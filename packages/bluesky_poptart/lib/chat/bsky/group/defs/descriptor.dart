...
import './disabled_join_link_preview_view.dart';
import './invalid_join_link_preview_view.dart';
...
final disabledJoinLinkPreviewViewDescriptor =
    XRPCObjectDescriptor<DisabledJoinLinkPreviewView>(
      nsid: 'chat.bsky.group.defs',
      defName: 'disabledJoinLinkPreviewView',
      fromJson: (json) => const DisabledJoinLinkPreviewViewConverter().fromJson(
        json.cast<String, dynamic>(),
      ),
      toJson: const DisabledJoinLinkPreviewViewConverter().toJson,
      matches: DisabledJoinLinkPreviewView.validate,
    );

final invalidJoinLinkPreviewViewDescriptor =
    XRPCObjectDescriptor<InvalidJoinLinkPreviewView>(
      nsid: 'chat.bsky.group.defs',
      defName: 'invalidJoinLinkPreviewView',
      fromJson: (json) => const InvalidJoinLinkPreviewViewConverter().fromJson(
        json.cast<String, dynamic>(),
      ),
      toJson: const InvalidJoinLinkPreviewViewConverter().toJson,
      matches: InvalidJoinLinkPreviewView.validate,
    );
