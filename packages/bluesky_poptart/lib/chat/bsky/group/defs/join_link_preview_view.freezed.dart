...
mixin _$JoinLinkPreviewView {
 ...
 String get $type; String get convoId; String get code; String get name;@ProfileViewBasicConverter() ProfileViewBasic get owner; int get memberCount; int get memberLimit; bool get requireApproval;@JoinRuleConverter() JoinRule get joinRule;/// Present only if the request is authenticated and the user is a member of the group.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,convoId,code,name,owner,memberCount,memberLimit,requireApproval,joinRule,convo,viewer,const DeepCollectionEquality().hash($unknown));
...
@useResult
$Res call({
 String $type, String convoId, String code, String name,@ProfileViewBasicConverter() ProfileViewBasic owner, int memberCount, int memberLimit, bool requireApproval,@JoinRuleConverter() JoinRule joinRule,@ConvoViewConverter() ConvoView? convo,@JoinLinkViewerStateConverter() JoinLinkViewerState? viewer, Map<String, dynamic>? $unknown
});


$ProfileViewBasicCopyWith<$Res> get owner;$JoinRuleCopyWith<$Res> get joinRule;$ConvoViewCopyWith<$Res>? get convo;$JoinLinkViewerStateCopyWith<$Res>? get viewer;
...
as JoinRule,convo: freezed == convo ? _self.convo : convo // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type,  String convoId,  String code,  String name, @ProfileViewBasicConverter()  ProfileViewBasic owner,  int memberCount,  int memberLimit,  bool requireApproval, @JoinRuleConverter()  JoinRule joinRule, @ConvoViewConverter()  ConvoView? convo, @JoinLinkViewerStateConverter()  JoinLinkViewerState? viewer,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _JoinLinkPreviewView() when $default != null:
return $default(_that.$type,_that.convoId,_that.code,_that.name,_that.owner,_that.memberCount,_that.memberLimit,_that.requireApproval,_that.joinRule,_that.convo,_that.viewer,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type,  String convoId,  String code,  String name, @ProfileViewBasicConverter()  ProfileViewBasic owner,  int memberCount,  int memberLimit,  bool requireApproval, @JoinRuleConverter()  JoinRule joinRule, @ConvoViewConverter()  ConvoView? convo, @JoinLinkViewerStateConverter()  JoinLinkViewerState? viewer,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _JoinLinkPreviewView():
return $default(_that.$type,_that.convoId,_that.code,_that.name,_that.owner,_that.memberCount,_that.memberLimit,_that.requireApproval,_that.joinRule,_that.convo,_that.viewer,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type,  String convoId,  String code,  String name, @ProfileViewBasicConverter()  ProfileViewBasic owner,  int memberCount,  int memberLimit,  bool requireApproval, @JoinRuleConverter()  JoinRule joinRule, @ConvoViewConverter()  ConvoView? convo, @JoinLinkViewerStateConverter()  JoinLinkViewerState? viewer,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _JoinLinkPreviewView() when $default != null:
return $default(_that.$type,_that.convoId,_that.code,_that.name,_that.owner,_that.memberCount,_that.memberLimit,_that.requireApproval,_that.joinRule,_that.convo,_that.viewer,_that.$unknown);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,convoId,code,name,owner,memberCount,memberLimit,requireApproval,joinRule,convo,viewer,const DeepCollectionEquality().hash(_$unknown));
...
@override $ProfileViewBasicCopyWith<$Res> get owner;@override $JoinRuleCopyWith<$Res> get joinRule;@override $ConvoViewCopyWith<$Res>? get convo;@override $JoinLinkViewerStateCopyWith<$Res>? get viewer;
...
/// Create a copy of JoinLinkPreviewView
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? convoId = null,Object? code = null,Object? name = null,Object? owner = null,Object? memberCount = null,Object? memberLimit = null,Object? requireApproval = null,Object? joinRule = null,Object? convo = freezed,Object? viewer = freezed,Object? $unknown = freezed,}) {
