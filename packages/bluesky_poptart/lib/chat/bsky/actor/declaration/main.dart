...
abstract class ActorDeclarationRecord with _$ActorDeclarationRecord {
  ...
  const factory ActorDeclarationRecord({
    ...
    @ActorDeclarationAllowIncomingConverter() required ActorDeclarationAllowIncoming allowIncoming,

    Map<String, dynamic>? $unknown,
  }) = _ActorDeclarationRecord;

  factory ActorDeclarationRecord.fromJson(Map<String, Object?> json) => _$ActorDeclarationRecordFromJson(json);
