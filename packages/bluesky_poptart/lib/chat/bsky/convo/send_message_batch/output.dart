...
abstract class ConvoSendMessageBatchOutput with _$ConvoSendMessageBatchOutput {
  ...
  factory ConvoSendMessageBatchOutput.fromJson(Map<String, Object?> json) => _$ConvoSendMessageBatchOutputFromJson(json);
}
...
final class ConvoSendMessageBatchOutputConverter
  ...
  @override
  Map<String, dynamic> toJson(ConvoSendMessageBatchOutput object) => untranslate(
        object.toJson(),
      );
}
