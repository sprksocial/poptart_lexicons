...
abstract class ConvoGetMessagesOutput with _$ConvoGetMessagesOutput {
  ...
  const factory ConvoGetMessagesOutput({
    String? cursor,
@UConvoGetMessagesMessagesConverter() required List<UConvoGetMessagesMessages> messages,

    Map<String, dynamic>? $unknown,
  }) = _ConvoGetMessagesOutput;

  factory ConvoGetMessagesOutput.fromJson(Map<String, Object?> json) => _$ConvoGetMessagesOutputFromJson(json);
}
