...
$ConvoUnmuteConvoOutputCopyWith<ConvoUnmuteConvoOutput> get copyWith => _$ConvoUnmuteConvoOutputCopyWithImpl<ConvoUnmuteConvoOutput>(this as ConvoUnmuteConvoOutput, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ConvoUnmuteConvoOutput&&(identical(other.convo, convo) || other.convo == convo)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
abstract mixin class $ConvoUnmuteConvoOutputCopyWith<$Res>  {
  factory $ConvoUnmuteConvoOutputCopyWith(ConvoUnmuteConvoOutput value, $Res Function(ConvoUnmuteConvoOutput) _then) = _$ConvoUnmuteConvoOutputCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ConvoUnmuteConvoOutput value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ConvoUnmuteConvoOutput value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ConvoUnmuteConvoOutput value)?  $default,){
final _that = this;
switch (_that) {
case _ConvoUnmuteConvoOutput() when $default != null:
return $default(_that);case _:
...
class _ConvoUnmuteConvoOutput implements ConvoUnmuteConvoOutput {
  const _ConvoUnmuteConvoOutput({@ConvoViewConverter() required this.convo, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _ConvoUnmuteConvoOutput.fromJson(Map<String, dynamic> json) => _$ConvoUnmuteConvoOutputFromJson(json);
...
@pragma('vm:prefer-inline')
_$ConvoUnmuteConvoOutputCopyWith<_ConvoUnmuteConvoOutput> get copyWith => __$ConvoUnmuteConvoOutputCopyWithImpl<_ConvoUnmuteConvoOutput>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ConvoUnmuteConvoOutputToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ConvoUnmuteConvoOutput&&(identical(other.convo, convo) || other.convo == convo)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$ConvoUnmuteConvoOutputCopyWith<$Res> implements $ConvoUnmuteConvoOutputCopyWith<$Res> {
  factory _$ConvoUnmuteConvoOutputCopyWith(_ConvoUnmuteConvoOutput value, $Res Function(_ConvoUnmuteConvoOutput) _then) = __$ConvoUnmuteConvoOutputCopyWithImpl;
@override @useResult
$Res call({
@ConvoViewConverter() ConvoView convo, Map<String, dynamic>? $unknown
});
