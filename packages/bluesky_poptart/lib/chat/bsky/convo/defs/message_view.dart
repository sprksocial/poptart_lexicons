...
abstract class MessageView with _$MessageView {
  static const knownProps = <String>['id', 'rev', 'text', 'facets', 'embed', 'reactions', 'sender', 'sentAt', ];
...
required DateTime sentAt,
  ...
  factory MessageView.fromJson(Map<String, Object?> json) => _$MessageViewFromJson(json);
