...
mixin _$LogRemoveMember {
 ...
 String get $type; String get rev; String get convoId;/// A system message with data of type #systemMessageDataRemoveMember
...
$LogRemoveMemberCopyWith<LogRemoveMember> get copyWith => _$LogRemoveMemberCopyWithImpl<LogRemoveMember>(this as LogRemoveMember, _$identity);
...
/// @nodoc
abstract mixin class $LogRemoveMemberCopyWith<$Res>  {
  factory $LogRemoveMemberCopyWith(LogRemoveMember value, $Res Function(LogRemoveMember) _then) = _$LogRemoveMemberCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LogRemoveMemberCopyWithImpl<$Res>
    implements $LogRemoveMemberCopyWith<$Res> {
  _$LogRemoveMemberCopyWithImpl(this._self, this._then);

  final LogRemoveMember _self;
  final $Res Function(LogRemoveMember) _then;
...
/// Adds pattern-matching-related methods to [LogRemoveMember].
extension LogRemoveMemberPatterns on LogRemoveMember {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LogRemoveMember value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogRemoveMember() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LogRemoveMember value)  $default,){
final _that = this;
switch (_that) {
case _LogRemoveMember():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LogRemoveMember value)?  $default,){
final _that = this;
switch (_that) {
case _LogRemoveMember() when $default != null:
return $default(_that);case _:
...
class _LogRemoveMember implements LogRemoveMember {
  const _LogRemoveMember({this.$type = 'chat.bsky.convo.defs#logRemoveMember', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, @ProfileViewBasicConverter() required final  List<ProfileViewBasic> relatedProfiles, final  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
  factory _LogRemoveMember.fromJson(Map<String, dynamic> json) => _$LogRemoveMemberFromJson(json);
...
@pragma('vm:prefer-inline')
_$LogRemoveMemberCopyWith<_LogRemoveMember> get copyWith => __$LogRemoveMemberCopyWithImpl<_LogRemoveMember>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LogRemoveMemberToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LogRemoveMember&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.rev, rev) || other.rev == rev)&&(identical(other.convoId, convoId) || other.convoId == convoId)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._relatedProfiles, _relatedProfiles)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$LogRemoveMemberCopyWith<$Res> implements $LogRemoveMemberCopyWith<$Res> {
  factory _$LogRemoveMemberCopyWith(_LogRemoveMember value, $Res Function(_LogRemoveMember) _then) = __$LogRemoveMemberCopyWithImpl;
@override @useResult
$Res call({
 String $type, String rev, String convoId,@SystemMessageViewConverter() SystemMessageView message,@ProfileViewBasicConverter() List<ProfileViewBasic> relatedProfiles, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$LogRemoveMemberCopyWithImpl<$Res>
    implements _$LogRemoveMemberCopyWith<$Res> {
  __$LogRemoveMemberCopyWithImpl(this._self, this._then);

  final _LogRemoveMember _self;
  final $Res Function(_LogRemoveMember) _then;
