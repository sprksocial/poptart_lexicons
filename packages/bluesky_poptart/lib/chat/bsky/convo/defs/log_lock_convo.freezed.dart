...
mixin _$LogLockConvo {
 ...
 String get $type; String get rev; String get convoId;/// A system message with data of type #systemMessageDataLockConvo
...
$LogLockConvoCopyWith<LogLockConvo> get copyWith => _$LogLockConvoCopyWithImpl<LogLockConvo>(this as LogLockConvo, _$identity);
...
/// @nodoc
abstract mixin class $LogLockConvoCopyWith<$Res>  {
  factory $LogLockConvoCopyWith(LogLockConvo value, $Res Function(LogLockConvo) _then) = _$LogLockConvoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LogLockConvoCopyWithImpl<$Res>
    implements $LogLockConvoCopyWith<$Res> {
  _$LogLockConvoCopyWithImpl(this._self, this._then);

  final LogLockConvo _self;
  final $Res Function(LogLockConvo) _then;
...
/// Adds pattern-matching-related methods to [LogLockConvo].
extension LogLockConvoPatterns on LogLockConvo {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LogLockConvo value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogLockConvo() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LogLockConvo value)  $default,){
final _that = this;
switch (_that) {
case _LogLockConvo():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LogLockConvo value)?  $default,){
final _that = this;
switch (_that) {
case _LogLockConvo() when $default != null:
return $default(_that);case _:
...
class _LogLockConvo implements LogLockConvo {
  const _LogLockConvo({this.$type = 'chat.bsky.convo.defs#logLockConvo', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, @ProfileViewBasicConverter() required final  List<ProfileViewBasic> relatedProfiles, final  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
  factory _LogLockConvo.fromJson(Map<String, dynamic> json) => _$LogLockConvoFromJson(json);
...
@pragma('vm:prefer-inline')
_$LogLockConvoCopyWith<_LogLockConvo> get copyWith => __$LogLockConvoCopyWithImpl<_LogLockConvo>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LogLockConvoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LogLockConvo&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.rev, rev) || other.rev == rev)&&(identical(other.convoId, convoId) || other.convoId == convoId)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._relatedProfiles, _relatedProfiles)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$LogLockConvoCopyWith<$Res> implements $LogLockConvoCopyWith<$Res> {
  factory _$LogLockConvoCopyWith(_LogLockConvo value, $Res Function(_LogLockConvo) _then) = __$LogLockConvoCopyWithImpl;
@override @useResult
$Res call({
 String $type, String rev, String convoId,@SystemMessageViewConverter() SystemMessageView message,@ProfileViewBasicConverter() List<ProfileViewBasic> relatedProfiles, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$LogLockConvoCopyWithImpl<$Res>
    implements _$LogLockConvoCopyWith<$Res> {
  __$LogLockConvoCopyWithImpl(this._self, this._then);

  final _LogLockConvo _self;
  final $Res Function(_LogLockConvo) _then;
