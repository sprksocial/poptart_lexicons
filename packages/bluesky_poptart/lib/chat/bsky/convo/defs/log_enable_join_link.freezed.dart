...
mixin _$LogEnableJoinLink {
 ...
 String get $type; String get rev; String get convoId;/// A system message with data of type #systemMessageDataEnableJoinLink
...
$LogEnableJoinLinkCopyWith<LogEnableJoinLink> get copyWith => _$LogEnableJoinLinkCopyWithImpl<LogEnableJoinLink>(this as LogEnableJoinLink, _$identity);
...
/// @nodoc
abstract mixin class $LogEnableJoinLinkCopyWith<$Res>  {
  factory $LogEnableJoinLinkCopyWith(LogEnableJoinLink value, $Res Function(LogEnableJoinLink) _then) = _$LogEnableJoinLinkCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LogEnableJoinLinkCopyWithImpl<$Res>
    implements $LogEnableJoinLinkCopyWith<$Res> {
  _$LogEnableJoinLinkCopyWithImpl(this._self, this._then);

  final LogEnableJoinLink _self;
  final $Res Function(LogEnableJoinLink) _then;
...
/// Adds pattern-matching-related methods to [LogEnableJoinLink].
extension LogEnableJoinLinkPatterns on LogEnableJoinLink {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LogEnableJoinLink value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogEnableJoinLink() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LogEnableJoinLink value)  $default,){
final _that = this;
switch (_that) {
case _LogEnableJoinLink():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LogEnableJoinLink value)?  $default,){
final _that = this;
switch (_that) {
case _LogEnableJoinLink() when $default != null:
return $default(_that);case _:
...
class _LogEnableJoinLink implements LogEnableJoinLink {
  const _LogEnableJoinLink({this.$type = 'chat.bsky.convo.defs#logEnableJoinLink', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _LogEnableJoinLink.fromJson(Map<String, dynamic> json) => _$LogEnableJoinLinkFromJson(json);
...
@pragma('vm:prefer-inline')
_$LogEnableJoinLinkCopyWith<_LogEnableJoinLink> get copyWith => __$LogEnableJoinLinkCopyWithImpl<_LogEnableJoinLink>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LogEnableJoinLinkToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LogEnableJoinLink&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.rev, rev) || other.rev == rev)&&(identical(other.convoId, convoId) || other.convoId == convoId)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$LogEnableJoinLinkCopyWith<$Res> implements $LogEnableJoinLinkCopyWith<$Res> {
  factory _$LogEnableJoinLinkCopyWith(_LogEnableJoinLink value, $Res Function(_LogEnableJoinLink) _then) = __$LogEnableJoinLinkCopyWithImpl;
@override @useResult
$Res call({
 String $type, String rev, String convoId,@SystemMessageViewConverter() SystemMessageView message, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$LogEnableJoinLinkCopyWithImpl<$Res>
    implements _$LogEnableJoinLinkCopyWith<$Res> {
  __$LogEnableJoinLinkCopyWithImpl(this._self, this._then);

  final _LogEnableJoinLink _self;
  final $Res Function(_LogEnableJoinLink) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? message = null,Object? $unknown = freezed,}) {
  return _then(_LogEnableJoinLink(
$type: null == $type ? _self.$type : $type // ignore: cast_nullable_to_non_nullable
as String,rev: null == rev ? _self.rev : rev // ignore: cast_nullable_to_non_nullable
as String,convoId: null == convoId ? _self.convoId : convoId // ignore: cast_nullable_to_non_nullable
as String,message: null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
