...
mixin _$LogMemberJoin {
 ...
 String get $type; String get rev; String get convoId;/// A system message with data of type #systemMessageDataMemberJoin
...
$LogMemberJoinCopyWith<LogMemberJoin> get copyWith => _$LogMemberJoinCopyWithImpl<LogMemberJoin>(this as LogMemberJoin, _$identity);
...
/// @nodoc
abstract mixin class $LogMemberJoinCopyWith<$Res>  {
  factory $LogMemberJoinCopyWith(LogMemberJoin value, $Res Function(LogMemberJoin) _then) = _$LogMemberJoinCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LogMemberJoinCopyWithImpl<$Res>
    implements $LogMemberJoinCopyWith<$Res> {
  _$LogMemberJoinCopyWithImpl(this._self, this._then);

  final LogMemberJoin _self;
  final $Res Function(LogMemberJoin) _then;
...
/// Adds pattern-matching-related methods to [LogMemberJoin].
extension LogMemberJoinPatterns on LogMemberJoin {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LogMemberJoin value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogMemberJoin() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LogMemberJoin value)  $default,){
final _that = this;
switch (_that) {
case _LogMemberJoin():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LogMemberJoin value)?  $default,){
final _that = this;
switch (_that) {
case _LogMemberJoin() when $default != null:
return $default(_that);case _:
...
class _LogMemberJoin implements LogMemberJoin {
  const _LogMemberJoin({this.$type = 'chat.bsky.convo.defs#logMemberJoin', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, @ProfileViewBasicConverter() required final  List<ProfileViewBasic> relatedProfiles, final  Map<String, dynamic>? $unknown}): _relatedProfiles = relatedProfiles,_$unknown = $unknown;
  factory _LogMemberJoin.fromJson(Map<String, dynamic> json) => _$LogMemberJoinFromJson(json);
...
@pragma('vm:prefer-inline')
_$LogMemberJoinCopyWith<_LogMemberJoin> get copyWith => __$LogMemberJoinCopyWithImpl<_LogMemberJoin>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LogMemberJoinToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LogMemberJoin&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.rev, rev) || other.rev == rev)&&(identical(other.convoId, convoId) || other.convoId == convoId)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._relatedProfiles, _relatedProfiles)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$LogMemberJoinCopyWith<$Res> implements $LogMemberJoinCopyWith<$Res> {
  factory _$LogMemberJoinCopyWith(_LogMemberJoin value, $Res Function(_LogMemberJoin) _then) = __$LogMemberJoinCopyWithImpl;
@override @useResult
$Res call({
 String $type, String rev, String convoId,@SystemMessageViewConverter() SystemMessageView message,@ProfileViewBasicConverter() List<ProfileViewBasic> relatedProfiles, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$LogMemberJoinCopyWithImpl<$Res>
    implements _$LogMemberJoinCopyWith<$Res> {
  __$LogMemberJoinCopyWithImpl(this._self, this._then);

  final _LogMemberJoin _self;
  final $Res Function(_LogMemberJoin) _then;
