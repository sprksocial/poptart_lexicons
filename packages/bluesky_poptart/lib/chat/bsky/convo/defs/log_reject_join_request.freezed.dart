...
$LogRejectJoinRequestCopyWith<LogRejectJoinRequest> get copyWith => _$LogRejectJoinRequestCopyWithImpl<LogRejectJoinRequest>(this as LogRejectJoinRequest, _$identity);
...
/// @nodoc
abstract mixin class $LogRejectJoinRequestCopyWith<$Res>  {
  factory $LogRejectJoinRequestCopyWith(LogRejectJoinRequest value, $Res Function(LogRejectJoinRequest) _then) = _$LogRejectJoinRequestCopyWithImpl;
@useResult
$Res call({
...
class _$LogRejectJoinRequestCopyWithImpl<$Res>
  ...
  _$LogRejectJoinRequestCopyWithImpl(this._self, this._then);

  final LogRejectJoinRequest _self;
  final $Res Function(LogRejectJoinRequest) _then;
...
/// Adds pattern-matching-related methods to [LogRejectJoinRequest].
extension LogRejectJoinRequestPatterns on LogRejectJoinRequest {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LogRejectJoinRequest value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogRejectJoinRequest() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LogRejectJoinRequest value)  $default,){
final _that = this;
switch (_that) {
case _LogRejectJoinRequest():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LogRejectJoinRequest value)?  $default,){
final _that = this;
switch (_that) {
case _LogRejectJoinRequest() when $default != null:
return $default(_that);case _:
...
class _LogRejectJoinRequest implements LogRejectJoinRequest {
  const _LogRejectJoinRequest({this.$type = 'chat.bsky.convo.defs#logRejectJoinRequest', required this.rev, required this.convoId, @ProfileViewBasicConverter() required this.member, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _LogRejectJoinRequest.fromJson(Map<String, dynamic> json) => _$LogRejectJoinRequestFromJson(json);
...
@pragma('vm:prefer-inline')
_$LogRejectJoinRequestCopyWith<_LogRejectJoinRequest> get copyWith => __$LogRejectJoinRequestCopyWithImpl<_LogRejectJoinRequest>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LogRejectJoinRequestToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LogRejectJoinRequest&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.rev, rev) || other.rev == rev)&&(identical(other.convoId, convoId) || other.convoId == convoId)&&(identical(other.member, member) || other.member == member)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$LogRejectJoinRequestCopyWith<$Res> implements $LogRejectJoinRequestCopyWith<$Res> {
  factory _$LogRejectJoinRequestCopyWith(_LogRejectJoinRequest value, $Res Function(_LogRejectJoinRequest) _then) = __$LogRejectJoinRequestCopyWithImpl;
@override @useResult
$Res call({
 String $type, String rev, String convoId,@ProfileViewBasicConverter() ProfileViewBasic member, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$LogRejectJoinRequestCopyWithImpl<$Res>
    implements _$LogRejectJoinRequestCopyWith<$Res> {
  __$LogRejectJoinRequestCopyWithImpl(this._self, this._then);

  final _LogRejectJoinRequest _self;
  final $Res Function(_LogRejectJoinRequest) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? member = null,Object? $unknown = freezed,}) {
  return _then(_LogRejectJoinRequest(
$type: null == $type ? _self.$type : $type // ignore: cast_nullable_to_non_nullable
as String,rev: null == rev ? _self.rev : rev // ignore: cast_nullable_to_non_nullable
as String,convoId: null == convoId ? _self.convoId : convoId // ignore: cast_nullable_to_non_nullable
as String,member: null == member ? _self.member : member // ignore: cast_nullable_to_non_nullable
