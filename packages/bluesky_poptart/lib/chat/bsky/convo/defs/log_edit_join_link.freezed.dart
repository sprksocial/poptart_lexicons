...
mixin _$LogEditJoinLink {
 ...
 String get $type; String get rev; String get convoId;/// A system message with data of type #systemMessageDataEditJoinLink
...
$LogEditJoinLinkCopyWith<LogEditJoinLink> get copyWith => _$LogEditJoinLinkCopyWithImpl<LogEditJoinLink>(this as LogEditJoinLink, _$identity);
...
/// @nodoc
abstract mixin class $LogEditJoinLinkCopyWith<$Res>  {
  factory $LogEditJoinLinkCopyWith(LogEditJoinLink value, $Res Function(LogEditJoinLink) _then) = _$LogEditJoinLinkCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LogEditJoinLinkCopyWithImpl<$Res>
    implements $LogEditJoinLinkCopyWith<$Res> {
  _$LogEditJoinLinkCopyWithImpl(this._self, this._then);

  final LogEditJoinLink _self;
  final $Res Function(LogEditJoinLink) _then;
...
/// Adds pattern-matching-related methods to [LogEditJoinLink].
extension LogEditJoinLinkPatterns on LogEditJoinLink {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LogEditJoinLink value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogEditJoinLink() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LogEditJoinLink value)  $default,){
final _that = this;
switch (_that) {
case _LogEditJoinLink():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LogEditJoinLink value)?  $default,){
final _that = this;
switch (_that) {
case _LogEditJoinLink() when $default != null:
return $default(_that);case _:
...
class _LogEditJoinLink implements LogEditJoinLink {
  const _LogEditJoinLink({this.$type = 'chat.bsky.convo.defs#logEditJoinLink', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _LogEditJoinLink.fromJson(Map<String, dynamic> json) => _$LogEditJoinLinkFromJson(json);
...
@pragma('vm:prefer-inline')
_$LogEditJoinLinkCopyWith<_LogEditJoinLink> get copyWith => __$LogEditJoinLinkCopyWithImpl<_LogEditJoinLink>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LogEditJoinLinkToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LogEditJoinLink&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.rev, rev) || other.rev == rev)&&(identical(other.convoId, convoId) || other.convoId == convoId)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$LogEditJoinLinkCopyWith<$Res> implements $LogEditJoinLinkCopyWith<$Res> {
  factory _$LogEditJoinLinkCopyWith(_LogEditJoinLink value, $Res Function(_LogEditJoinLink) _then) = __$LogEditJoinLinkCopyWithImpl;
@override @useResult
$Res call({
 String $type, String rev, String convoId,@SystemMessageViewConverter() SystemMessageView message, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$LogEditJoinLinkCopyWithImpl<$Res>
    implements _$LogEditJoinLinkCopyWith<$Res> {
  __$LogEditJoinLinkCopyWithImpl(this._self, this._then);

  final _LogEditJoinLink _self;
  final $Res Function(_LogEditJoinLink) _then;
