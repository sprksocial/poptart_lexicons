...
sealed class UMessageInputEmbed with _$UMessageInputEmbed {
  ...
  Map<String, dynamic> toJson() => const UMessageInputEmbedConverter().toJson(this);
}
...
final class UMessageInputEmbedConverter implements JsonConverter<UMessageInputEmbed, Map<String, dynamic>> {
