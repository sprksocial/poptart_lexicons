...
mixin _$LogCreateJoinLink {
 ...
 String get $type; String get rev; String get convoId;/// A system message with data of type #systemMessageDataCreateJoinLink
...
$LogCreateJoinLinkCopyWith<LogCreateJoinLink> get copyWith => _$LogCreateJoinLinkCopyWithImpl<LogCreateJoinLink>(this as LogCreateJoinLink, _$identity);
...
/// @nodoc
abstract mixin class $LogCreateJoinLinkCopyWith<$Res>  {
  factory $LogCreateJoinLinkCopyWith(LogCreateJoinLink value, $Res Function(LogCreateJoinLink) _then) = _$LogCreateJoinLinkCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LogCreateJoinLinkCopyWithImpl<$Res>
    implements $LogCreateJoinLinkCopyWith<$Res> {
  _$LogCreateJoinLinkCopyWithImpl(this._self, this._then);

  final LogCreateJoinLink _self;
  final $Res Function(LogCreateJoinLink) _then;
...
/// Adds pattern-matching-related methods to [LogCreateJoinLink].
extension LogCreateJoinLinkPatterns on LogCreateJoinLink {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LogCreateJoinLink value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LogCreateJoinLink() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LogCreateJoinLink value)  $default,){
final _that = this;
switch (_that) {
case _LogCreateJoinLink():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LogCreateJoinLink value)?  $default,){
final _that = this;
switch (_that) {
case _LogCreateJoinLink() when $default != null:
return $default(_that);case _:
...
class _LogCreateJoinLink implements LogCreateJoinLink {
  const _LogCreateJoinLink({this.$type = 'chat.bsky.convo.defs#logCreateJoinLink', required this.rev, required this.convoId, @SystemMessageViewConverter() required this.message, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _LogCreateJoinLink.fromJson(Map<String, dynamic> json) => _$LogCreateJoinLinkFromJson(json);
...
@pragma('vm:prefer-inline')
_$LogCreateJoinLinkCopyWith<_LogCreateJoinLink> get copyWith => __$LogCreateJoinLinkCopyWithImpl<_LogCreateJoinLink>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LogCreateJoinLinkToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LogCreateJoinLink&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.rev, rev) || other.rev == rev)&&(identical(other.convoId, convoId) || other.convoId == convoId)&&(identical(other.message, message) || other.message == message)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$LogCreateJoinLinkCopyWith<$Res> implements $LogCreateJoinLinkCopyWith<$Res> {
  factory _$LogCreateJoinLinkCopyWith(_LogCreateJoinLink value, $Res Function(_LogCreateJoinLink) _then) = __$LogCreateJoinLinkCopyWithImpl;
@override @useResult
$Res call({
 String $type, String rev, String convoId,@SystemMessageViewConverter() SystemMessageView message, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$LogCreateJoinLinkCopyWithImpl<$Res>
    implements _$LogCreateJoinLinkCopyWith<$Res> {
  __$LogCreateJoinLinkCopyWithImpl(this._self, this._then);

  final _LogCreateJoinLink _self;
  final $Res Function(_LogCreateJoinLink) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? rev = null,Object? convoId = null,Object? message = null,Object? $unknown = freezed,}) {
  return _then(_LogCreateJoinLink(
$type: null == $type ? _self.$type : $type // ignore: cast_nullable_to_non_nullable
as String,rev: null == rev ? _self.rev : rev // ignore: cast_nullable_to_non_nullable
as String,convoId: null == convoId ? _self.convoId : convoId // ignore: cast_nullable_to_non_nullable
as String,message: null == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
