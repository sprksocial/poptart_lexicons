...
const factory UConvoGetLogLogs.logRemoveReaction({
  ...
  Map<String, dynamic> toJson() => const UConvoGetLogLogsConverter().toJson(this);
}
...
LogRemoveReaction? get logRemoveReaction => isLogRemoveReaction ? data as LogRemoveReaction : null;
...
final class UConvoGetLogLogsConverter implements JsonConverter<UConvoGetLogLogs, Map<String, dynamic>> {
...
logRemoveReaction: (data) => const LogRemoveReactionConverter().toJson(data),
