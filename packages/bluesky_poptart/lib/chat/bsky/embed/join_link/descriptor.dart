...
final embedJoinLinkViewDescriptor = XRPCObjectDescriptor<EmbedJoinLinkView>(
  nsid: 'chat.bsky.embed.joinLink',
  defName: 'view',
  fromJson: (json) =>
      const EmbedJoinLinkViewConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const EmbedJoinLinkViewConverter().toJson,
  matches: EmbedJoinLinkView.validate,
);
