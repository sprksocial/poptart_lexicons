...
extension AtUriExtension on AtUri {
  ...
  bool get isFeedGenerator => collection.toString() == 'app.bsky.feed.generator';
  ...
  bool get isFeedLike => collection.toString() == 'app.bsky.feed.like';
  ...
  bool get isFeedRepost => collection.toString() == 'app.bsky.feed.repost';
  ...
  bool get isFeedThreadgate => collection.toString() == 'app.bsky.feed.threadgate';
  ...
  bool get isGraphListblock => collection.toString() == 'app.bsky.graph.listblock';
  ...
  bool get isGraphListitem => collection.toString() == 'app.bsky.graph.listitem';
  ...
  bool get isGraphStarterpack => collection.toString() == 'app.bsky.graph.starterpack';
  ...
  bool get isGraphVerification => collection.toString() == 'app.bsky.graph.verification';
  ...
  bool get isLabelerService => collection.toString() == 'app.bsky.labeler.service';
  ...
  bool get isNotificationDeclaration => collection.toString() == 'app.bsky.notification.declaration';
  ...
  bool get isActorDeclaration => collection.toString() == 'chat.bsky.actor.declaration';
