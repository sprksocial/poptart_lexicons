...
abstract class StarterPackWithMembership with _$StarterPackWithMembership {
  ...
  const factory StarterPackWithMembership({
    @Default('app.bsky.graph.getStarterPacksWithMembership#starterPackWithMembership') String $type,
...
@ListItemViewConverter() ListItemView? listItem,
  ...
  factory StarterPackWithMembership.fromJson(Map<String, Object?> json) => _$StarterPackWithMembershipFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'app.bsky.graph.getStarterPacksWithMembership#starterPackWithMembership'
;
}
...
final class StarterPackWithMembershipConverter
  ...
  StarterPackWithMembership fromJson(Map<String, dynamic> json) {
    return StarterPackWithMembership.fromJson(translate(
      json,
      StarterPackWithMembership.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(StarterPackWithMembership object) => untranslate(
        object.toJson(),
      );
}
