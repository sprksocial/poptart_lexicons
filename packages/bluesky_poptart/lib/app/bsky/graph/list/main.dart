...
abstract class GraphListRecord with _$GraphListRecord {
  static const knownProps = <String>['purpose', 'name', 'description', 'descriptionFacets', 'avatar', 'labels', 'createdAt', ];
...
required DateTime createdAt,
  ...
  factory GraphListRecord.fromJson(Map<String, Object?> json) => _$GraphListRecordFromJson(json);
