...
abstract class GraphStarterpackRecord with _$GraphStarterpackRecord {
  static const knownProps = <String>['name', 'description', 'descriptionFacets', 'list', 'feeds', 'createdAt', ];
...
required DateTime createdAt,
  ...
  factory GraphStarterpackRecord.fromJson(Map<String, Object?> json) => _$GraphStarterpackRecordFromJson(json);
