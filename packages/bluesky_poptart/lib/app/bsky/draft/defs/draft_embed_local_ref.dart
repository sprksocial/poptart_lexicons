...
required String path,
  ...
  factory DraftEmbedLocalRef.fromJson(Map<String, Object?> json) => _$DraftEmbedLocalRefFromJson(json);
...
final class DraftEmbedLocalRefConverter
  ...
  DraftEmbedLocalRef fromJson(Map<String, dynamic> json) {
    return DraftEmbedLocalRef.fromJson(translate(
      json,
      DraftEmbedLocalRef.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(DraftEmbedLocalRef object) => untranslate(
        object.toJson(),
      );
}
