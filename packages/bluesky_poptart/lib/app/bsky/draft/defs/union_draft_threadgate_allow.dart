...
sealed class UDraftThreadgateAllow with _$UDraftThreadgateAllow {
  ...
  const factory UDraftThreadgateAllow.mentionRule({
...
const factory UDraftThreadgateAllow.listRule({
  ...
  Map<String, dynamic> toJson() => const UDraftThreadgateAllowConverter().toJson(this);
}
...
final class UDraftThreadgateAllowConverter implements JsonConverter<UDraftThreadgateAllow, Map<String, dynamic>> {
