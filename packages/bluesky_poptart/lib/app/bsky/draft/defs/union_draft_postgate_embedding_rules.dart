...
sealed class UDraftPostgateEmbeddingRules with _$UDraftPostgateEmbeddingRules {
  ...
  Map<String, dynamic> toJson() => const UDraftPostgateEmbeddingRulesConverter().toJson(this);
}

extension UDraftPostgateEmbeddingRulesExtension on UDraftPostgateEmbeddingRules {
...
final class UDraftPostgateEmbeddingRulesConverter implements JsonConverter<UDraftPostgateEmbeddingRules, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UDraftPostgateEmbeddingRules object) => object.when(
