...
sealed class UBookmarkViewItem with _$UBookmarkViewItem {
  ...
  const factory UBookmarkViewItem.blockedPost({
  required BlockedPost data,
}) = UBookmarkViewItemBlockedPost;
const factory UBookmarkViewItem.notFoundPost({
  required NotFoundPost data,
}) = UBookmarkViewItemNotFoundPost;
const factory UBookmarkViewItem.postView({
  ...
  Map<String, dynamic> toJson() => const UBookmarkViewItemConverter().toJson(this);
}
...
final class UBookmarkViewItemConverter implements JsonConverter<UBookmarkViewItem, Map<String, dynamic>> {
