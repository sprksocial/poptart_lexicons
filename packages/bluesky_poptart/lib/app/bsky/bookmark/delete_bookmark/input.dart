...
abstract class BookmarkDeleteBookmarkInput with _$BookmarkDeleteBookmarkInput {
  ...
  factory BookmarkDeleteBookmarkInput.fromJson(Map<String, Object?> json) => _$BookmarkDeleteBookmarkInputFromJson(json);
}
...
final class BookmarkDeleteBookmarkInputConverter
  ...
  BookmarkDeleteBookmarkInput fromJson(Map<String, dynamic> json) {
    return BookmarkDeleteBookmarkInput.fromJson(translate(
      json,
      BookmarkDeleteBookmarkInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(BookmarkDeleteBookmarkInput object) => untranslate(
        object.toJson(),
      );
}
