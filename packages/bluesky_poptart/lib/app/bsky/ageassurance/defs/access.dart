...
abstract class Access with _$Access {
  ...
  const factory Access.knownValue({
    required KnownAccess data,
  }) = AccessKnownValue;

  const factory Access.unknown({
  ...
  static Access? valueOf(final String? value) {
    ...
    return knownValue != null ? Access.knownValue(data: knownValue) : Access.unknown(data: value);
  }
...
final class AccessConverter extends JsonConverter<Access, String> {
  ...
  @override
  String toJson(Access object) => object.when(
