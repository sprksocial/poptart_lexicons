...
final class StateConverter
    extends JsonConverter<State, Map<String, dynamic>> {
  const StateConverter();

  @override
  State fromJson(Map<String, dynamic> json) {
    return State.fromJson(translate(
      json,
      State.knownProps,
    ));
  }
  ...
  @override
  Map<String, dynamic> toJson(State object) => untranslate(
        object.toJson(),
      );
}
