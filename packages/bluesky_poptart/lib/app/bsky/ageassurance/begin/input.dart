...
abstract class AgeassuranceBeginInput with _$AgeassuranceBeginInput {
  static const knownProps = <String>['email', 'language', 'countryCode', 'regionCode', ];
...
String? regionCode,
  ...
  factory AgeassuranceBeginInput.fromJson(Map<String, Object?> json) => _$AgeassuranceBeginInputFromJson(json);
}
...
final class AgeassuranceBeginInputConverter
  ...
  AgeassuranceBeginInput fromJson(Map<String, dynamic> json) {
    return AgeassuranceBeginInput.fromJson(translate(
      json,
      AgeassuranceBeginInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(AgeassuranceBeginInput object) => untranslate(
        object.toJson(),
      );
}
