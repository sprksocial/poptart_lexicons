...
final embedVideoDescriptor = XRPCObjectDescriptor<EmbedVideo>(
  ...
  defName: 'main',
  fromJson: (json) => const EmbedVideoConverter().fromJson(json.cast<String, dynamic>()),
...
final embedVideoCaptionDescriptor = XRPCObjectDescriptor<EmbedVideoCaption>(
  nsid: 'app.bsky.embed.video',
  defName: 'caption',
  fromJson: (json) => const EmbedVideoCaptionConverter().fromJson(json.cast<String, dynamic>()),
...
final embedVideoViewDescriptor = XRPCObjectDescriptor<EmbedVideoView>(
  nsid: 'app.bsky.embed.video',
  defName: 'view',
  fromJson: (json) => const EmbedVideoViewConverter().fromJson(json.cast<String, dynamic>()),
