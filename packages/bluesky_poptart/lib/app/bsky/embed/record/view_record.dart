...
abstract class EmbedRecordViewRecord with _$EmbedRecordViewRecord {
  static const knownProps = <String>['uri', 'cid', 'author', 'value', 'labels', 'replyCount', 'repostCount', 'likeCount', 'quoteCount', 'embeds', 'indexedAt', ];
...
int? likeCount,
int? quoteCount,
@UEmbedRecordViewRecordEmbedsConverter() List<UEmbedRecordViewRecordEmbeds>? embeds,
required DateTime indexedAt,

    Map<String, dynamic>? $unknown,
  }) = _EmbedRecordViewRecord;

  factory EmbedRecordViewRecord.fromJson(Map<String, Object?> json) => _$EmbedRecordViewRecordFromJson(json);
