...
$EmbedRecordViewBlockedCopyWith<EmbedRecordViewBlocked> get copyWith => _$EmbedRecordViewBlockedCopyWithImpl<EmbedRecordViewBlocked>(this as EmbedRecordViewBlocked, _$identity);
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EmbedRecordViewBlocked value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EmbedRecordViewBlocked value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EmbedRecordViewBlocked value)?  $default,){
final _that = this;
switch (_that) {
case _EmbedRecordViewBlocked() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$EmbedRecordViewBlockedCopyWith<_EmbedRecordViewBlocked> get copyWith => __$EmbedRecordViewBlockedCopyWithImpl<_EmbedRecordViewBlocked>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EmbedRecordViewBlockedToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EmbedRecordViewBlocked&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.blocked, blocked) || other.blocked == blocked)&&(identical(other.author, author) || other.author == author)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$EmbedRecordViewBlockedCopyWith<$Res> implements $EmbedRecordViewBlockedCopyWith<$Res> {
