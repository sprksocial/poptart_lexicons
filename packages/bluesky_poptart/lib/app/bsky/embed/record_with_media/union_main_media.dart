...
const factory UEmbedRecordWithMediaMedia.embedExternal({
  ...
  Map<String, dynamic> toJson() => const UEmbedRecordWithMediaMediaConverter().toJson(this);
}
...
bool get isEmbedExternal => isA<UEmbedRecordWithMediaMediaEmbedExternal>(this);
...
final class UEmbedRecordWithMediaMediaConverter implements JsonConverter<UEmbedRecordWithMediaMedia, Map<String, dynamic>> {
