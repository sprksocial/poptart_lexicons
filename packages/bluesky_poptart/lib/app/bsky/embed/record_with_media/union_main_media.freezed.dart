...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( UEmbedRecordWithMediaMediaEmbedImages value)?  embedImages,TResult Function( UEmbedRecordWithMediaMediaEmbedVideo value)?  embedVideo,TResult Function( UEmbedRecordWithMediaMediaEmbedGallery value)?  embedGallery,TResult Function( UEmbedRecordWithMediaMediaEmbedExternal value)?  embedExternal,TResult Function( UEmbedRecordWithMediaMediaUnknown value)?  unknown,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return embedVideo(_that);case UEmbedRecordWithMediaMediaEmbedGallery() when embedGallery != null:
return embedGallery(_that);case UEmbedRecordWithMediaMediaEmbedExternal() when embedExternal != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( UEmbedRecordWithMediaMediaEmbedImages value)  embedImages,required TResult Function( UEmbedRecordWithMediaMediaEmbedVideo value)  embedVideo,required TResult Function( UEmbedRecordWithMediaMediaEmbedGallery value)  embedGallery,required TResult Function( UEmbedRecordWithMediaMediaEmbedExternal value)  embedExternal,required TResult Function( UEmbedRecordWithMediaMediaUnknown value)  unknown,}){
final _that = this;
switch (_that) {
case UEmbedRecordWithMediaMediaEmbedImages():
return embedImages(_that);case UEmbedRecordWithMediaMediaEmbedVideo():
return embedVideo(_that);case UEmbedRecordWithMediaMediaEmbedGallery():
return embedGallery(_that);case UEmbedRecordWithMediaMediaEmbedExternal():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( UEmbedRecordWithMediaMediaEmbedImages value)?  embedImages,TResult? Function( UEmbedRecordWithMediaMediaEmbedVideo value)?  embedVideo,TResult? Function( UEmbedRecordWithMediaMediaEmbedGallery value)?  embedGallery,TResult? Function( UEmbedRecordWithMediaMediaEmbedExternal value)?  embedExternal,TResult? Function( UEmbedRecordWithMediaMediaUnknown value)?  unknown,}){
final _that = this;
switch (_that) {
case UEmbedRecordWithMediaMediaEmbedImages() when embedImages != null:
return embedImages(_that);case UEmbedRecordWithMediaMediaEmbedVideo() when embedVideo != null:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UEmbedRecordWithMediaMediaEmbedGalleryCopyWith<UEmbedRecordWithMediaMediaEmbedGallery> get copyWith => _$UEmbedRecordWithMediaMediaEmbedGalleryCopyWithImpl<UEmbedRecordWithMediaMediaEmbedGallery>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UEmbedRecordWithMediaMediaEmbedGallery&&(identical(other.data, data) || other.data == data));
}
...
/// @nodoc
abstract mixin class $UEmbedRecordWithMediaMediaEmbedGalleryCopyWith<$Res> implements $UEmbedRecordWithMediaMediaCopyWith<$Res> {
  factory $UEmbedRecordWithMediaMediaEmbedGalleryCopyWith(UEmbedRecordWithMediaMediaEmbedGallery value, $Res Function(UEmbedRecordWithMediaMediaEmbedGallery) _then) = _$UEmbedRecordWithMediaMediaEmbedGalleryCopyWithImpl;
@useResult
$Res call({
 EmbedGallery data
});
...
/// @nodoc
class _$UEmbedRecordWithMediaMediaEmbedGalleryCopyWithImpl<$Res>
    implements $UEmbedRecordWithMediaMediaEmbedGalleryCopyWith<$Res> {
  _$UEmbedRecordWithMediaMediaEmbedGalleryCopyWithImpl(this._self, this._then);

  final UEmbedRecordWithMediaMediaEmbedGallery _self;
  final $Res Function(UEmbedRecordWithMediaMediaEmbedGallery) _then;

/// Create a copy of UEmbedRecordWithMediaMedia
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? data = null,}) {
  return _then(UEmbedRecordWithMediaMediaEmbedGallery(
data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as EmbedGallery,
  ));
}
