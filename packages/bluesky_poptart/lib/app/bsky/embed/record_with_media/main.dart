...
@UEmbedRecordWithMediaMediaConverter() required UEmbedRecordWithMediaMedia media,

    Map<String, dynamic>? $unknown,
  }) = _EmbedRecordWithMedia;

  factory EmbedRecordWithMedia.fromJson(Map<String, Object?> json) => _$EmbedRecordWithMediaFromJson(json);
...
final class EmbedRecordWithMediaConverter
  ...
  EmbedRecordWithMedia fromJson(Map<String, dynamic> json) {
    return EmbedRecordWithMedia.fromJson(translate(
      json,
      EmbedRecordWithMedia.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(EmbedRecordWithMedia object) => untranslate(
        object.toJson(),
      );
}
