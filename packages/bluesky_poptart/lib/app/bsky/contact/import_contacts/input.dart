...
required List<String> contacts,
  ...
  factory ContactImportContactsInput.fromJson(Map<String, Object?> json) => _$ContactImportContactsInputFromJson(json);
}
...
final class ContactImportContactsInputConverter
  ...
  ContactImportContactsInput fromJson(Map<String, dynamic> json) {
    return ContactImportContactsInput.fromJson(translate(
      json,
      ContactImportContactsInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ContactImportContactsInput object) => untranslate(
        object.toJson(),
      );
}
