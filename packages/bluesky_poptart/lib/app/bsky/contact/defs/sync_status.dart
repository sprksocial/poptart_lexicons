...
required int matchesCount,
  ...
  factory SyncStatus.fromJson(Map<String, Object?> json) => _$SyncStatusFromJson(json);
...
final class SyncStatusConverter
  ...
  SyncStatus fromJson(Map<String, dynamic> json) {
    return SyncStatus.fromJson(translate(
      json,
      SyncStatus.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(SyncStatus object) => untranslate(
        object.toJson(),
      );
}
