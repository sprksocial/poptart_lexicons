...
required int contactIndex,
  ...
  factory MatchAndContactIndex.fromJson(Map<String, Object?> json) => _$MatchAndContactIndexFromJson(json);
...
final class MatchAndContactIndexConverter
  ...
  MatchAndContactIndex fromJson(Map<String, dynamic> json) {
    return MatchAndContactIndex.fromJson(translate(
      json,
      MatchAndContactIndex.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(MatchAndContactIndex object) => untranslate(
        object.toJson(),
      );
}
