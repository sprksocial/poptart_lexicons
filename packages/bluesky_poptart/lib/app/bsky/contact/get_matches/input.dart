...
String? cursor,
  ...
  factory ContactGetMatchesInput.fromJson(Map<String, Object?> json) => _$ContactGetMatchesInputFromJson(json);
}
...
final class ContactGetMatchesInputConverter
  ...
  ContactGetMatchesInput fromJson(Map<String, dynamic> json) {
    return ContactGetMatchesInput.fromJson(translate(
      json,
      ContactGetMatchesInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ContactGetMatchesInput object) => untranslate(
        object.toJson(),
      );
}
