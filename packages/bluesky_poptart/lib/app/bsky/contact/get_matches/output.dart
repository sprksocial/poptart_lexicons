...
@ProfileViewConverter() required List<ProfileView> matches,
  ...
  factory ContactGetMatchesOutput.fromJson(Map<String, Object?> json) => _$ContactGetMatchesOutputFromJson(json);
}
...
final class ContactGetMatchesOutputConverter
  ...
  ContactGetMatchesOutput fromJson(Map<String, dynamic> json) {
    return ContactGetMatchesOutput.fromJson(translate(
      json,
      ContactGetMatchesOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ContactGetMatchesOutput object) => untranslate(
        object.toJson(),
      );
}
