...
abstract class StatusView with _$StatusView {
  static const knownProps = <String>['uri', 'cid', 'status', 'record', 'embed', 'expiresAt', 'isActive', 'isDisabled', ];
...
bool? isDisabled,
  ...
  factory StatusView.fromJson(Map<String, Object?> json) => _$StatusViewFromJson(json);
