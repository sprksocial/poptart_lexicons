...
const factory UPreferences.declaredAgePref({
  required DeclaredAgePref data,
...
AdultContentPref? get adultContentPref => isAdultContentPref ? data as AdultContentPref : null;
bool get isContentLabelPref => isA<UPreferencesContentLabelPref>(this);
bool get isNotContentLabelPref => !isContentLabelPref;
ContentLabelPref? get contentLabelPref => isContentLabelPref ? data as ContentLabelPref : null;
bool get isSavedFeedsPref => isA<UPreferencesSavedFeedsPref>(this);
bool get isNotSavedFeedsPref => !isSavedFeedsPref;
SavedFeedsPref? get savedFeedsPref => isSavedFeedsPref ? data as SavedFeedsPref : null;
bool get isSavedFeedsPrefV2 => isA<UPreferencesSavedFeedsPrefV2>(this);
bool get isNotSavedFeedsPrefV2 => !isSavedFeedsPrefV2;
SavedFeedsPrefV2? get savedFeedsPrefV2 => isSavedFeedsPrefV2 ? data as SavedFeedsPrefV2 : null;
...
PersonalDetailsPref? get personalDetailsPref => isPersonalDetailsPref ? data as PersonalDetailsPref : null;
bool get isDeclaredAgePref => isA<UPreferencesDeclaredAgePref>(this);
bool get isNotDeclaredAgePref => !isDeclaredAgePref;
DeclaredAgePref? get declaredAgePref => isDeclaredAgePref ? data as DeclaredAgePref : null;
bool get isFeedViewPref => isA<UPreferencesFeedViewPref>(this);
bool get isNotFeedViewPref => !isFeedViewPref;
FeedViewPref? get feedViewPref => isFeedViewPref ? data as FeedViewPref : null;
bool get isThreadViewPref => isA<UPreferencesThreadViewPref>(this);
bool get isNotThreadViewPref => !isThreadViewPref;
ThreadViewPref? get threadViewPref => isThreadViewPref ? data as ThreadViewPref : null;
bool get isInterestsPref => isA<UPreferencesInterestsPref>(this);
bool get isNotInterestsPref => !isInterestsPref;
InterestsPref? get interestsPref => isInterestsPref ? data as InterestsPref : null;
bool get isMutedWordsPref => isA<UPreferencesMutedWordsPref>(this);
bool get isNotMutedWordsPref => !isMutedWordsPref;
MutedWordsPref? get mutedWordsPref => isMutedWordsPref ? data as MutedWordsPref : null;
bool get isHiddenPostsPref => isA<UPreferencesHiddenPostsPref>(this);
bool get isNotHiddenPostsPref => !isHiddenPostsPref;
HiddenPostsPref? get hiddenPostsPref => isHiddenPostsPref ? data as HiddenPostsPref : null;
bool get isBskyAppStatePref => isA<UPreferencesBskyAppStatePref>(this);
bool get isNotBskyAppStatePref => !isBskyAppStatePref;
BskyAppStatePref? get bskyAppStatePref => isBskyAppStatePref ? data as BskyAppStatePref : null;
bool get isLabelersPref => isA<UPreferencesLabelersPref>(this);
bool get isNotLabelersPref => !isLabelersPref;
LabelersPref? get labelersPref => isLabelersPref ? data as LabelersPref : null;
bool get isPostInteractionSettingsPref => isA<UPreferencesPostInteractionSettingsPref>(this);
bool get isNotPostInteractionSettingsPref => !isPostInteractionSettingsPref;
PostInteractionSettingsPref? get postInteractionSettingsPref => isPostInteractionSettingsPref ? data as PostInteractionSettingsPref : null;
bool get isVerificationPrefs => isA<UPreferencesVerificationPrefs>(this);
bool get isNotVerificationPrefs => !isVerificationPrefs;
VerificationPrefs? get verificationPrefs => isVerificationPrefs ? data as VerificationPrefs : null;
bool get isLiveEventPreferences => isA<UPreferencesLiveEventPreferences>(this);
bool get isNotLiveEventPreferences => !isLiveEventPreferences;
LiveEventPreferences? get liveEventPreferences => isLiveEventPreferences ? data as LiveEventPreferences : null;
...
final class UPreferencesConverter implements JsonConverter<UPreferences, Map<String, dynamic>> {
...
personalDetailsPref: (data) => const PersonalDetailsPrefConverter().toJson(data),
...
postInteractionSettingsPref: (data) => const PostInteractionSettingsPrefConverter().toJson(data),
verificationPrefs: (data) => const VerificationPrefsConverter().toJson(data),
liveEventPreferences: (data) => const LiveEventPreferencesConverter().toJson(data),
