...
abstract class VerificationState with _$VerificationState {
  static const knownProps = <String>['verifications', 'verifiedStatus', 'trustedVerifierStatus', ];
...
@VerificationStateVerifiedStatusConverter() required VerificationStateVerifiedStatus verifiedStatus,
/// The user's status as a trusted verifier.
@VerificationStateTrustedVerifierStatusConverter() required VerificationStateTrustedVerifierStatus trustedVerifierStatus,

    Map<String, dynamic>? $unknown,
  }) = _VerificationState;

  factory VerificationState.fromJson(Map<String, Object?> json) => _$VerificationStateFromJson(json);
