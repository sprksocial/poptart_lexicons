...
import '../../feed/threadgate/mention_rule.dart';
import '../../feed/threadgate/follower_rule.dart';
import '../../feed/threadgate/following_rule.dart';
import '../../feed/threadgate/list_rule.dart';
...
@freezed
sealed class UPostInteractionSettingsPrefThreadgateAllowRules with _$UPostInteractionSettingsPrefThreadgateAllowRules {
...
const factory UPostInteractionSettingsPrefThreadgateAllowRules.listRule({
  ...
  Map<String, dynamic> toJson() => const UPostInteractionSettingsPrefThreadgateAllowRulesConverter().toJson(this);
}

extension UPostInteractionSettingsPrefThreadgateAllowRulesExtension on UPostInteractionSettingsPrefThreadgateAllowRules {
  bool get isMentionRule => isA<UPostInteractionSettingsPrefThreadgateAllowRulesMentionRule>(this);
bool get isNotMentionRule => !isMentionRule;
MentionRule? get mentionRule => isMentionRule ? data as MentionRule : null;
bool get isFollowerRule => isA<UPostInteractionSettingsPrefThreadgateAllowRulesFollowerRule>(this);
bool get isNotFollowerRule => !isFollowerRule;
FollowerRule? get followerRule => isFollowerRule ? data as FollowerRule : null;
bool get isFollowingRule => isA<UPostInteractionSettingsPrefThreadgateAllowRulesFollowingRule>(this);
bool get isNotFollowingRule => !isFollowingRule;
FollowingRule? get followingRule => isFollowingRule ? data as FollowingRule : null;
bool get isListRule => isA<UPostInteractionSettingsPrefThreadgateAllowRulesListRule>(this);
bool get isNotListRule => !isListRule;
ListRule? get listRule => isListRule ? data as ListRule : null;
bool get isUnknown => isA<UPostInteractionSettingsPrefThreadgateAllowRulesUnknown>(this);
bool get isNotUnknown => !isUnknown;
Map<String, dynamic>? get unknown => isUnknown ? data as Map<String, dynamic> : null;

}

final class UPostInteractionSettingsPrefThreadgateAllowRulesConverter implements JsonConverter<UPostInteractionSettingsPrefThreadgateAllowRules, Map<String, dynamic>> {
  const UPostInteractionSettingsPrefThreadgateAllowRulesConverter();

  @override
  UPostInteractionSettingsPrefThreadgateAllowRules fromJson(Map<String, dynamic> json) {
    try {
...
if (ListRule.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UPostInteractionSettingsPrefThreadgateAllowRules object) => object.when(
