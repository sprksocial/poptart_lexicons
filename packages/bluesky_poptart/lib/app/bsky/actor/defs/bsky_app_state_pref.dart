...
abstract class BskyAppStatePref with _$BskyAppStatePref {
  static const knownProps = <String>['activeProgressGuide', 'queuedNudges', 'nuxs', ];
...
@NuxConverter() List<Nux>? nuxs,
  ...
  factory BskyAppStatePref.fromJson(Map<String, Object?> json) => _$BskyAppStatePrefFromJson(json);
