...
import '../defs/chat_preference.dart';
import '../defs/filterable_preference.dart';
import '../defs/preference.dart';
...
@freezed
abstract class NotificationPutPreferencesV2Input with _$NotificationPutPreferencesV2Input {
  static const knownProps = <String>['chat', 'follow', 'like', 'likeViaRepost', 'mention', 'quote', 'reply', 'repost', 'repostViaRepost', 'starterpackJoined', 'subscribedPost', 'unverified', 'verified', ];
...
@PreferenceConverter() Preference? verified,
  ...
  factory NotificationPutPreferencesV2Input.fromJson(Map<String, Object?> json) => _$NotificationPutPreferencesV2InputFromJson(json);
}

extension NotificationPutPreferencesV2InputExtension on NotificationPutPreferencesV2Input {
...
final class NotificationPutPreferencesV2InputConverter
    extends JsonConverter<NotificationPutPreferencesV2Input, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(NotificationPutPreferencesV2Input object) => untranslate(
        object.toJson(),
      );
}
