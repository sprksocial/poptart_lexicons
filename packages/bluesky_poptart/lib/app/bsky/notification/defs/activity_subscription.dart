...
required bool reply,
  ...
  factory ActivitySubscription.fromJson(Map<String, Object?> json) => _$ActivitySubscriptionFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'app.bsky.notification.defs#activitySubscription'
;
}
