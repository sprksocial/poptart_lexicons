...
abstract class SubjectActivitySubscription with _$SubjectActivitySubscription {
  ...
  const factory SubjectActivitySubscription({
    @Default('app.bsky.notification.defs#subjectActivitySubscription') String $type,
...
@ActivitySubscriptionConverter() required ActivitySubscription activitySubscription,
  ...
  factory SubjectActivitySubscription.fromJson(Map<String, Object?> json) => _$SubjectActivitySubscriptionFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'app.bsky.notification.defs#subjectActivitySubscription'
;
}
...
final class SubjectActivitySubscriptionConverter
  ...
  @override
  Map<String, dynamic> toJson(SubjectActivitySubscription object) => untranslate(
        object.toJson(),
      );
}
