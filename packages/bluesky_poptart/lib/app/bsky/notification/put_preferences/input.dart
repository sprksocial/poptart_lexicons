...
@freezed
abstract class NotificationPutPreferencesInput with _$NotificationPutPreferencesInput {
  ...
  factory NotificationPutPreferencesInput.fromJson(Map<String, Object?> json) => _$NotificationPutPreferencesInputFromJson(json);
}

extension NotificationPutPreferencesInputExtension on NotificationPutPreferencesInput {
...
final class NotificationPutPreferencesInputConverter
    extends JsonConverter<NotificationPutPreferencesInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(NotificationPutPreferencesInput object) => untranslate(
        object.toJson(),
      );
}
