...
@freezed
abstract class NotificationRegisterPushPlatform with _$NotificationRegisterPushPlatform {
  ...
  static NotificationRegisterPushPlatform? valueOf(final String? value) {
    ...
    return knownValue != null ? NotificationRegisterPushPlatform.knownValue(data: knownValue) : NotificationRegisterPushPlatform.unknown(data: value);
  }

  String toJson() => const NotificationRegisterPushPlatformConverter().toJson(this);
}

extension NotificationRegisterPushPlatformExtension on NotificationRegisterPushPlatform {
  bool get isKnownValue => isA<NotificationRegisterPushPlatformKnownValue>(this);
bool get isNotKnownValue => !isKnownValue;
KnownNotificationRegisterPushPlatform? get knownValue => isKnownValue ? data as KnownNotificationRegisterPushPlatform : null;
...
final class NotificationRegisterPushPlatformConverter extends JsonConverter<NotificationRegisterPushPlatform, String> {
