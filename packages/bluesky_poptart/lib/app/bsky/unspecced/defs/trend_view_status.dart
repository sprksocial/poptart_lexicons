...
abstract class TrendViewStatus with _$TrendViewStatus {
  ...
  static TrendViewStatus? valueOf(final String? value) {
    ...
    return knownValue != null ? TrendViewStatus.knownValue(data: knownValue) : TrendViewStatus.unknown(data: value);
  }
...
KnownTrendViewStatus? get knownValue => isKnownValue ? data as KnownTrendViewStatus : null;
...
final class TrendViewStatusConverter extends JsonConverter<TrendViewStatus, String> {
