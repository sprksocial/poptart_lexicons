...
abstract class AgeAssuranceEventStatus with _$AgeAssuranceEventStatus {
  ...
  static AgeAssuranceEventStatus? valueOf(final String? value) {
    ...
    return knownValue != null ? AgeAssuranceEventStatus.knownValue(data: knownValue) : AgeAssuranceEventStatus.unknown(data: value);
  }
...
KnownAgeAssuranceEventStatus? get knownValue => isKnownValue ? data as KnownAgeAssuranceEventStatus : null;
...
final class AgeAssuranceEventStatusConverter extends JsonConverter<AgeAssuranceEventStatus, String> {
