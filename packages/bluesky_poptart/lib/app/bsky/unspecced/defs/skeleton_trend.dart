...
abstract class SkeletonTrend with _$SkeletonTrend {
  static const knownProps = <String>['topic', 'displayName', 'link', 'startedAt', 'postCount', 'status', 'category', 'dids', ];
...
required List<String> dids,
  ...
  factory SkeletonTrend.fromJson(Map<String, Object?> json) => _$SkeletonTrendFromJson(json);
