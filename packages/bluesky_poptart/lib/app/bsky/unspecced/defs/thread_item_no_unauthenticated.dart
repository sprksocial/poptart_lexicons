...
abstract class ThreadItemNoUnauthenticated with _$ThreadItemNoUnauthenticated {
  ...
  const factory ThreadItemNoUnauthenticated({
    @Default('app.bsky.unspecced.defs#threadItemNoUnauthenticated') String $type,
    
    Map<String, dynamic>? $unknown,
  }) = _ThreadItemNoUnauthenticated;

  factory ThreadItemNoUnauthenticated.fromJson(Map<String, Object?> json) => _$ThreadItemNoUnauthenticatedFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'app.bsky.unspecced.defs#threadItemNoUnauthenticated'
;
}
...
final class ThreadItemNoUnauthenticatedConverter
  ...
  @override
  Map<String, dynamic> toJson(ThreadItemNoUnauthenticated object) => untranslate(
        object.toJson(),
      );
}
