...
@freezed
abstract class UnspeccedGetPostThreadV2Input with _$UnspeccedGetPostThreadV2Input {
  static const knownProps = <String>['anchor', 'above', 'below', 'branchingFactor', 'sort', ];
...
@UnspeccedGetPostThreadV2SortConverter() UnspeccedGetPostThreadV2Sort? sort,
  ...
  factory UnspeccedGetPostThreadV2Input.fromJson(Map<String, Object?> json) => _$UnspeccedGetPostThreadV2InputFromJson(json);
}

extension UnspeccedGetPostThreadV2InputExtension on UnspeccedGetPostThreadV2Input {
...
final class UnspeccedGetPostThreadV2InputConverter
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedGetPostThreadV2Input object) => untranslate(
        object.toJson(),
      );
}
