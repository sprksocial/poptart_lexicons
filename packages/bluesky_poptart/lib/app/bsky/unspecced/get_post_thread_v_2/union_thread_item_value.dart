...
import '../defs/thread_item_post.dart';
import '../defs/thread_item_no_unauthenticated.dart';
import '../defs/thread_item_not_found.dart';
import '../defs/thread_item_blocked.dart';
...
ThreadItemPost? get threadItemPost => isThreadItemPost ? data as ThreadItemPost : null;
bool get isThreadItemNoUnauthenticated => isA<UThreadItemValueThreadItemNoUnauthenticated>(this);
bool get isNotThreadItemNoUnauthenticated => !isThreadItemNoUnauthenticated;
ThreadItemNoUnauthenticated? get threadItemNoUnauthenticated => isThreadItemNoUnauthenticated ? data as ThreadItemNoUnauthenticated : null;
bool get isThreadItemNotFound => isA<UThreadItemValueThreadItemNotFound>(this);
bool get isNotThreadItemNotFound => !isThreadItemNotFound;
ThreadItemNotFound? get threadItemNotFound => isThreadItemNotFound ? data as ThreadItemNotFound : null;
...
ThreadItemBlocked? get threadItemBlocked => isThreadItemBlocked ? data as ThreadItemBlocked : null;
...
threadItemNoUnauthenticated: (data) => const ThreadItemNoUnauthenticatedConverter().toJson(data),
threadItemNotFound: (data) => const ThreadItemNotFoundConverter().toJson(data),
threadItemBlocked: (data) => const ThreadItemBlockedConverter().toJson(data),
