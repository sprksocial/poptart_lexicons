...
@freezed
abstract class UnspeccedGetTaggedSuggestionsOutput with _$UnspeccedGetTaggedSuggestionsOutput {
  ...
  factory UnspeccedGetTaggedSuggestionsOutput.fromJson(Map<String, Object?> json) => _$UnspeccedGetTaggedSuggestionsOutputFromJson(json);
}



final class UnspeccedGetTaggedSuggestionsOutputConverter
    extends JsonConverter<UnspeccedGetTaggedSuggestionsOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedGetTaggedSuggestionsOutput object) => untranslate(
        object.toJson(),
      );
}
