...
@freezed
abstract class UnspeccedSearchActorsSkeletonOutput with _$UnspeccedSearchActorsSkeletonOutput {
...
@SkeletonSearchActorConverter() required List<SkeletonSearchActor> actors,
  ...
  factory UnspeccedSearchActorsSkeletonOutput.fromJson(Map<String, Object?> json) => _$UnspeccedSearchActorsSkeletonOutputFromJson(json);
}

extension UnspeccedSearchActorsSkeletonOutputExtension on UnspeccedSearchActorsSkeletonOutput {
...
final class UnspeccedSearchActorsSkeletonOutputConverter
    extends JsonConverter<UnspeccedSearchActorsSkeletonOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedSearchActorsSkeletonOutput object) => untranslate(
        object.toJson(),
      );
}
