...
@freezed
abstract class UnspeccedGetSuggestedUsersOutput with _$UnspeccedGetSuggestedUsersOutput {
...
String? recIdStr,
  ...
  factory UnspeccedGetSuggestedUsersOutput.fromJson(Map<String, Object?> json) => _$UnspeccedGetSuggestedUsersOutputFromJson(json);
}

extension UnspeccedGetSuggestedUsersOutputExtension on UnspeccedGetSuggestedUsersOutput {
...
final class UnspeccedGetSuggestedUsersOutputConverter
    extends JsonConverter<UnspeccedGetSuggestedUsersOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedGetSuggestedUsersOutput object) => untranslate(
        object.toJson(),
      );
}
