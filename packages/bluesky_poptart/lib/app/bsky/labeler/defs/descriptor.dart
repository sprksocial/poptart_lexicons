...
final labelerViewDescriptor = XRPCObjectDescriptor<LabelerView>(
  ...
  defName: 'labelerView',
  fromJson: (json) => const LabelerViewConverter().fromJson(json.cast<String, dynamic>()),
...
final labelerViewDetailedDescriptor = XRPCObjectDescriptor<LabelerViewDetailed>(
  ...
  fromJson: (json) => const LabelerViewDetailedConverter().fromJson(json.cast<String, dynamic>()),
...
final labelerViewerStateDescriptor = XRPCObjectDescriptor<LabelerViewerState>(
  ...
  fromJson: (json) => const LabelerViewerStateConverter().fromJson(json.cast<String, dynamic>()),
...
final labelerPoliciesDescriptor = XRPCObjectDescriptor<LabelerPolicies>(
  ...
  fromJson: (json) => const LabelerPoliciesConverter().fromJson(json.cast<String, dynamic>()),
