...
sealed class UFeedPostgateEmbeddingRules with _$UFeedPostgateEmbeddingRules {
  ...
  Map<String, dynamic> toJson() => const UFeedPostgateEmbeddingRulesConverter().toJson(this);
}
...
final class UFeedPostgateEmbeddingRulesConverter implements JsonConverter<UFeedPostgateEmbeddingRules, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UFeedPostgateEmbeddingRules object) => object.when(
