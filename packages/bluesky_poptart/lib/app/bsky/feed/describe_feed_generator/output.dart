...
@freezed
abstract class FeedDescribeFeedGeneratorOutput with _$FeedDescribeFeedGeneratorOutput {
...
@LinksConverter() Links? links,
  ...
  factory FeedDescribeFeedGeneratorOutput.fromJson(Map<String, Object?> json) => _$FeedDescribeFeedGeneratorOutputFromJson(json);
}

extension FeedDescribeFeedGeneratorOutputExtension on FeedDescribeFeedGeneratorOutput {
...
final class FeedDescribeFeedGeneratorOutputConverter
    extends JsonConverter<FeedDescribeFeedGeneratorOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(FeedDescribeFeedGeneratorOutput object) => untranslate(
        object.toJson(),
      );
}
