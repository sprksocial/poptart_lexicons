...
const factory UThreadViewPostParent.blockedPost({
  ...
  Map<String, dynamic> toJson() => const UThreadViewPostParentConverter().toJson(this);
}
...
final class UThreadViewPostParentConverter implements JsonConverter<UThreadViewPostParent, Map<String, dynamic>> {
