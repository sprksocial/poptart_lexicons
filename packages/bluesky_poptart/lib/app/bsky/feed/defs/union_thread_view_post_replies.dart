...
const factory UThreadViewPostReplies.blockedPost({
  ...
  Map<String, dynamic> toJson() => const UThreadViewPostRepliesConverter().toJson(this);
}
...
final class UThreadViewPostRepliesConverter implements JsonConverter<UThreadViewPostReplies, Map<String, dynamic>> {
