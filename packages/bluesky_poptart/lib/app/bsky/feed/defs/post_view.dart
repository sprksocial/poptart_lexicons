...
abstract class PostView with _$PostView {
  static const knownProps = <String>['uri', 'cid', 'author', 'record', 'embed', 'bookmarkCount', 'replyCount', 'repostCount', 'likeCount', 'quoteCount', 'indexedAt', 'viewer', 'labels', 'threadgate', 'debug', ];
...
Map<String, dynamic>? debug,
  ...
  factory PostView.fromJson(Map<String, Object?> json) => _$PostViewFromJson(json);
