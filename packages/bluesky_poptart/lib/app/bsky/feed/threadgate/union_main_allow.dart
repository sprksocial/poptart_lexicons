...
const factory UFeedThreadgateAllow.listRule({
  ...
  Map<String, dynamic> toJson() => const UFeedThreadgateAllowConverter().toJson(this);
}
...
final class UFeedThreadgateAllowConverter implements JsonConverter<UFeedThreadgateAllow, Map<String, dynamic>> {
