...
abstract class FeedSearchPostsInput with _$FeedSearchPostsInput {
  static const knownProps = <String>['q', 'sort', 'since', 'until', 'mentions', 'author', 'lang', 'domain', 'url', 'tag', 'limit', 'cursor', ];
...
String? cursor,
  ...
  factory FeedSearchPostsInput.fromJson(Map<String, Object?> json) => _$FeedSearchPostsInputFromJson(json);
}
