...
EmbedExternal? get embedExternal => isEmbedExternal ? data as EmbedExternal : null;
...
bool get isEmbedRecordWithMedia => isA<UFeedPostEmbedEmbedRecordWithMedia>(this);
bool get isNotEmbedRecordWithMedia => !isEmbedRecordWithMedia;
EmbedRecordWithMedia? get embedRecordWithMedia => isEmbedRecordWithMedia ? data as EmbedRecordWithMedia : null;
...
final class UFeedPostEmbedConverter implements JsonConverter<UFeedPostEmbed, Map<String, dynamic>> {
...
embedRecordWithMedia: (data) => const EmbedRecordWithMediaConverter().toJson(data),
