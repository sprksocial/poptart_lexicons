...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReplyRef&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.cid, cid) || other.cid == cid)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
@override
String toString() {
  return 'ReplyRef(\$type: ${$type}, uri: $uri, cid: $cid, \$unknown: ${$unknown})';
}
...
class _ReplyRef implements ReplyRef {
  const _ReplyRef({this.$type = 'at.margin.reply#replyRef', @AtUriConverter() required this.uri, required this.cid, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReplyRef&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.cid, cid) || other.cid == cid)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
