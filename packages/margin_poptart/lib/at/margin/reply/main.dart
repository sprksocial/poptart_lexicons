...
abstract class ReplyRecord with _$ReplyRecord {
  static const knownProps = <String>['parent', 'root', 'text', 'format', 'createdAt', ];
...
required DateTime createdAt,
  ...
  factory ReplyRecord.fromJson(Map<String, Object?> json) => _$ReplyRecordFromJson(json);
...
final class ReplyRecordConverter
  ...
  ReplyRecord fromJson(Map<String, dynamic> json) {
    return ReplyRecord.fromJson(translate(
      json,
      ReplyRecord.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ReplyRecord object) => untranslate(
        object.toJson(),
      );
}
