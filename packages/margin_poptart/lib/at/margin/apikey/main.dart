...
required DateTime createdAt,
  ...
  factory ApikeyRecord.fromJson(Map<String, Object?> json) => _$ApikeyRecordFromJson(json);
...
final class ApikeyRecordConverter
  ...
  ApikeyRecord fromJson(Map<String, dynamic> json) {
    return ApikeyRecord.fromJson(translate(
      json,
      ApikeyRecord.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ApikeyRecord object) => untranslate(
        object.toJson(),
      );
}
