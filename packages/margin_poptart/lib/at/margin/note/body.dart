...
final class BodyConverter extends JsonConverter<Body, Map<String, dynamic>> {
  const BodyConverter();

  @override
  Body fromJson(Map<String, dynamic> json) {
    return Body.fromJson(translate(json, Body.knownProps));
  }

  @override
  Map<String, dynamic> toJson(Body object) => untranslate(object.toJson());
}
