...
String? cached,
  ...
  factory TimeState.fromJson(Map<String, Object?> json) => _$TimeStateFromJson(json);
...
final class TimeStateConverter
  ...
  TimeState fromJson(Map<String, dynamic> json) {
    return TimeState.fromJson(translate(
      json,
      TimeState.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(TimeState object) => untranslate(
        object.toJson(),
      );
}
