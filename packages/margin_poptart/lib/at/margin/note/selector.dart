...
abstract class Selector with _$Selector {
  static const knownProps = <String>['type', 'exact', 'prefix', 'suffix', 'start', 'end', 'value', 'conformsTo', ];
...
final class SelectorConverter
  ...
  Selector fromJson(Map<String, dynamic> json) {
    return Selector.fromJson(translate(
      json,
      Selector.knownProps,
    ));
  }
  ...
  @override
  Map<String, dynamic> toJson(Selector object) => untranslate(
        object.toJson(),
      );
}
