...
final noteRecordDescriptor = XRPCRecordDescriptor<NoteRecord>(
  nsid: 'at.margin.note',
  defName: 'main',
  fromJson: (json) => const NoteRecordConverter().fromJson(json.cast<String, dynamic>()),
...
final generatorDescriptor = XRPCObjectDescriptor<Generator>(
  nsid: 'at.margin.note',
  defName: 'generator',
  fromJson: (json) => const GeneratorConverter().fromJson(json.cast<String, dynamic>()),
...
final bodyDescriptor = XRPCObjectDescriptor<Body>(
  nsid: 'at.margin.note',
  defName: 'body',
  fromJson: (json) => const BodyConverter().fromJson(json.cast<String, dynamic>()),
...
final targetDescriptor = XRPCObjectDescriptor<Target>(
  nsid: 'at.margin.note',
  defName: 'target',
  fromJson: (json) => const TargetConverter().fromJson(json.cast<String, dynamic>()),
...
final selectorDescriptor = XRPCObjectDescriptor<Selector>(
  nsid: 'at.margin.note',
  defName: 'selector',
  fromJson: (json) => const SelectorConverter().fromJson(json.cast<String, dynamic>()),
...
final timeStateDescriptor = XRPCObjectDescriptor<TimeState>(
  nsid: 'at.margin.note',
  defName: 'timeState',
  fromJson: (json) => const TimeStateConverter().fromJson(json.cast<String, dynamic>()),
