...
abstract class NoteMotivation with _$NoteMotivation {
  ...
  const factory NoteMotivation.knownValue({
    required KnownNoteMotivation data,
  }) = NoteMotivationKnownValue;

  const factory NoteMotivation.unknown({
  ...
  static NoteMotivation? valueOf(final String? value) {
    ...
    return knownValue != null ? NoteMotivation.knownValue(data: knownValue) : NoteMotivation.unknown(data: value);
  }
...
KnownNoteMotivation? get knownValue => isKnownValue ? data as KnownNoteMotivation : null;
...
final class NoteMotivationConverter extends JsonConverter<NoteMotivation, String> {
  ...
  @override
  String toJson(NoteMotivation object) => object.when(
