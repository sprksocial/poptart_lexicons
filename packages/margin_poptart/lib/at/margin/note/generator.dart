...
abstract class Generator with _$Generator {
  ...
  factory Generator.fromJson(Map<String, Object?> json) =>
...
final class GeneratorConverter
  ...
  Generator fromJson(Map<String, dynamic> json) {
    return Generator.fromJson(translate(json, Generator.knownProps));
  }

  @override
  Map<String, dynamic> toJson(Generator object) => untranslate(object.toJson());
}
