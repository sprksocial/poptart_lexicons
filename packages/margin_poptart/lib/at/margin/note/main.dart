...
abstract class NoteRecord with _$NoteRecord {
  ...
  factory NoteRecord.fromJson(Map<String, Object?> json) =>
...
final class NoteRecordConverter
  ...
  NoteRecord fromJson(Map<String, dynamic> json) {
    return NoteRecord.fromJson(translate(json, NoteRecord.knownProps));
  }

  @override
  Map<String, dynamic> toJson(NoteRecord object) =>
