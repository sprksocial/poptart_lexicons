...
abstract class LabelPreference with _$LabelPreference {
  ...
  const factory LabelPreference({
    ...
    @LabelPreferenceVisibilityConverter()
    required LabelPreferenceVisibility visibility,

    Map<String, dynamic>? $unknown,
  }) = _LabelPreference;

  factory LabelPreference.fromJson(Map<String, Object?> json) =>
...
final class LabelPreferenceConverter
  ...
  LabelPreference fromJson(Map<String, dynamic> json) {
    return LabelPreference.fromJson(
      translate(json, LabelPreference.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(LabelPreference object) =>
