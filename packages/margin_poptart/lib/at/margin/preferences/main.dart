...
abstract class PreferencesRecord with _$PreferencesRecord {
  ...
  const factory PreferencesRecord({
    ...
    @LabelerSubscriptionConverter()
    List<LabelerSubscription>? subscribedLabelers,
  ...
  factory PreferencesRecord.fromJson(Map<String, Object?> json) =>
      _$PreferencesRecordFromJson(json);
...
final class PreferencesRecordConverter
  ...
  PreferencesRecord fromJson(Map<String, dynamic> json) {
    return PreferencesRecord.fromJson(
      translate(json, PreferencesRecord.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(PreferencesRecord object) =>
