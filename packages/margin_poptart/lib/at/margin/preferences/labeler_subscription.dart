...
abstract class LabelerSubscription with _$LabelerSubscription {
  ...
  factory LabelerSubscription.fromJson(Map<String, Object?> json) =>
      _$LabelerSubscriptionFromJson(json);
...
final class LabelerSubscriptionConverter
  ...
  LabelerSubscription fromJson(Map<String, dynamic> json) {
    return LabelerSubscription.fromJson(
      translate(json, LabelerSubscription.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(LabelerSubscription object) =>
