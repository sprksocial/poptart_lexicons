...
mixin _$LikeRecord {
 ...
 String get $type;/// Reference to the annotation or reply being liked
@SubjectRefConverter() SubjectRef get subject; DateTime get createdAt; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
 String $type,@SubjectRefConverter() SubjectRef subject, DateTime createdAt, Map<String, dynamic>? $unknown
});
...
as SubjectRef,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type, @SubjectRefConverter()  SubjectRef subject,  DateTime createdAt,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LikeRecord() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type, @SubjectRefConverter()  SubjectRef subject,  DateTime createdAt,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _LikeRecord():
return $default(_that.$type,_that.subject,_that.createdAt,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type, @SubjectRefConverter()  SubjectRef subject,  DateTime createdAt,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _LikeRecord() when $default != null:
return $default(_that.$type,_that.subject,_that.createdAt,_that.$unknown);case _:
  return null;
...
class _LikeRecord implements LikeRecord {
  const _LikeRecord({this.$type = 'at.margin.like', @SubjectRefConverter() required this.subject, required this.createdAt, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@override@SubjectRefConverter() final  SubjectRef subject;
...
@override $SubjectRefCopyWith<$Res> get subject;
