...
required String cid,
  ...
  factory SubjectRef.fromJson(Map<String, Object?> json) => _$SubjectRefFromJson(json);
...
final class SubjectRefConverter
  ...
  SubjectRef fromJson(Map<String, dynamic> json) {
    return SubjectRef.fromJson(translate(
      json,
      SubjectRef.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(SubjectRef object) => untranslate(
        object.toJson(),
      );
}
