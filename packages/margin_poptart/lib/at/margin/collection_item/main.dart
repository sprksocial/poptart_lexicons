...
abstract class CollectionItemRecord with _$CollectionItemRecord {
  static const knownProps = <String>['collection', 'annotation', 'position', 'createdAt', ];
...
required DateTime createdAt,
  ...
  factory CollectionItemRecord.fromJson(Map<String, Object?> json) => _$CollectionItemRecordFromJson(json);
...
final class CollectionItemRecordConverter
  ...
  CollectionItemRecord fromJson(Map<String, dynamic> json) {
    return CollectionItemRecord.fromJson(translate(
      json,
      CollectionItemRecord.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(CollectionItemRecord object) => untranslate(
        object.toJson(),
      );
}
