...
abstract class CollectionRecord with _$CollectionRecord {
  static const knownProps = <String>['name', 'description', 'icon', 'createdAt', ];
...
required DateTime createdAt,
  ...
  factory CollectionRecord.fromJson(Map<String, Object?> json) => _$CollectionRecordFromJson(json);
...
final class CollectionRecordConverter
  ...
  CollectionRecord fromJson(Map<String, dynamic> json) {
    return CollectionRecord.fromJson(translate(
      json,
      CollectionRecord.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(CollectionRecord object) => untranslate(
        object.toJson(),
      );
}
