...
@freezed
abstract class SignatureFindCorrelationInput with _$SignatureFindCorrelationInput {
  ...
  factory SignatureFindCorrelationInput.fromJson(Map<String, Object?> json) => _$SignatureFindCorrelationInputFromJson(json);
}
...
final class SignatureFindCorrelationInputConverter
  ...
  @override
  Map<String, dynamic> toJson(SignatureFindCorrelationInput object) => untranslate(
        object.toJson(),
      );
}
