...
@freezed
abstract class CommunicationUpdateTemplateInput with _$CommunicationUpdateTemplateInput {
  static const knownProps = <String>['id', 'name', 'lang', 'contentMarkdown', 'subject', 'updatedBy', 'disabled', ];
...
bool? disabled,
  ...
  factory CommunicationUpdateTemplateInput.fromJson(Map<String, Object?> json) => _$CommunicationUpdateTemplateInputFromJson(json);
}

extension CommunicationUpdateTemplateInputExtension on CommunicationUpdateTemplateInput {
...
final class CommunicationUpdateTemplateInputConverter
    extends JsonConverter<CommunicationUpdateTemplateInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(CommunicationUpdateTemplateInput object) => untranslate(
        object.toJson(),
      );
}
