...
abstract class TemplateView with _$TemplateView {
  static const knownProps = <String>['id', 'name', 'subject', 'contentMarkdown', 'disabled', 'lang', 'lastUpdatedBy', 'createdAt', 'updatedAt', ];
...
required DateTime updatedAt,
  ...
  factory TemplateView.fromJson(Map<String, Object?> json) => _$TemplateViewFromJson(json);
