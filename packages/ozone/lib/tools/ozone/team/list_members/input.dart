...
abstract class TeamListMembersInput with _$TeamListMembersInput {
  static const knownProps = <String>['q', 'disabled', 'roles', 'limit', 'cursor', ];
...
String? cursor,
  ...
  factory TeamListMembersInput.fromJson(Map<String, Object?> json) => _$TeamListMembersInputFromJson(json);
}
