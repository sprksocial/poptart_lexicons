...
abstract class MemberRole with _$MemberRole {
  ...
  static MemberRole? valueOf(final String? value) {
    ...
    return knownValue != null ? MemberRole.knownValue(data: knownValue) : MemberRole.unknown(data: value);
  }
...
KnownMemberRole? get knownValue => isKnownValue ? data as KnownMemberRole : null;
