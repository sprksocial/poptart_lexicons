...
@freezed
abstract class HostingGetAccountHistoryEvents with _$HostingGetAccountHistoryEvents {
  ...
  static HostingGetAccountHistoryEvents? valueOf(final String? value) {
    ...
    return knownValue != null ? HostingGetAccountHistoryEvents.knownValue(data: knownValue) : HostingGetAccountHistoryEvents.unknown(data: value);
  }

  String toJson() => const HostingGetAccountHistoryEventsConverter().toJson(this);
}

extension HostingGetAccountHistoryEventsExtension on HostingGetAccountHistoryEvents {
  bool get isKnownValue => isA<HostingGetAccountHistoryEventsKnownValue>(this);
bool get isNotKnownValue => !isKnownValue;
KnownHostingGetAccountHistoryEvents? get knownValue => isKnownValue ? data as KnownHostingGetAccountHistoryEvents : null;
...
final class HostingGetAccountHistoryEventsConverter extends JsonConverter<HostingGetAccountHistoryEvents, String> {
