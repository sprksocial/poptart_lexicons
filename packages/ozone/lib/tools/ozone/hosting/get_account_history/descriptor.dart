...
final accountCreatedDescriptor = XRPCObjectDescriptor<AccountCreated>(
  ...
  fromJson: (json) => const AccountCreatedConverter().fromJson(json.cast<String, dynamic>()),
...
final emailUpdatedDescriptor = XRPCObjectDescriptor<EmailUpdated>(
  ...
  fromJson: (json) => const EmailUpdatedConverter().fromJson(json.cast<String, dynamic>()),
...
final emailConfirmedDescriptor = XRPCObjectDescriptor<EmailConfirmed>(
  ...
  fromJson: (json) => const EmailConfirmedConverter().fromJson(json.cast<String, dynamic>()),
...
final passwordUpdatedDescriptor = XRPCObjectDescriptor<PasswordUpdated>(
  ...
  fromJson: (json) => const PasswordUpdatedConverter().fromJson(json.cast<String, dynamic>()),
...
final handleUpdatedDescriptor = XRPCObjectDescriptor<HandleUpdated>(
  ...
  fromJson: (json) => const HandleUpdatedConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const HandleUpdatedConverter().toJson,
  matches: HandleUpdated.validate,
);

final methodDescriptor = XRPCMethodDescriptor<HostingGetAccountHistoryInput, EmptyData, HostingGetAccountHistoryOutput>(
  nsid: NSID.parse('tools.ozone.hosting.getAccountHistory'),
  kind: XRPCMethodKind.query,  parametersFromJson: (json) => const HostingGetAccountHistoryInputConverter().fromJson(json.cast<String, dynamic>()),
  parametersToJson: const HostingGetAccountHistoryInputConverter().toJson,  outputFromJson: (json) => const HostingGetAccountHistoryOutputConverter().fromJson(json.cast<String, dynamic>()),
