...
abstract class PasswordUpdated with _$PasswordUpdated {
  ...
  const factory PasswordUpdated({
    @Default('tools.ozone.hosting.getAccountHistory#passwordUpdated') String $type,
    
    Map<String, dynamic>? $unknown,
  }) = _PasswordUpdated;

  factory PasswordUpdated.fromJson(Map<String, Object?> json) => _$PasswordUpdatedFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.hosting.getAccountHistory#passwordUpdated'
;
}
