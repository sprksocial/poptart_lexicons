...
bool? acknowledgeAccountSubjects,
  ...
  factory ModEventAcknowledge.fromJson(Map<String, Object?> json) => _$ModEventAcknowledgeFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.defs#modEventAcknowledge'
;
}
