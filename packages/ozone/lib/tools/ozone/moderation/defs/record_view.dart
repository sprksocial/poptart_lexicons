...
abstract class RecordView with _$RecordView {
  static const knownProps = <String>['uri', 'cid', 'value', 'blobCids', 'indexedAt', 'moderation', 'repo', ];
...
@RepoViewConverter() required RepoView repo,
  ...
  factory RecordView.fromJson(Map<String, Object?> json) => _$RecordViewFromJson(json);
