...
const factory UModEventViewDetailSubject.recordViewNotFound({
  ...
  Map<String, dynamic> toJson() => const UModEventViewDetailSubjectConverter().toJson(this);
}
...
bool get isRepoViewNotFound => isA<UModEventViewDetailSubjectRepoViewNotFound>(this);
...
bool get isRecordViewNotFound => isA<UModEventViewDetailSubjectRecordViewNotFound>(this);
...
final class UModEventViewDetailSubjectConverter implements JsonConverter<UModEventViewDetailSubject, Map<String, dynamic>> {
