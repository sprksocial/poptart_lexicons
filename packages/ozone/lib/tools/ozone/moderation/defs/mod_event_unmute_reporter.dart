...
String? comment,
  ...
  factory ModEventUnmuteReporter.fromJson(Map<String, Object?> json) => _$ModEventUnmuteReporterFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.defs#modEventUnmuteReporter'
;
}
