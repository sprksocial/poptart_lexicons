...
abstract class ModEventReverseTakedown with _$ModEventReverseTakedown {
  static const knownProps = <String>['comment', 'policies', 'severityLevel', 'strikeCount', ];

  @JsonSerializable(includeIfNull: false)
  const factory ModEventReverseTakedown({
    @Default('tools.ozone.moderation.defs#modEventReverseTakedown') String $type,
...
int? strikeCount,
  ...
  factory ModEventReverseTakedown.fromJson(Map<String, Object?> json) => _$ModEventReverseTakedownFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.defs#modEventReverseTakedown'
;
}
