...
abstract class ScheduledActionView with _$ScheduledActionView {
  static const knownProps = <String>['id', 'action', 'eventData', 'did', 'executeAt', 'executeAfter', 'executeUntil', 'randomizeExecution', 'createdBy', 'createdAt', 'updatedAt', 'status', 'lastExecutedAt', 'lastFailureReason', 'executionEventId', ];
...
int? executionEventId,
  ...
  factory ScheduledActionView.fromJson(Map<String, Object?> json) => _$ScheduledActionViewFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.defs#scheduledActionView'
;
}
...
final class ScheduledActionViewConverter
  ...
  ScheduledActionView fromJson(Map<String, dynamic> json) {
    return ScheduledActionView.fromJson(translate(
      json,
      ScheduledActionView.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ScheduledActionView object) => untranslate(
        object.toJson(),
      );
}
