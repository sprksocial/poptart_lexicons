...
abstract class RepoViewDetail with _$RepoViewDetail {
  static const knownProps = <String>['did', 'handle', 'email', 'relatedRecords', 'indexedAt', 'moderation', 'labels', 'invitedBy', 'invites', 'invitesDisabled', 'inviteNote', 'emailConfirmedAt', 'deactivatedAt', 'threatSignatures', ];
...
@ThreatSignatureConverter() List<ThreatSignature>? threatSignatures,
  ...
  factory RepoViewDetail.fromJson(Map<String, Object?> json) => _$RepoViewDetailFromJson(json);
