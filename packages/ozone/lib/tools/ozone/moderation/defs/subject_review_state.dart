...
abstract class SubjectReviewState with _$SubjectReviewState {
  ...
  static SubjectReviewState? valueOf(final String? value) {
    ...
    return knownValue != null ? SubjectReviewState.knownValue(data: knownValue) : SubjectReviewState.unknown(data: value);
  }
...
KnownSubjectReviewState? get knownValue => isKnownValue ? data as KnownSubjectReviewState : null;
...
final class SubjectReviewStateConverter extends JsonConverter<SubjectReviewState, String> {
