...
int? durationInHours,
  ...
  factory ModEventMuteReporter.fromJson(Map<String, Object?> json) => _$ModEventMuteReporterFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.defs#modEventMuteReporter'
;
}
