...
required String comment,
  ...
  factory AgeAssurancePurgeEvent.fromJson(Map<String, Object?> json) => _$AgeAssurancePurgeEventFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.defs#ageAssurancePurgeEvent'
;
}
...
final class AgeAssurancePurgeEventConverter
  ...
  AgeAssurancePurgeEvent fromJson(Map<String, dynamic> json) {
    return AgeAssurancePurgeEvent.fromJson(translate(
      json,
      AgeAssurancePurgeEvent.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(AgeAssurancePurgeEvent object) => untranslate(
        object.toJson(),
      );
}
