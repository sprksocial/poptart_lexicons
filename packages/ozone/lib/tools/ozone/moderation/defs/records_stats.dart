...
abstract class RecordsStats with _$RecordsStats {
  static const knownProps = <String>['totalReports', 'reportedCount', 'escalatedCount', 'appealedCount', 'subjectCount', 'pendingCount', 'processedCount', 'takendownCount', ];
...
int? takendownCount,
  ...
  factory RecordsStats.fromJson(Map<String, Object?> json) => _$RecordsStatsFromJson(json);
