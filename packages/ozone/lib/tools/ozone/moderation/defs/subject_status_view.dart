...
abstract class SubjectStatusView with _$SubjectStatusView {
  static const knownProps = <String>['id', 'subject', 'hosting', 'subjectBlobCids', 'subjectRepoHandle', 'updatedAt', 'createdAt', 'reviewState', 'comment', 'priorityScore', 'muteUntil', 'muteReportingUntil', 'lastReviewedBy', 'lastReviewedAt', 'lastReportedAt', 'lastAppealedAt', 'takendown', 'appealed', 'suspendUntil', 'tags', 'accountStats', 'recordsStats', 'accountStrike', 'ageAssuranceState', 'ageAssuranceUpdatedBy', ];
...
@SubjectStatusViewAgeAssuranceUpdatedByConverter() SubjectStatusViewAgeAssuranceUpdatedBy? ageAssuranceUpdatedBy,
  ...
  factory SubjectStatusView.fromJson(Map<String, Object?> json) => _$SubjectStatusViewFromJson(json);
