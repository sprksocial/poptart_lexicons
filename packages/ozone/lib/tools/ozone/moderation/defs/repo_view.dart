...
import 'package:poptart_lex/com/atproto/server/defs.dart';
...
abstract class RepoView with _$RepoView {
  static const knownProps = <String>['did', 'handle', 'email', 'relatedRecords', 'indexedAt', 'moderation', 'invitedBy', 'invitesDisabled', 'inviteNote', 'deactivatedAt', 'threatSignatures', ];
...
@ThreatSignatureConverter() List<ThreatSignature>? threatSignatures,
  ...
  factory RepoView.fromJson(Map<String, Object?> json) => _$RepoViewFromJson(json);
...
final class RepoViewConverter
  ...
  RepoView fromJson(Map<String, dynamic> json) {
    return RepoView.fromJson(translate(
      json,
      RepoView.knownProps,
    ));
  }
  ...
  @override
  Map<String, dynamic> toJson(RepoView object) => untranslate(
        object.toJson(),
      );
}
