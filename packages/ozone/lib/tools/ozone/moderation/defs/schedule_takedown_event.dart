...
abstract class ScheduleTakedownEvent with _$ScheduleTakedownEvent {
  static const knownProps = <String>['comment', 'executeAt', 'executeAfter', 'executeUntil', ];
...
DateTime? executeUntil,
  ...
  factory ScheduleTakedownEvent.fromJson(Map<String, Object?> json) => _$ScheduleTakedownEventFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.defs#scheduleTakedownEvent'
;
}
...
final class ScheduleTakedownEventConverter
  ...
  ScheduleTakedownEvent fromJson(Map<String, dynamic> json) {
    return ScheduleTakedownEvent.fromJson(translate(
      json,
      ScheduleTakedownEvent.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ScheduleTakedownEvent object) => untranslate(
        object.toJson(),
      );
}
