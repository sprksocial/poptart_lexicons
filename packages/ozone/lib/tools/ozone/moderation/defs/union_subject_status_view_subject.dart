...
const factory USubjectStatusViewSubject.messageRef({
  ...
  Map<String, dynamic> toJson() => const USubjectStatusViewSubjectConverter().toJson(this);
}
...
final class USubjectStatusViewSubjectConverter implements JsonConverter<USubjectStatusViewSubject, Map<String, dynamic>> {
