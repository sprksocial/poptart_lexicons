...
const factory UModEventViewSubject.messageRef({
  ...
  Map<String, dynamic> toJson() => const UModEventViewSubjectConverter().toJson(this);
}
...
final class UModEventViewSubjectConverter implements JsonConverter<UModEventViewSubject, Map<String, dynamic>> {
