...
const factory UModerationGetRecordsRecords.recordViewNotFound({
  ...
  Map<String, dynamic> toJson() => const UModerationGetRecordsRecordsConverter().toJson(this);
}

extension UModerationGetRecordsRecordsExtension on UModerationGetRecordsRecords {
  bool get isRecordViewDetail => isA<UModerationGetRecordsRecordsRecordViewDetail>(this);
bool get isNotRecordViewDetail => !isRecordViewDetail;
RecordViewDetail? get recordViewDetail => isRecordViewDetail ? data as RecordViewDetail : null;
bool get isRecordViewNotFound => isA<UModerationGetRecordsRecordsRecordViewNotFound>(this);
bool get isNotRecordViewNotFound => !isRecordViewNotFound;
RecordViewNotFound? get recordViewNotFound => isRecordViewNotFound ? data as RecordViewNotFound : null;
...
final class UModerationGetRecordsRecordsConverter implements JsonConverter<UModerationGetRecordsRecords, Map<String, dynamic>> {
...
if (RecordViewNotFound.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UModerationGetRecordsRecords object) => object.when(
        recordViewDetail: (data) => const RecordViewDetailConverter().toJson(data),
recordViewNotFound: (data) => const RecordViewNotFoundConverter().toJson(data),
