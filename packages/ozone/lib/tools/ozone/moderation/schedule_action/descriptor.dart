...
final takedownDescriptor = XRPCObjectDescriptor<Takedown>(
  ...
  defName: 'takedown',
  fromJson: (json) => const TakedownConverter().fromJson(json.cast<String, dynamic>()),
...
final schedulingConfigDescriptor = XRPCObjectDescriptor<SchedulingConfig>(
  ...
  fromJson: (json) => const SchedulingConfigConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const SchedulingConfigConverter().toJson,
  matches: SchedulingConfig.validate,
);

final scheduledActionResultsDescriptor = XRPCObjectDescriptor<ScheduledActionResults>(
  nsid: 'tools.ozone.moderation.scheduleAction',
  defName: 'scheduledActionResults',
  fromJson: (json) => const ScheduledActionResultsConverter().fromJson(json.cast<String, dynamic>()),
...
final failedSchedulingDescriptor = XRPCObjectDescriptor<FailedScheduling>(
  ...
  fromJson: (json) => const FailedSchedulingConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const FailedSchedulingConverter().toJson,
  matches: FailedScheduling.validate,
);

final methodDescriptor = XRPCMethodDescriptor<EmptyData, ModerationScheduleActionInput, ScheduledActionResults>(
  nsid: NSID.parse('tools.ozone.moderation.scheduleAction'),
  kind: XRPCMethodKind.procedure,  inputFromJson: (json) => const ModerationScheduleActionInputConverter().fromJson(json.cast<String, dynamic>()),
  inputToJson: const ModerationScheduleActionInputConverter().toJson,  outputFromJson: (json) => const ScheduledActionResultsConverter().fromJson(json.cast<String, dynamic>()),
