...
@freezed
sealed class UModerationScheduleActionAction with _$UModerationScheduleActionAction {
  ...
  Map<String, dynamic> toJson() => const UModerationScheduleActionActionConverter().toJson(this);
}

extension UModerationScheduleActionActionExtension on UModerationScheduleActionAction {
...
final class UModerationScheduleActionActionConverter implements JsonConverter<UModerationScheduleActionAction, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UModerationScheduleActionAction object) => object.when(
