...
@freezed
abstract class ModerationGetReporterStatsOutput with _$ModerationGetReporterStatsOutput {
  ...
  factory ModerationGetReporterStatsOutput.fromJson(Map<String, Object?> json) => _$ModerationGetReporterStatsOutputFromJson(json);
}



final class ModerationGetReporterStatsOutputConverter
    extends JsonConverter<ModerationGetReporterStatsOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(ModerationGetReporterStatsOutput object) => untranslate(
        object.toJson(),
      );
}
