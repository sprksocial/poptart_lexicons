...
abstract class CancellationResults with _$CancellationResults {
  ...
  const factory CancellationResults({
    @Default('tools.ozone.moderation.cancelScheduledActions#cancellationResults') String $type,
...
@FailedCancellationConverter() required List<FailedCancellation> failed,
  ...
  factory CancellationResults.fromJson(Map<String, Object?> json) => _$CancellationResultsFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.cancelScheduledActions#cancellationResults'
;
}
...
final class CancellationResultsConverter
  ...
  CancellationResults fromJson(Map<String, dynamic> json) {
    return CancellationResults.fromJson(translate(
      json,
      CancellationResults.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(CancellationResults object) => untranslate(
        object.toJson(),
      );
}
