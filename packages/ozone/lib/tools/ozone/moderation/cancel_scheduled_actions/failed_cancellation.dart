...
abstract class FailedCancellation with _$FailedCancellation {
  ...
  const factory FailedCancellation({
    @Default('tools.ozone.moderation.cancelScheduledActions#failedCancellation') String $type,
    required String did,
...
String? errorCode,
  ...
  factory FailedCancellation.fromJson(Map<String, Object?> json) => _$FailedCancellationFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.cancelScheduledActions#failedCancellation'
;
}
...
final class FailedCancellationConverter
  ...
  FailedCancellation fromJson(Map<String, dynamic> json) {
    return FailedCancellation.fromJson(translate(
      json,
      FailedCancellation.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(FailedCancellation object) => untranslate(
        object.toJson(),
      );
}
