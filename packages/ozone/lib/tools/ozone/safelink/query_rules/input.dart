...
abstract class SafelinkQueryRulesInput with _$SafelinkQueryRulesInput {
  static const knownProps = <String>['cursor', 'limit', 'urls', 'patternType', 'actions', 'reason', 'createdBy', 'sortDirection', ];
...
@SafelinkQueryRulesSortDirectionConverter() SafelinkQueryRulesSortDirection? sortDirection,
  ...
  factory SafelinkQueryRulesInput.fromJson(Map<String, Object?> json) => _$SafelinkQueryRulesInputFromJson(json);
}
