...
@SettingRemoveOptionsScopeConverter() required SettingRemoveOptionsScope scope,

    Map<String, dynamic>? $unknown,
  }) = _SettingRemoveOptionsInput;

  factory SettingRemoveOptionsInput.fromJson(Map<String, Object?> json) => _$SettingRemoveOptionsInputFromJson(json);
}
