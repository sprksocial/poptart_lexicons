...
abstract class RevokeError with _$RevokeError {
  ...
  const factory RevokeError({
    @Default('tools.ozone.verification.revokeVerifications#revokeError') String $type,
...
required String error,
  ...
  return object['\$type'] == 'tools.ozone.verification.revokeVerifications#revokeError'
;
}
