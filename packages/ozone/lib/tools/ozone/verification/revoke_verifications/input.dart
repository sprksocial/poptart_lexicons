...
@freezed
abstract class VerificationRevokeVerificationsInput with _$VerificationRevokeVerificationsInput {
...
String? revokeReason,
  ...
  factory VerificationRevokeVerificationsInput.fromJson(Map<String, Object?> json) => _$VerificationRevokeVerificationsInputFromJson(json);
}

extension VerificationRevokeVerificationsInputExtension on VerificationRevokeVerificationsInput {
...
final class VerificationRevokeVerificationsInputConverter
    extends JsonConverter<VerificationRevokeVerificationsInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(VerificationRevokeVerificationsInput object) => untranslate(
        object.toJson(),
      );
}
