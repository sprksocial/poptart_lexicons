...
abstract class VerificationInput with _$VerificationInput {
  static const knownProps = <String>['subject', 'handle', 'displayName', 'createdAt', ];
...
DateTime? createdAt,
  ...
  factory VerificationInput.fromJson(Map<String, Object?> json) => _$VerificationInputFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.verification.grantVerifications#verificationInput'
;
}
