...
@freezed
abstract class VerificationListVerificationsInput with _$VerificationListVerificationsInput {
  static const knownProps = <String>['cursor', 'limit', 'createdAfter', 'createdBefore', 'issuers', 'subjects', 'sortDirection', 'isRevoked', ];
...
bool? isRevoked,
  ...
  factory VerificationListVerificationsInput.fromJson(Map<String, Object?> json) => _$VerificationListVerificationsInputFromJson(json);
}

extension VerificationListVerificationsInputExtension on VerificationListVerificationsInput {
...
final class VerificationListVerificationsInputConverter
    extends JsonConverter<VerificationListVerificationsInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(VerificationListVerificationsInput object) => untranslate(
        object.toJson(),
      );
}
