...
@freezed
abstract class VerificationListVerificationsOutput with _$VerificationListVerificationsOutput {
...
@VerificationViewConverter() required List<VerificationView> verifications,
  ...
  factory VerificationListVerificationsOutput.fromJson(Map<String, Object?> json) => _$VerificationListVerificationsOutputFromJson(json);
}

extension VerificationListVerificationsOutputExtension on VerificationListVerificationsOutput {
...
final class VerificationListVerificationsOutputConverter
    extends JsonConverter<VerificationListVerificationsOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(VerificationListVerificationsOutput object) => untranslate(
        object.toJson(),
      );
}
