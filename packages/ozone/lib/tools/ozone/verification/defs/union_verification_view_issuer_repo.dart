...
const factory UVerificationViewIssuerRepo.repoViewNotFound({
  ...
  Map<String, dynamic> toJson() => const UVerificationViewIssuerRepoConverter().toJson(this);
}

extension UVerificationViewIssuerRepoExtension on UVerificationViewIssuerRepo {
  bool get isRepoViewDetail => isA<UVerificationViewIssuerRepoRepoViewDetail>(this);
...
bool get isRepoViewNotFound => isA<UVerificationViewIssuerRepoRepoViewNotFound>(this);
...
final class UVerificationViewIssuerRepoConverter implements JsonConverter<UVerificationViewIssuerRepo, Map<String, dynamic>> {
...
if (RepoViewNotFound.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UVerificationViewIssuerRepo object) => object.when(
