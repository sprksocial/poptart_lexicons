...
mixin _$Provenance {
 ...
 String get $type;/// Strong reference to the card that led to this record.
@RepoStrongRefConverter() RepoStrongRef? get via; Map<String, dynamic>? get $unknown;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Provenance&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.via, via) || other.via == via)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,via,const DeepCollectionEquality().hash($unknown));

@override
String toString() {
  return 'Provenance(\$type: ${$type}, via: $via, \$unknown: ${$unknown})';
}
...
@useResult
$Res call({
 String $type,@RepoStrongRefConverter() RepoStrongRef? via, Map<String, dynamic>? $unknown
});
...
/// Create a copy of Provenance
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? via = freezed,Object? $unknown = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type, @RepoStrongRefConverter()  RepoStrongRef? via,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Provenance() when $default != null:
return $default(_that.$type,_that.via,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type, @RepoStrongRefConverter()  RepoStrongRef? via,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _Provenance():
return $default(_that.$type,_that.via,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type, @RepoStrongRefConverter()  RepoStrongRef? via,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _Provenance() when $default != null:
return $default(_that.$type,_that.via,_that.$unknown);case _:
  return null;
...
class _Provenance implements Provenance {
  const _Provenance({this.$type = 'network.cosmik.defs#provenance', @RepoStrongRefConverter() this.via, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Provenance&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.via, via) || other.via == via)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,via,const DeepCollectionEquality().hash(_$unknown));
...
/// Create a copy of Provenance
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? via = freezed,Object? $unknown = freezed,}) {
