...
class _ThreadViewPref implements ThreadViewPref {
  const _ThreadViewPref({this.$type = 'so.sprk.actor.defs#threadViewPref', @ThreadViewPrefSortConverter() this.sort, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
