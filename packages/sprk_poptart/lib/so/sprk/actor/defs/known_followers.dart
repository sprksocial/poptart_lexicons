...
abstract class KnownFollowers with _$KnownFollowers {
  ...
  const factory KnownFollowers({
    @Default('so.sprk.actor.defs#knownFollowers') String $type,
    required int count,
@ProfileViewBasicConverter() required List<ProfileViewBasic> followers,
  ...
  factory KnownFollowers.fromJson(Map<String, Object?> json) => _$KnownFollowersFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.actor.defs#knownFollowers'
;
}
