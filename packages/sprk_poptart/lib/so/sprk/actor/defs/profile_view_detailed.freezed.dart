...
mixin _$ProfileViewDetailed {
 ...
 String get $type; String get did; String get handle; String? get displayName; String? get description; String? get avatar; String? get banner; int? get followersCount; int? get followsCount; int? get postsCount;@ProfileAssociatedConverter() ProfileAssociated? get associated; DateTime? get indexedAt; DateTime? get createdAt;@ViewerStateConverter() ViewerState? get viewer;@LabelConverter() List<Label>? get labels;@RepoStrongRefConverter() RepoStrongRef? get pinnedPost;@StoryViewConverter() List<StoryView>? get stories; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
 String $type, String did, String handle, String? displayName, String? description, String? avatar, String? banner, int? followersCount, int? followsCount, int? postsCount,@ProfileAssociatedConverter() ProfileAssociated? associated, DateTime? indexedAt, DateTime? createdAt,@ViewerStateConverter() ViewerState? viewer,@LabelConverter() List<Label>? labels,@RepoStrongRefConverter() RepoStrongRef? pinnedPost,@StoryViewConverter() List<StoryView>? stories, Map<String, dynamic>? $unknown
});


$ProfileAssociatedCopyWith<$Res>? get associated;$ViewerStateCopyWith<$Res>? get viewer;$RepoStrongRefCopyWith<$Res>? get pinnedPost;
...
/// Create a copy of ProfileViewDetailed
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? did = null,Object? handle = null,Object? displayName = freezed,Object? description = freezed,Object? avatar = freezed,Object? banner = freezed,Object? followersCount = freezed,Object? followsCount = freezed,Object? postsCount = freezed,Object? associated = freezed,Object? indexedAt = freezed,Object? createdAt = freezed,Object? viewer = freezed,Object? labels = freezed,Object? pinnedPost = freezed,Object? stories = freezed,Object? $unknown = freezed,}) {
...
as RepoStrongRef?,stories: freezed == stories ? _self.stories : stories // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type,  String did,  String handle,  String? displayName,  String? description,  String? avatar,  String? banner,  int? followersCount,  int? followsCount,  int? postsCount, @ProfileAssociatedConverter()  ProfileAssociated? associated,  DateTime? indexedAt,  DateTime? createdAt, @ViewerStateConverter()  ViewerState? viewer, @LabelConverter()  List<Label>? labels, @RepoStrongRefConverter()  RepoStrongRef? pinnedPost, @StoryViewConverter()  List<StoryView>? stories,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileViewDetailed() when $default != null:
return $default(_that.$type,_that.did,_that.handle,_that.displayName,_that.description,_that.avatar,_that.banner,_that.followersCount,_that.followsCount,_that.postsCount,_that.associated,_that.indexedAt,_that.createdAt,_that.viewer,_that.labels,_that.pinnedPost,_that.stories,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type,  String did,  String handle,  String? displayName,  String? description,  String? avatar,  String? banner,  int? followersCount,  int? followsCount,  int? postsCount, @ProfileAssociatedConverter()  ProfileAssociated? associated,  DateTime? indexedAt,  DateTime? createdAt, @ViewerStateConverter()  ViewerState? viewer, @LabelConverter()  List<Label>? labels, @RepoStrongRefConverter()  RepoStrongRef? pinnedPost, @StoryViewConverter()  List<StoryView>? stories,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _ProfileViewDetailed():
return $default(_that.$type,_that.did,_that.handle,_that.displayName,_that.description,_that.avatar,_that.banner,_that.followersCount,_that.followsCount,_that.postsCount,_that.associated,_that.indexedAt,_that.createdAt,_that.viewer,_that.labels,_that.pinnedPost,_that.stories,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type,  String did,  String handle,  String? displayName,  String? description,  String? avatar,  String? banner,  int? followersCount,  int? followsCount,  int? postsCount, @ProfileAssociatedConverter()  ProfileAssociated? associated,  DateTime? indexedAt,  DateTime? createdAt, @ViewerStateConverter()  ViewerState? viewer, @LabelConverter()  List<Label>? labels, @RepoStrongRefConverter()  RepoStrongRef? pinnedPost, @StoryViewConverter()  List<StoryView>? stories,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _ProfileViewDetailed() when $default != null:
return $default(_that.$type,_that.did,_that.handle,_that.displayName,_that.description,_that.avatar,_that.banner,_that.followersCount,_that.followsCount,_that.postsCount,_that.associated,_that.indexedAt,_that.createdAt,_that.viewer,_that.labels,_that.pinnedPost,_that.stories,_that.$unknown);case _:
  return null;
...
class _ProfileViewDetailed implements ProfileViewDetailed {
  const _ProfileViewDetailed({this.$type = 'so.sprk.actor.defs#profileViewDetailed', required this.did, required this.handle, this.displayName, this.description, this.avatar, this.banner, this.followersCount, this.followsCount, this.postsCount, @ProfileAssociatedConverter() this.associated, this.indexedAt, this.createdAt, @ViewerStateConverter() this.viewer, @LabelConverter() final  List<Label>? labels, @RepoStrongRefConverter() this.pinnedPost, @StoryViewConverter() final  List<StoryView>? stories, final  Map<String, dynamic>? $unknown}): _labels = labels,_stories = stories,_$unknown = $unknown;
...
@override $ProfileAssociatedCopyWith<$Res>? get associated;@override $ViewerStateCopyWith<$Res>? get viewer;@override $RepoStrongRefCopyWith<$Res>? get pinnedPost;
...
as List<Label>?,pinnedPost: freezed == pinnedPost ? _self.pinnedPost : pinnedPost // ignore: cast_nullable_to_non_nullable
as RepoStrongRef?,stories: freezed == stories ? _self._stories : stories // ignore: cast_nullable_to_non_nullable
