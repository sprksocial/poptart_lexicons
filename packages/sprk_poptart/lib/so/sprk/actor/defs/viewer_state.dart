...
abstract class ViewerState with _$ViewerState {
  static const knownProps = <String>['muted', 'blockedBy', 'blocking', 'following', 'followedBy', 'knownFollowers', ];

  @JsonSerializable(includeIfNull: false)
  const factory ViewerState({
    @Default('so.sprk.actor.defs#viewerState') String $type,
    bool? muted,
bool? blockedBy,
...
@KnownFollowersConverter() KnownFollowers? knownFollowers,
  ...
  return object['\$type'] == 'so.sprk.actor.defs#viewerState'
;
}
