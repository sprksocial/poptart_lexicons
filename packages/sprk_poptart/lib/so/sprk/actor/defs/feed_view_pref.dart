...
abstract class FeedViewPref with _$FeedViewPref {
  static const knownProps = <String>['feed', 'hideReplies', 'hideRepliesByUnfollowed', 'hideRepliesByLikeCount', 'hideReposts', 'hideQuotePosts', ];

  @JsonSerializable(includeIfNull: false)
  const factory FeedViewPref({
    @Default('so.sprk.actor.defs#feedViewPref') String $type,
...
bool? hideQuotePosts,
  ...
  factory FeedViewPref.fromJson(Map<String, Object?> json) => _$FeedViewPrefFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.actor.defs#feedViewPref'
;
}
