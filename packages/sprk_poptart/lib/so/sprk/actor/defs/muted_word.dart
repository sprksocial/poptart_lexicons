...
abstract class MutedWord with _$MutedWord {
  static const knownProps = <String>['id', 'value', 'targets', 'actorTarget', 'expiresAt', ];

  @JsonSerializable(includeIfNull: false)
  const factory MutedWord({
    @Default('so.sprk.actor.defs#mutedWord') String $type,
    String? id,
...
DateTime? expiresAt,
  ...
  factory MutedWord.fromJson(Map<String, Object?> json) => _$MutedWordFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.actor.defs#mutedWord'
;
}
