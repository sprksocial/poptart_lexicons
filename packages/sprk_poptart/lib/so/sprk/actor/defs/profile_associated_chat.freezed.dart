...
class _ProfileAssociatedChat implements ProfileAssociatedChat {
  const _ProfileAssociatedChat({this.$type = 'so.sprk.actor.defs#profileAssociatedChat', @ProfileAssociatedChatAllowIncomingConverter() required this.allowIncoming, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
