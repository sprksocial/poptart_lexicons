...
class _FeedViewPref implements FeedViewPref {
  const _FeedViewPref({this.$type = 'so.sprk.actor.defs#feedViewPref', required this.feed, this.hideReplies, this.hideRepliesByUnfollowed = true, this.hideRepliesByLikeCount, this.hideReposts, this.hideQuotePosts, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
