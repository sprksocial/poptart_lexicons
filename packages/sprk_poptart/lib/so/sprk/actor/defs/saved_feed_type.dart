...
abstract class SavedFeedType with _$SavedFeedType {
  ...
  const factory SavedFeedType.unknown({
  ...
  static SavedFeedType? valueOf(final String? value) {
    ...
    return knownValue != null ? SavedFeedType.knownValue(data: knownValue) : SavedFeedType.unknown(data: value);
  }
...
KnownSavedFeedType? get knownValue => isKnownValue ? data as KnownSavedFeedType : null;
...
final class SavedFeedTypeConverter extends JsonConverter<SavedFeedType, String> {
