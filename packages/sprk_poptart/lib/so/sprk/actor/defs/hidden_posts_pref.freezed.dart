...
class _HiddenPostsPref implements HiddenPostsPref {
  const _HiddenPostsPref({this.$type = 'so.sprk.actor.defs#hiddenPostsPref', @AtUriConverter() required final  List<AtUri> items, final  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
