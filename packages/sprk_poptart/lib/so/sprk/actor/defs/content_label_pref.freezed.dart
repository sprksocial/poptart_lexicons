...
class _ContentLabelPref implements ContentLabelPref {
  const _ContentLabelPref({this.$type = 'so.sprk.actor.defs#contentLabelPref', this.labelerDid, required this.label, @ContentLabelPrefVisibilityConverter() required this.visibility, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
