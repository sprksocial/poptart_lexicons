...
abstract class PersonalDetailsPref with _$PersonalDetailsPref {
  ...
  const factory PersonalDetailsPref({
    @Default('so.sprk.actor.defs#personalDetailsPref') String $type,
...
DateTime? birthDate,
  ...
  factory PersonalDetailsPref.fromJson(Map<String, Object?> json) => _$PersonalDetailsPrefFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.actor.defs#personalDetailsPref'
;
}
