...
class _MutedWordsPref implements MutedWordsPref {
  const _MutedWordsPref({this.$type = 'so.sprk.actor.defs#mutedWordsPref', @MutedWordConverter() required final  List<MutedWord> items, final  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
