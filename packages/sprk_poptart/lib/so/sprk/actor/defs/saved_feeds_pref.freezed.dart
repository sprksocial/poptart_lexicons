...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SavedFeedsPref&&(identical(other.$type, $type) || other.$type == $type)&&const DeepCollectionEquality().equals(other.items, items)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
@override
String toString() {
  return 'SavedFeedsPref(\$type: ${$type}, items: $items, \$unknown: ${$unknown})';
}
...
class _SavedFeedsPref implements SavedFeedsPref {
  const _SavedFeedsPref({this.$type = 'so.sprk.actor.defs#savedFeedsPref', @SavedFeedConverter() required final  List<SavedFeed> items, final  Map<String, dynamic>? $unknown}): _items = items,_$unknown = $unknown;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SavedFeedsPref&&(identical(other.$type, $type) || other.$type == $type)&&const DeepCollectionEquality().equals(other._items, _items)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
