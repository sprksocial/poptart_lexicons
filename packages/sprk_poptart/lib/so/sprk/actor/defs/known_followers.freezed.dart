...
class _KnownFollowers implements KnownFollowers {
  const _KnownFollowers({this.$type = 'so.sprk.actor.defs#knownFollowers', required this.count, @ProfileViewBasicConverter() required final  List<ProfileViewBasic> followers, final  Map<String, dynamic>? $unknown}): _followers = followers,_$unknown = $unknown;
