...
class _InterestsPref implements InterestsPref {
  const _InterestsPref({this.$type = 'so.sprk.actor.defs#interestsPref', required final  List<String> tags, final  Map<String, dynamic>? $unknown}): _tags = tags,_$unknown = $unknown;
