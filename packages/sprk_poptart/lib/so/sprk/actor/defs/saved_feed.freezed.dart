...
class _SavedFeed implements SavedFeed {
  const _SavedFeed({this.$type = 'so.sprk.actor.defs#savedFeed', required this.id, @SavedFeedTypeConverter() required this.type, required this.value, required this.pinned, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
