...
class _LabelersPref implements LabelersPref {
  const _LabelersPref({this.$type = 'so.sprk.actor.defs#labelersPref', @LabelerPrefItemConverter() required final  List<LabelerPrefItem> labelers, final  Map<String, dynamic>? $unknown}): _labelers = labelers,_$unknown = $unknown;
