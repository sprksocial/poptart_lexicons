...
/// A declaration of a Spark account profile.
@freezed
abstract class ActorProfileRecord with _$ActorProfileRecord {
  static const knownProps = <String>['displayName', 'description', 'avatar', 'banner', 'labels', 'joinedViaStarterPack', 'pinnedPost', 'createdAt', ];

  @JsonSerializable(includeIfNull: false)
  const factory ActorProfileRecord({
    @Default('so.sprk.actor.profile') String $type,
    String? displayName,
...
DateTime? createdAt,
  ...
  return object['\$type'] == 'so.sprk.actor.profile';
}
