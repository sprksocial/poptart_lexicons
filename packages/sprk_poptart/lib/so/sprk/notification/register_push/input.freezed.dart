...
mixin _$NotificationRegisterPushInput {
 ...
 String get serviceDid; String get token;@NotificationRegisterPushPlatformConverter() NotificationRegisterPushPlatform get platform; String get appId; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
 String serviceDid, String token,@NotificationRegisterPushPlatformConverter() NotificationRegisterPushPlatform platform, String appId, Map<String, dynamic>? $unknown
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String serviceDid,  String token, @NotificationRegisterPushPlatformConverter()  NotificationRegisterPushPlatform platform,  String appId,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationRegisterPushInput() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String serviceDid,  String token, @NotificationRegisterPushPlatformConverter()  NotificationRegisterPushPlatform platform,  String appId,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _NotificationRegisterPushInput():
return $default(_that.serviceDid,_that.token,_that.platform,_that.appId,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String serviceDid,  String token, @NotificationRegisterPushPlatformConverter()  NotificationRegisterPushPlatform platform,  String appId,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _NotificationRegisterPushInput() when $default != null:
return $default(_that.serviceDid,_that.token,_that.platform,_that.appId,_that.$unknown);case _:
  return null;
...
class _NotificationRegisterPushInput implements NotificationRegisterPushInput {
  const _NotificationRegisterPushInput({required this.serviceDid, required this.token, @NotificationRegisterPushPlatformConverter() required this.platform, required this.appId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
