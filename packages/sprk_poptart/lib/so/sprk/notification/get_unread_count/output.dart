...
@freezed
abstract class NotificationGetUnreadCountOutput with _$NotificationGetUnreadCountOutput {
  ...
  factory NotificationGetUnreadCountOutput.fromJson(Map<String, Object?> json) => _$NotificationGetUnreadCountOutputFromJson(json);
}



final class NotificationGetUnreadCountOutputConverter
    extends JsonConverter<NotificationGetUnreadCountOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(NotificationGetUnreadCountOutput object) => untranslate(
        object.toJson(),
      );
}
