...
required String did,
  ...
  factory EmbedMention.fromJson(Map<String, Object?> json) => _$EmbedMentionFromJson(json);
...
final class EmbedMentionConverter
  ...
  EmbedMention fromJson(Map<String, dynamic> json) {
    return EmbedMention.fromJson(translate(
      json,
      EmbedMention.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(EmbedMention object) => untranslate(
        object.toJson(),
      );
}
