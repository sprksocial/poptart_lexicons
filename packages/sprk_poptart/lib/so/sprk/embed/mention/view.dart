...
abstract class EmbedMentionView with _$EmbedMentionView {
  ...
  factory EmbedMentionView.fromJson(Map<String, Object?> json) =>
      _$EmbedMentionViewFromJson(json);
...
final class EmbedMentionViewConverter
  ...
  EmbedMentionView fromJson(Map<String, dynamic> json) {
    return EmbedMentionView.fromJson(
      translate(json, EmbedMentionView.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(EmbedMentionView object) =>
