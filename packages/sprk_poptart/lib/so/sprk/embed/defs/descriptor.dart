...
final placementDescriptor = XRPCObjectDescriptor<Placement>(
  ...
  defName: 'placement',
  fromJson: (json) => const PlacementConverter().fromJson(json.cast<String, dynamic>()),
...
final frameDescriptor = XRPCObjectDescriptor<Frame>(
  nsid: 'so.sprk.embed.defs',
  defName: 'frame',
  fromJson: (json) => const FrameConverter().fromJson(json.cast<String, dynamic>()),
...
final mediaRefDescriptor = XRPCObjectDescriptor<MediaRef>(
  nsid: 'so.sprk.embed.defs',
  defName: 'mediaRef',
  fromJson: (json) => const MediaRefConverter().fromJson(json.cast<String, dynamic>()),
