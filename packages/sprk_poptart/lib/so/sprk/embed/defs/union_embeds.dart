...
sealed class UEmbeds with _$UEmbeds {
  ...
  const factory UEmbeds.embedMention({
  required EmbedMention data,
}) = UEmbedsEmbedMention;
const factory UEmbeds.embedRecord({
  required EmbedRecord data,
}) = UEmbedsEmbedRecord;


  const factory UEmbeds.unknown({
...
EmbedMention? get embedMention => isEmbedMention ? data as EmbedMention : null;
...
final class UEmbedsConverter implements JsonConverter<UEmbeds, Map<String, dynamic>> {
