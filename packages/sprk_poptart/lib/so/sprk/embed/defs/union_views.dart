...
sealed class UViews with _$UViews {
  ...
  const factory UViews.embedMentionView({required EmbedMentionView data}) =
      UViewsEmbedMentionView;
  const factory UViews.embedRecordView({required EmbedRecordView data}) =
      UViewsEmbedRecordView;

  const factory UViews.unknown({required Map<String, dynamic> data}) =
      UViewsUnknown;
...
extension UViewsExtension on UViews {
  ...
  EmbedMentionView? get embedMentionView =>
      isEmbedMentionView ? data as EmbedMentionView : null;
...
final class UViewsConverter
    implements JsonConverter<UViews, Map<String, dynamic>> {
