...
sealed class UEmbedRecordViewPost with _$UEmbedRecordViewPost {
  ...
  const factory UEmbedRecordViewPost.postView({
...
const factory UEmbedRecordViewPost.blockedPost({
  ...
  Map<String, dynamic> toJson() => const UEmbedRecordViewPostConverter().toJson(this);
}
...
final class UEmbedRecordViewPostConverter implements JsonConverter<UEmbedRecordViewPost, Map<String, dynamic>> {
