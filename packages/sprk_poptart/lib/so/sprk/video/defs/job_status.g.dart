...
_JobStatus _$JobStatusFromJson(Map json) =>
    $checkedCreate('_JobStatus', json, ($checkedConvert) {
      final val = _JobStatus(
        $type: $checkedConvert(
          r'$type',
          (v) => v as String? ?? 'so.sprk.video.defs#jobStatus',
        ),
        ...
        audio: $checkedConvert(
          'audio',
          (v) => _$JsonConverterFromJson<Map<String, dynamic>, ExtractedAudio>(
            v,
            const ExtractedAudioConverter().fromJson,
          ),
        ),
...
Map<String, dynamic> _$JobStatusToJson(_JobStatus instance) =>
    <String, dynamic>{
      ...
      'audio': ?_$JsonConverterToJson<Map<String, dynamic>, ExtractedAudio>(
        instance.audio,
        const ExtractedAudioConverter().toJson,
      ),
