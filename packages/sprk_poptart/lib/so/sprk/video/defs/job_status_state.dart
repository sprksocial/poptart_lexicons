...
abstract class JobStatusState with _$JobStatusState {
  ...
  static JobStatusState? valueOf(final String? value) {
    ...
    return knownValue != null ? JobStatusState.knownValue(data: knownValue) : JobStatusState.unknown(data: value);
  }
...
KnownJobStatusState? get knownValue => isKnownValue ? data as KnownJobStatusState : null;
...
final class JobStatusStateConverter extends JsonConverter<JobStatusState, String> {
...
@JsonValue('JOB_STATE_QUEUED')
jOB_STATE_QUEUED('JOB_STATE_QUEUED'),
@JsonValue('JOB_STATE_PROCESSING')
