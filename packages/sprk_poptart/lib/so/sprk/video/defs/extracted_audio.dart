...
@BlobConverter() required Blob blob,
  ...
  factory ExtractedAudio.fromJson(Map<String, Object?> json) => _$ExtractedAudioFromJson(json);
...
final class ExtractedAudioConverter
  ...
  ExtractedAudio fromJson(Map<String, dynamic> json) {
    return ExtractedAudio.fromJson(translate(
      json,
      ExtractedAudio.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ExtractedAudio object) => untranslate(
        object.toJson(),
      );
}
