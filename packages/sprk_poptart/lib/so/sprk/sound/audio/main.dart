...
abstract class SoundAudioRecord with _$SoundAudioRecord {
  static const knownProps = <String>['sound', 'origin', 'title', 'details', 'labels', 'createdAt', ];
...
required DateTime createdAt,
  ...
  factory SoundAudioRecord.fromJson(Map<String, Object?> json) => _$SoundAudioRecordFromJson(json);
...
final class SoundAudioRecordConverter
  ...
  SoundAudioRecord fromJson(Map<String, dynamic> json) {
    return SoundAudioRecord.fromJson(translate(
      json,
      SoundAudioRecord.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(SoundAudioRecord object) => untranslate(
        object.toJson(),
      );
}
