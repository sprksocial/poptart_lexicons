...
sealed class USoundAudioLabels with _$USoundAudioLabels {
  ...
  const factory USoundAudioLabels.selfLabels({required SelfLabels data}) =
  ...
  Map<String, dynamic> toJson() =>
      const USoundAudioLabelsConverter().toJson(this);
}
...
final class USoundAudioLabelsConverter
    implements JsonConverter<USoundAudioLabels, Map<String, dynamic>> {
