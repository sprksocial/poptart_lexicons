...
String? cursor,
  ...
  factory SoundGetTrendingAudiosInput.fromJson(Map<String, Object?> json) => _$SoundGetTrendingAudiosInputFromJson(json);
}
...
final class SoundGetTrendingAudiosInputConverter
  ...
  SoundGetTrendingAudiosInput fromJson(Map<String, dynamic> json) {
    return SoundGetTrendingAudiosInput.fromJson(translate(
      json,
      SoundGetTrendingAudiosInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(SoundGetTrendingAudiosInput object) => untranslate(
        object.toJson(),
      );
}
