...
abstract class SoundGetActorAudiosOutput with _$SoundGetActorAudiosOutput {
  ...
  factory SoundGetActorAudiosOutput.fromJson(Map<String, Object?> json) =>
      _$SoundGetActorAudiosOutputFromJson(json);
}
...
final class SoundGetActorAudiosOutputConverter
  ...
  SoundGetActorAudiosOutput fromJson(Map<String, dynamic> json) {
    return SoundGetActorAudiosOutput.fromJson(
      translate(json, SoundGetActorAudiosOutput.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(SoundGetActorAudiosOutput object) =>
