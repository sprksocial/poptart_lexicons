...
abstract class SoundGetActorAudiosInput with _$SoundGetActorAudiosInput {
  ...
  factory SoundGetActorAudiosInput.fromJson(Map<String, Object?> json) =>
      _$SoundGetActorAudiosInputFromJson(json);
}
...
final class SoundGetActorAudiosInputConverter
  ...
  SoundGetActorAudiosInput fromJson(Map<String, dynamic> json) {
    return SoundGetActorAudiosInput.fromJson(
      translate(json, SoundGetActorAudiosInput.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(SoundGetActorAudiosInput object) =>
