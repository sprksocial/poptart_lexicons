...
abstract class AudioDetails with _$AudioDetails {
  ...
  factory AudioDetails.fromJson(Map<String, Object?> json) =>
...
final class AudioDetailsConverter
  ...
  AudioDetails fromJson(Map<String, dynamic> json) {
    return AudioDetails.fromJson(translate(json, AudioDetails.knownProps));
  }

  @override
  Map<String, dynamic> toJson(AudioDetails object) =>
