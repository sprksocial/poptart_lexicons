...
abstract class AudioView with _$AudioView {
  ...
  factory AudioView.fromJson(Map<String, Object?> json) =>
...
final class AudioViewConverter
  ...
  AudioView fromJson(Map<String, dynamic> json) {
    return AudioView.fromJson(translate(json, AudioView.knownProps));
  }

  @override
  Map<String, dynamic> toJson(AudioView object) => untranslate(object.toJson());
}
