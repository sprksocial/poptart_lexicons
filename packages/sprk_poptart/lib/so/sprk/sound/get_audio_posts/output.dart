...
@AudioViewConverter() AudioView? audio,
  ...
  factory SoundGetAudioPostsOutput.fromJson(Map<String, Object?> json) => _$SoundGetAudioPostsOutputFromJson(json);
}
...
final class SoundGetAudioPostsOutputConverter
  ...
  SoundGetAudioPostsOutput fromJson(Map<String, dynamic> json) {
    return SoundGetAudioPostsOutput.fromJson(translate(
      json,
      SoundGetAudioPostsOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(SoundGetAudioPostsOutput object) => untranslate(
        object.toJson(),
      );
}
