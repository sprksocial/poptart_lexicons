...
abstract class SoundGetAudioPostsInput with _$SoundGetAudioPostsInput {
  ...
  factory SoundGetAudioPostsInput.fromJson(Map<String, Object?> json) =>
      _$SoundGetAudioPostsInputFromJson(json);
}
...
final class SoundGetAudioPostsInputConverter
  ...
  SoundGetAudioPostsInput fromJson(Map<String, dynamic> json) {
    return SoundGetAudioPostsInput.fromJson(
      translate(json, SoundGetAudioPostsInput.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(SoundGetAudioPostsInput object) =>
