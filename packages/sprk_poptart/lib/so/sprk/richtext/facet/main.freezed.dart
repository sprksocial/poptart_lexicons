...
class _$RichtextFacetCopyWithImpl<$Res>
  ...
  _$RichtextFacetCopyWithImpl(this._self, this._then);
...
class _RichtextFacet implements RichtextFacet {
  const _RichtextFacet({this.$type = 'so.sprk.richtext.facet', @RichtextFacetByteSliceConverter() required this.index, @URichtextFacetFeaturesConverter() required final  List<URichtextFacetFeatures> features, final  Map<String, dynamic>? $unknown}): _features = features,_$unknown = $unknown;
...
class __$RichtextFacetCopyWithImpl<$Res>
  ...
  __$RichtextFacetCopyWithImpl(this._self, this._then);
