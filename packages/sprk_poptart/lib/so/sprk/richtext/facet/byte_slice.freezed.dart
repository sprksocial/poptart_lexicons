...
class _RichtextFacetByteSlice implements RichtextFacetByteSlice {
  const _RichtextFacetByteSlice({this.$type = 'so.sprk.richtext.facet#byteSlice', required this.byteStart, required this.byteEnd, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
