...
const factory URichtextFacetFeatures.richtextFacetTag({
  ...
  Map<String, dynamic> toJson() => const URichtextFacetFeaturesConverter().toJson(this);
}

extension URichtextFacetFeaturesExtension on URichtextFacetFeatures {
  bool get isRichtextFacetMention => isA<URichtextFacetFeaturesRichtextFacetMention>(this);
bool get isNotRichtextFacetMention => !isRichtextFacetMention;
RichtextFacetMention? get richtextFacetMention => isRichtextFacetMention ? data as RichtextFacetMention : null;
bool get isRichtextFacetLink => isA<URichtextFacetFeaturesRichtextFacetLink>(this);
bool get isNotRichtextFacetLink => !isRichtextFacetLink;
RichtextFacetLink? get richtextFacetLink => isRichtextFacetLink ? data as RichtextFacetLink : null;
bool get isRichtextFacetTag => isA<URichtextFacetFeaturesRichtextFacetTag>(this);
bool get isNotRichtextFacetTag => !isRichtextFacetTag;
RichtextFacetTag? get richtextFacetTag => isRichtextFacetTag ? data as RichtextFacetTag : null;
...
final class URichtextFacetFeaturesConverter implements JsonConverter<URichtextFacetFeatures, Map<String, dynamic>> {
...
if (RichtextFacetTag.validate(json)) {
  ...
  Map<String, dynamic> toJson(URichtextFacetFeatures object) => object.when(
        richtextFacetMention: (data) => const RichtextFacetMentionConverter().toJson(data),
richtextFacetLink: (data) => const RichtextFacetLinkConverter().toJson(data),
