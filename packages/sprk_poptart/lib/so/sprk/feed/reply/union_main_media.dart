...
sealed class UFeedReplyMedia with _$UFeedReplyMedia {
  ...
  const factory UFeedReplyMedia.mediaImage({required MediaImage data}) =
      UFeedReplyMediaMediaImage;

  const factory UFeedReplyMedia.unknown({required Map<String, dynamic> data}) =
      UFeedReplyMediaUnknown;

  Map<String, dynamic> toJson() =>
      const UFeedReplyMediaConverter().toJson(this);
}
...
final class UFeedReplyMediaConverter
    implements JsonConverter<UFeedReplyMedia, Map<String, dynamic>> {
