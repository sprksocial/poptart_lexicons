...
sealed class UFeedReplyLabels with _$UFeedReplyLabels {
  ...
  const factory UFeedReplyLabels.selfLabels({required SelfLabels data}) =
      UFeedReplyLabelsSelfLabels;

  const factory UFeedReplyLabels.unknown({required Map<String, dynamic> data}) =
      UFeedReplyLabelsUnknown;

  Map<String, dynamic> toJson() =>
      const UFeedReplyLabelsConverter().toJson(this);
}
...
final class UFeedReplyLabelsConverter
    implements JsonConverter<UFeedReplyLabels, Map<String, dynamic>> {
