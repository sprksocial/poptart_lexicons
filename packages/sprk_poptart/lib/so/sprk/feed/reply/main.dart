...
abstract class FeedReplyRecord with _$FeedReplyRecord {
  ...
  factory FeedReplyRecord.fromJson(Map<String, Object?> json) =>
      _$FeedReplyRecordFromJson(json);
...
final class FeedReplyRecordConverter
  ...
  FeedReplyRecord fromJson(Map<String, dynamic> json) {
    return FeedReplyRecord.fromJson(
      translate(json, FeedReplyRecord.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(FeedReplyRecord object) =>
