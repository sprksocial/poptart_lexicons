...
mixin _$FeedGeneratorRecord {
 ...
 String get $type; String get did; String get displayName; String? get description;@RichtextFacetConverter() List<RichtextFacet>? get descriptionFacets;@BlobConverter() Blob? get avatar;/// Declaration that a feed accepts feedback interactions from a client through so.sprk.feed.sendInteractions
 bool? get acceptsInteractions;@UFeedGeneratorLabelsConverter() UFeedGeneratorLabels? get labels; DateTime get createdAt; Map<String, dynamic>? get $unknown;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,did,displayName,description,const DeepCollectionEquality().hash(descriptionFacets),avatar,acceptsInteractions,labels,createdAt,const DeepCollectionEquality().hash($unknown));

@override
String toString() {
  return 'FeedGeneratorRecord(\$type: ${$type}, did: $did, displayName: $displayName, description: $description, descriptionFacets: $descriptionFacets, avatar: $avatar, acceptsInteractions: $acceptsInteractions, labels: $labels, createdAt: $createdAt, \$unknown: ${$unknown})';
}
...
@useResult
$Res call({
 String $type, String did, String displayName, String? description,@RichtextFacetConverter() List<RichtextFacet>? descriptionFacets,@BlobConverter() Blob? avatar, bool? acceptsInteractions,@UFeedGeneratorLabelsConverter() UFeedGeneratorLabels? labels, DateTime createdAt, Map<String, dynamic>? $unknown
});
...
/// Create a copy of FeedGeneratorRecord
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? did = null,Object? displayName = null,Object? description = freezed,Object? descriptionFacets = freezed,Object? avatar = freezed,Object? acceptsInteractions = freezed,Object? labels = freezed,Object? createdAt = null,Object? $unknown = freezed,}) {
...
as UFeedGeneratorLabels?,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type,  String did,  String displayName,  String? description, @RichtextFacetConverter()  List<RichtextFacet>? descriptionFacets, @BlobConverter()  Blob? avatar,  bool? acceptsInteractions, @UFeedGeneratorLabelsConverter()  UFeedGeneratorLabels? labels,  DateTime createdAt,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedGeneratorRecord() when $default != null:
return $default(_that.$type,_that.did,_that.displayName,_that.description,_that.descriptionFacets,_that.avatar,_that.acceptsInteractions,_that.labels,_that.createdAt,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type,  String did,  String displayName,  String? description, @RichtextFacetConverter()  List<RichtextFacet>? descriptionFacets, @BlobConverter()  Blob? avatar,  bool? acceptsInteractions, @UFeedGeneratorLabelsConverter()  UFeedGeneratorLabels? labels,  DateTime createdAt,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _FeedGeneratorRecord():
return $default(_that.$type,_that.did,_that.displayName,_that.description,_that.descriptionFacets,_that.avatar,_that.acceptsInteractions,_that.labels,_that.createdAt,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type,  String did,  String displayName,  String? description, @RichtextFacetConverter()  List<RichtextFacet>? descriptionFacets, @BlobConverter()  Blob? avatar,  bool? acceptsInteractions, @UFeedGeneratorLabelsConverter()  UFeedGeneratorLabels? labels,  DateTime createdAt,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _FeedGeneratorRecord() when $default != null:
return $default(_that.$type,_that.did,_that.displayName,_that.description,_that.descriptionFacets,_that.avatar,_that.acceptsInteractions,_that.labels,_that.createdAt,_that.$unknown);case _:
  return null;
...
class _FeedGeneratorRecord implements FeedGeneratorRecord {
  const _FeedGeneratorRecord({this.$type = 'so.sprk.feed.generator', required this.did, required this.displayName, this.description, @RichtextFacetConverter() final  List<RichtextFacet>? descriptionFacets, @BlobConverter() this.avatar, this.acceptsInteractions, @UFeedGeneratorLabelsConverter() this.labels, required this.createdAt, final  Map<String, dynamic>? $unknown}): _descriptionFacets = descriptionFacets,_$unknown = $unknown;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,did,displayName,description,const DeepCollectionEquality().hash(_descriptionFacets),avatar,acceptsInteractions,labels,createdAt,const DeepCollectionEquality().hash(_$unknown));
...
/// Create a copy of FeedGeneratorRecord
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? did = null,Object? displayName = null,Object? description = freezed,Object? descriptionFacets = freezed,Object? avatar = freezed,Object? acceptsInteractions = freezed,Object? labels = freezed,Object? createdAt = null,Object? $unknown = freezed,}) {
