...
abstract class FeedGetPostThreadSort with _$FeedGetPostThreadSort {
  ...
  const factory FeedGetPostThreadSort.unknown({
  ...
  static FeedGetPostThreadSort? valueOf(final String? value) {
    ...
    return knownValue != null ? FeedGetPostThreadSort.knownValue(data: knownValue) : FeedGetPostThreadSort.unknown(data: value);
  }
...
KnownFeedGetPostThreadSort? get knownValue => isKnownValue ? data as KnownFeedGetPostThreadSort : null;
...
final class FeedGetPostThreadSortConverter extends JsonConverter<FeedGetPostThreadSort, String> {
  ...
  @override
  String toJson(FeedGetPostThreadSort object) => object.when(
