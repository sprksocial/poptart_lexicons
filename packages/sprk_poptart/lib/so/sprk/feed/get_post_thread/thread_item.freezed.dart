...
class _ThreadItem implements ThreadItem {
  const _ThreadItem({this.$type = 'so.sprk.feed.getPostThread#threadItem', @AtUriConverter() required this.uri, required this.depth, @UThreadItemValueConverter() required this.value, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
