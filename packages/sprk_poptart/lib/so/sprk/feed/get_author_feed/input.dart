...
abstract class FeedGetAuthorFeedInput with _$FeedGetAuthorFeedInput {
  static const knownProps = <String>['actor', 'limit', 'cursor', 'filter', 'includePins', ];
...
@Default(false) bool includePins,
  ...
  factory FeedGetAuthorFeedInput.fromJson(Map<String, Object?> json) => _$FeedGetAuthorFeedInputFromJson(json);
}
