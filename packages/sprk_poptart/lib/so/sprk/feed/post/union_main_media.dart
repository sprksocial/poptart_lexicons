...
sealed class UFeedPostMedia with _$UFeedPostMedia {
  ...
  const factory UFeedPostMedia.mediaImages({required MediaImages data}) =
      UFeedPostMediaMediaImages;
  const factory UFeedPostMedia.mediaVideo({required MediaVideo data}) =
      UFeedPostMediaMediaVideo;

  const factory UFeedPostMedia.unknown({required Map<String, dynamic> data}) =
...
final class UFeedPostMediaConverter
    implements JsonConverter<UFeedPostMedia, Map<String, dynamic>> {
