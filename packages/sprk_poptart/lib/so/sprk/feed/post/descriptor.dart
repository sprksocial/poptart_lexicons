...
final feedPostRecordDescriptor = XRPCRecordDescriptor<FeedPostRecord>(
  ...
  defName: 'main',
  fromJson: (json) => const FeedPostRecordConverter().fromJson(json.cast<String, dynamic>()),
...
final captionRefDescriptor = XRPCObjectDescriptor<CaptionRef>(
  nsid: 'so.sprk.feed.post',
  defName: 'captionRef',
  fromJson: (json) => const CaptionRefConverter().fromJson(json.cast<String, dynamic>()),
