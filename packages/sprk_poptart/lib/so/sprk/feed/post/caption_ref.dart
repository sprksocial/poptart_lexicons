...
@RichtextFacetConverter() List<RichtextFacet>? facets,
  ...
  factory CaptionRef.fromJson(Map<String, Object?> json) => _$CaptionRefFromJson(json);
...
final class CaptionRefConverter
  ...
  CaptionRef fromJson(Map<String, dynamic> json) {
    return CaptionRef.fromJson(translate(
      json,
      CaptionRef.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(CaptionRef object) => untranslate(
        object.toJson(),
      );
}
