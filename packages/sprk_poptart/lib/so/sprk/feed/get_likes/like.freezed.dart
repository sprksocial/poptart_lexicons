...
class _Like implements Like {
  const _Like({this.$type = 'so.sprk.feed.getLikes#like', required this.indexedAt, required this.createdAt, @ProfileViewConverter() required this.actor, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
