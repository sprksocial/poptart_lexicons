...
mixin _$FeedGetFeedSkeletonOutput {
 ...
 String? get cursor;@SkeletonFeedPostConverter() List<SkeletonFeedPost> get feed; Map<String, dynamic>? get $unknown;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedGetFeedSkeletonOutput&&(identical(other.cursor, cursor) || other.cursor == cursor)&&const DeepCollectionEquality().equals(other.feed, feed)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
@override
String toString() {
  return 'FeedGetFeedSkeletonOutput(cursor: $cursor, feed: $feed, \$unknown: ${$unknown})';
}
...
@useResult
$Res call({
 String? cursor,@SkeletonFeedPostConverter() List<SkeletonFeedPost> feed, Map<String, dynamic>? $unknown
});
...
as List<SkeletonFeedPost>,$unknown: freezed == $unknown ? _self.$unknown : $unknown // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? cursor, @SkeletonFeedPostConverter()  List<SkeletonFeedPost> feed,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedGetFeedSkeletonOutput() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? cursor, @SkeletonFeedPostConverter()  List<SkeletonFeedPost> feed,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _FeedGetFeedSkeletonOutput():
return $default(_that.cursor,_that.feed,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? cursor, @SkeletonFeedPostConverter()  List<SkeletonFeedPost> feed,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _FeedGetFeedSkeletonOutput() when $default != null:
return $default(_that.cursor,_that.feed,_that.$unknown);case _:
  return null;
...
class _FeedGetFeedSkeletonOutput implements FeedGetFeedSkeletonOutput {
  const _FeedGetFeedSkeletonOutput({this.cursor, @SkeletonFeedPostConverter() required final  List<SkeletonFeedPost> feed, final  Map<String, dynamic>? $unknown}): _feed = feed,_$unknown = $unknown;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FeedGetFeedSkeletonOutput&&(identical(other.cursor, cursor) || other.cursor == cursor)&&const DeepCollectionEquality().equals(other._feed, _feed)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
as List<SkeletonFeedPost>,$unknown: freezed == $unknown ? _self._$unknown : $unknown // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
