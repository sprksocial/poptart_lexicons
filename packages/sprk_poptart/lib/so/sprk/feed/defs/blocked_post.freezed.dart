...
class _BlockedPost implements BlockedPost {
  const _BlockedPost({this.$type = 'so.sprk.feed.defs#blockedPost', @AtUriConverter() required this.uri, required this.blocked, @BlockedAuthorConverter() required this.author, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
