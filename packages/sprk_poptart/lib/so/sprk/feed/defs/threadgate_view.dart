...
abstract class ThreadgateView with _$ThreadgateView {
  static const knownProps = <String>['uri', 'cid', 'record', ];

  @JsonSerializable(includeIfNull: false)
  const factory ThreadgateView({
    @Default('so.sprk.feed.defs#threadgateView') String $type,
...
Map<String, dynamic>? record,
  ...
  factory ThreadgateView.fromJson(Map<String, Object?> json) => _$ThreadgateViewFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.feed.defs#threadgateView'
;
}
