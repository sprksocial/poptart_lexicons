...
import './union_viewer_state_known_interactions.dart';
...
abstract class ViewerState with _$ViewerState {
  static const knownProps = <String>['repost', 'like', 'threadMuted', 'replyDisabled', 'embeddingDisabled', 'knownInteractions', ];

  @JsonSerializable(includeIfNull: false)
  const factory ViewerState({
    @Default('so.sprk.feed.defs#viewerState') String $type,
    @AtUriConverter() AtUri? repost,
@AtUriConverter() AtUri? like,
bool? threadMuted,
bool? replyDisabled,
bool? embeddingDisabled,
@UViewerStateKnownInteractionsConverter() List<UViewerStateKnownInteractions>? knownInteractions,

    Map<String, dynamic>? $unknown,
  }) = _ViewerState;

  factory ViewerState.fromJson(Map<String, Object?> json) => _$ViewerStateFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.feed.defs#viewerState'
;
}
