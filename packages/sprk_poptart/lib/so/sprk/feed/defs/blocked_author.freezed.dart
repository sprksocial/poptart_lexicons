...
class _BlockedAuthor implements BlockedAuthor {
  const _BlockedAuthor({this.$type = 'so.sprk.feed.defs#blockedAuthor', required this.did, @ViewerStateConverter() this.viewer, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
