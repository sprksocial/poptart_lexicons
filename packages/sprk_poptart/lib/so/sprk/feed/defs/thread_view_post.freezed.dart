...
mixin _$ThreadViewPost {
 ...
 String get $type;@UThreadViewPostPostConverter() UThreadViewPostPost get post;@UThreadViewPostParentConverter() UThreadViewPostParent? get parent;@UThreadViewPostRepliesConverter() List<UThreadViewPostReplies>? get replies;@ThreadContextConverter() ThreadContext? get threadContext; Map<String, dynamic>? get $unknown;
...
@useResult
$Res call({
 String $type,@UThreadViewPostPostConverter() UThreadViewPostPost post,@UThreadViewPostParentConverter() UThreadViewPostParent? parent,@UThreadViewPostRepliesConverter() List<UThreadViewPostReplies>? replies,@ThreadContextConverter() ThreadContext? threadContext, Map<String, dynamic>? $unknown
});


$UThreadViewPostPostCopyWith<$Res> get post;$UThreadViewPostParentCopyWith<$Res>? get parent;$ThreadContextCopyWith<$Res>? get threadContext;
...
as UThreadViewPostPost,parent: freezed == parent ? _self.parent : parent // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type, @UThreadViewPostPostConverter()  UThreadViewPostPost post, @UThreadViewPostParentConverter()  UThreadViewPostParent? parent, @UThreadViewPostRepliesConverter()  List<UThreadViewPostReplies>? replies, @ThreadContextConverter()  ThreadContext? threadContext,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThreadViewPost() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type, @UThreadViewPostPostConverter()  UThreadViewPostPost post, @UThreadViewPostParentConverter()  UThreadViewPostParent? parent, @UThreadViewPostRepliesConverter()  List<UThreadViewPostReplies>? replies, @ThreadContextConverter()  ThreadContext? threadContext,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _ThreadViewPost():
return $default(_that.$type,_that.post,_that.parent,_that.replies,_that.threadContext,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type, @UThreadViewPostPostConverter()  UThreadViewPostPost post, @UThreadViewPostParentConverter()  UThreadViewPostParent? parent, @UThreadViewPostRepliesConverter()  List<UThreadViewPostReplies>? replies, @ThreadContextConverter()  ThreadContext? threadContext,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _ThreadViewPost() when $default != null:
return $default(_that.$type,_that.post,_that.parent,_that.replies,_that.threadContext,_that.$unknown);case _:
  return null;
...
@override $UThreadViewPostPostCopyWith<$Res> get post;@override $UThreadViewPostParentCopyWith<$Res>? get parent;@override $ThreadContextCopyWith<$Res>? get threadContext;
