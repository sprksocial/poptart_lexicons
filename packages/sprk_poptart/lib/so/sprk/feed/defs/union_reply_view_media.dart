...
sealed class UReplyViewMedia with _$UReplyViewMedia {
  ...
  const factory UReplyViewMedia.mediaImageView({
  required MediaImageView data,
}) = UReplyViewMediaMediaImageView;


  const factory UReplyViewMedia.unknown({
    required Map<String, dynamic> data,
  }) = UReplyViewMediaUnknown;

  Map<String, dynamic> toJson() => const UReplyViewMediaConverter().toJson(this);
}
...
final class UReplyViewMediaConverter implements JsonConverter<UReplyViewMedia, Map<String, dynamic>> {
