...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,item,event,feedContext,const DeepCollectionEquality().hash($unknown));
...
@useResult
$Res call({
 String $type,@AtUriConverter() AtUri? item,@InteractionEventConverter() InteractionEvent? event, String? feedContext, Map<String, dynamic>? $unknown
});
...
/// Create a copy of Interaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? item = freezed,Object? event = freezed,Object? feedContext = freezed,Object? $unknown = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type, @AtUriConverter()  AtUri? item, @InteractionEventConverter()  InteractionEvent? event,  String? feedContext,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Interaction() when $default != null:
return $default(_that.$type,_that.item,_that.event,_that.feedContext,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type, @AtUriConverter()  AtUri? item, @InteractionEventConverter()  InteractionEvent? event,  String? feedContext,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _Interaction():
return $default(_that.$type,_that.item,_that.event,_that.feedContext,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type, @AtUriConverter()  AtUri? item, @InteractionEventConverter()  InteractionEvent? event,  String? feedContext,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _Interaction() when $default != null:
return $default(_that.$type,_that.item,_that.event,_that.feedContext,_that.$unknown);case _:
  return null;
...
class _Interaction implements Interaction {
  const _Interaction({this.$type = 'so.sprk.feed.defs#interaction', @AtUriConverter() this.item, @InteractionEventConverter() this.event, this.feedContext, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,item,event,feedContext,const DeepCollectionEquality().hash(_$unknown));
...
/// Create a copy of Interaction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? item = freezed,Object? event = freezed,Object? feedContext = freezed,Object? $unknown = freezed,}) {
