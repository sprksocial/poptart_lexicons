...
required DateTime indexedAt,
  ...
  factory KnownLike.fromJson(Map<String, Object?> json) => _$KnownLikeFromJson(json);
...
final class KnownLikeConverter
  ...
  KnownLike fromJson(Map<String, dynamic> json) {
    return KnownLike.fromJson(translate(
      json,
      KnownLike.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(KnownLike object) => untranslate(
        object.toJson(),
      );
}
