...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,uri,cid,did,creator,displayName,description,const DeepCollectionEquality().hash(descriptionFacets),avatar,likeCount,acceptsInteractions,const DeepCollectionEquality().hash(labels),viewer,indexedAt,const DeepCollectionEquality().hash($unknown));
...
as GeneratorViewerState?,indexedAt: null == indexedAt ? _self.indexedAt : indexedAt // ignore: cast_nullable_to_non_nullable
...
class _GeneratorView implements GeneratorView {
  const _GeneratorView({this.$type = 'so.sprk.feed.defs#generatorView', @AtUriConverter() required this.uri, required this.cid, required this.did, @ProfileViewConverter() required this.creator, required this.displayName, this.description, @RichtextFacetConverter() final  List<RichtextFacet>? descriptionFacets, this.avatar, this.likeCount, this.acceptsInteractions, @LabelConverter() final  List<Label>? labels, @GeneratorViewerStateConverter() this.viewer, required this.indexedAt, final  Map<String, dynamic>? $unknown}): _descriptionFacets = descriptionFacets,_labels = labels,_$unknown = $unknown;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,uri,cid,did,creator,displayName,description,const DeepCollectionEquality().hash(_descriptionFacets),avatar,likeCount,acceptsInteractions,const DeepCollectionEquality().hash(_labels),viewer,indexedAt,const DeepCollectionEquality().hash(_$unknown));
...
@override $ProfileViewCopyWith<$Res> get creator;@override $GeneratorViewerStateCopyWith<$Res>? get viewer;
