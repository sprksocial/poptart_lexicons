...
sealed class UThreadViewPostPost with _$UThreadViewPostPost {
  ...
  const factory UThreadViewPostPost.postView({
  required PostView data,
}) = UThreadViewPostPostPostView;
const factory UThreadViewPostPost.replyView({
  ...
  Map<String, dynamic> toJson() => const UThreadViewPostPostConverter().toJson(this);
}
...
final class UThreadViewPostPostConverter implements JsonConverter<UThreadViewPostPost, Map<String, dynamic>> {
