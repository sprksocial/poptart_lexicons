...
abstract class ReplyView with _$ReplyView {
  ...
  factory ReplyView.fromJson(Map<String, Object?> json) =>
...
final class ReplyViewConverter
  ...
  ReplyView fromJson(Map<String, dynamic> json) {
    return ReplyView.fromJson(translate(json, ReplyView.knownProps));
  }

  @override
  Map<String, dynamic> toJson(ReplyView object) => untranslate(object.toJson());
}
