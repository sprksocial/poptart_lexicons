...
_PostView _$PostViewFromJson(Map json) => $checkedCreate('_PostView', json, (
  ...
  final val = _PostView(
    $type: $checkedConvert(
      r'$type',
      (v) => v as String? ?? 'so.sprk.feed.defs#postView',
    ),
    uri: $checkedConvert(
      'uri',
    ...
    media: $checkedConvert(
      'media',
      (v) => _$JsonConverterFromJson<Map<String, dynamic>, UPostViewMedia>(
        v,
        const UPostViewMediaConverter().fromJson,
      ),
    ),
...
Map<String, dynamic> _$PostViewToJson(_PostView instance) => <String, dynamic>{
  ...
  'media': ?_$JsonConverterToJson<Map<String, dynamic>, UPostViewMedia>(
    instance.media,
    const UPostViewMediaConverter().toJson,
  ),
