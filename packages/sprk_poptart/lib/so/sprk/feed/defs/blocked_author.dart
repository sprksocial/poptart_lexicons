...
abstract class BlockedAuthor with _$BlockedAuthor {
  ...
  const factory BlockedAuthor({
    @Default('so.sprk.feed.defs#blockedAuthor') String $type,
    required String did,
@ViewerStateConverter() ViewerState? viewer,
  ...
  factory BlockedAuthor.fromJson(Map<String, Object?> json) => _$BlockedAuthorFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.feed.defs#blockedAuthor'
;
}
