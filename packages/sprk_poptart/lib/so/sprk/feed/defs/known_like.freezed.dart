...
/// Create a copy of KnownLike
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$KnownLikeCopyWith<KnownLike> get copyWith => _$KnownLikeCopyWithImpl<KnownLike>(this as KnownLike, _$identity);

  /// Serializes this KnownLike to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is KnownLike&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.by, by) || other.by == by)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.cid, cid) || other.cid == cid)&&(identical(other.indexedAt, indexedAt) || other.indexedAt == indexedAt)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
@override
String toString() {
  return 'KnownLike(\$type: ${$type}, by: $by, uri: $uri, cid: $cid, indexedAt: $indexedAt, \$unknown: ${$unknown})';
}
...
/// @nodoc
abstract mixin class $KnownLikeCopyWith<$Res>  {
  factory $KnownLikeCopyWith(KnownLike value, $Res Function(KnownLike) _then) = _$KnownLikeCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$KnownLikeCopyWithImpl<$Res>
    implements $KnownLikeCopyWith<$Res> {
  _$KnownLikeCopyWithImpl(this._self, this._then);

  final KnownLike _self;
  final $Res Function(KnownLike) _then;
...
/// Adds pattern-matching-related methods to [KnownLike].
extension KnownLikePatterns on KnownLike {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _KnownLike value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _KnownLike() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _KnownLike value)  $default,){
final _that = this;
switch (_that) {
case _KnownLike():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _KnownLike value)?  $default,){
final _that = this;
switch (_that) {
case _KnownLike() when $default != null:
return $default(_that);case _:
...
class _KnownLike implements KnownLike {
  const _KnownLike({this.$type = 'so.sprk.feed.defs#knownLike', @ProfileViewBasicConverter() required this.by, @AtUriConverter() this.uri, this.cid, required this.indexedAt, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _KnownLike.fromJson(Map<String, dynamic> json) => _$KnownLikeFromJson(json);
...
@pragma('vm:prefer-inline')
_$KnownLikeCopyWith<_KnownLike> get copyWith => __$KnownLikeCopyWithImpl<_KnownLike>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$KnownLikeToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _KnownLike&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.by, by) || other.by == by)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.cid, cid) || other.cid == cid)&&(identical(other.indexedAt, indexedAt) || other.indexedAt == indexedAt)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$KnownLikeCopyWith<$Res> implements $KnownLikeCopyWith<$Res> {
  factory _$KnownLikeCopyWith(_KnownLike value, $Res Function(_KnownLike) _then) = __$KnownLikeCopyWithImpl;
@override @useResult
$Res call({
 String $type,@ProfileViewBasicConverter() ProfileViewBasic by,@AtUriConverter() AtUri? uri, String? cid, DateTime indexedAt, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$KnownLikeCopyWithImpl<$Res>
    implements _$KnownLikeCopyWith<$Res> {
  __$KnownLikeCopyWithImpl(this._self, this._then);

  final _KnownLike _self;
  final $Res Function(_KnownLike) _then;
