...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( UReplyRefParentPostView value)?  postView,TResult Function( UReplyRefParentReplyView value)?  replyView,TResult Function( UReplyRefParentNotFoundPost value)?  notFoundPost,TResult Function( UReplyRefParentBlockedPost value)?  blockedPost,TResult Function( UReplyRefParentUnknown value)?  unknown,required TResult orElse(),}){
final _that = this;
switch (_that) {
case UReplyRefParentPostView() when postView != null:
return postView(_that);case UReplyRefParentReplyView() when replyView != null:
return replyView(_that);case UReplyRefParentNotFoundPost() when notFoundPost != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( UReplyRefParentPostView value)  postView,required TResult Function( UReplyRefParentReplyView value)  replyView,required TResult Function( UReplyRefParentNotFoundPost value)  notFoundPost,required TResult Function( UReplyRefParentBlockedPost value)  blockedPost,required TResult Function( UReplyRefParentUnknown value)  unknown,}){
final _that = this;
switch (_that) {
case UReplyRefParentPostView():
return postView(_that);case UReplyRefParentReplyView():
return replyView(_that);case UReplyRefParentNotFoundPost():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( UReplyRefParentPostView value)?  postView,TResult? Function( UReplyRefParentReplyView value)?  replyView,TResult? Function( UReplyRefParentNotFoundPost value)?  notFoundPost,TResult? Function( UReplyRefParentBlockedPost value)?  blockedPost,TResult? Function( UReplyRefParentUnknown value)?  unknown,}){
final _that = this;
switch (_that) {
case UReplyRefParentPostView() when postView != null:
return postView(_that);case UReplyRefParentReplyView() when replyView != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( PostView data)?  postView,TResult Function( ReplyView data)?  replyView,TResult Function( NotFoundPost data)?  notFoundPost,TResult Function( BlockedPost data)?  blockedPost,TResult Function( Map<String, dynamic> data)?  unknown,required TResult orElse(),}) {final _that = this;
switch (_that) {
case UReplyRefParentPostView() when postView != null:
return postView(_that.data);case UReplyRefParentReplyView() when replyView != null:
return replyView(_that.data);case UReplyRefParentNotFoundPost() when notFoundPost != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( PostView data)  postView,required TResult Function( ReplyView data)  replyView,required TResult Function( NotFoundPost data)  notFoundPost,required TResult Function( BlockedPost data)  blockedPost,required TResult Function( Map<String, dynamic> data)  unknown,}) {final _that = this;
switch (_that) {
case UReplyRefParentPostView():
return postView(_that.data);case UReplyRefParentReplyView():
return replyView(_that.data);case UReplyRefParentNotFoundPost():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( PostView data)?  postView,TResult? Function( ReplyView data)?  replyView,TResult? Function( NotFoundPost data)?  notFoundPost,TResult? Function( BlockedPost data)?  blockedPost,TResult? Function( Map<String, dynamic> data)?  unknown,}) {final _that = this;
switch (_that) {
case UReplyRefParentPostView() when postView != null:
return postView(_that.data);case UReplyRefParentReplyView() when replyView != null:
return replyView(_that.data);case UReplyRefParentNotFoundPost() when notFoundPost != null:
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UReplyRefParentReplyViewCopyWith<UReplyRefParentReplyView> get copyWith => _$UReplyRefParentReplyViewCopyWithImpl<UReplyRefParentReplyView>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UReplyRefParentReplyView&&(identical(other.data, data) || other.data == data));
}
...
@override
String toString() {
  return 'UReplyRefParent.replyView(data: $data)';
}
...
/// @nodoc
abstract mixin class $UReplyRefParentReplyViewCopyWith<$Res> implements $UReplyRefParentCopyWith<$Res> {
  factory $UReplyRefParentReplyViewCopyWith(UReplyRefParentReplyView value, $Res Function(UReplyRefParentReplyView) _then) = _$UReplyRefParentReplyViewCopyWithImpl;
@useResult
$Res call({
 ReplyView data
});
...
/// @nodoc
class _$UReplyRefParentReplyViewCopyWithImpl<$Res>
    implements $UReplyRefParentReplyViewCopyWith<$Res> {
  _$UReplyRefParentReplyViewCopyWithImpl(this._self, this._then);

  final UReplyRefParentReplyView _self;
  final $Res Function(UReplyRefParentReplyView) _then;

/// Create a copy of UReplyRefParent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? data = null,}) {
  return _then(UReplyRefParentReplyView(
data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as ReplyView,
  ));
}
