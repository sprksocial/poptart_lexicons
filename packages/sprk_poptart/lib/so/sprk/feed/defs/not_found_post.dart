...
abstract class NotFoundPost with _$NotFoundPost {
  ...
  const factory NotFoundPost({
    @Default('so.sprk.feed.defs#notFoundPost') String $type,
...
required bool notFound,
  ...
  factory NotFoundPost.fromJson(Map<String, Object?> json) => _$NotFoundPostFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.feed.defs#notFoundPost'
;
}
