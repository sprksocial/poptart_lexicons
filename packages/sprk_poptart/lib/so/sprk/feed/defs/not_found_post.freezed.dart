...
$NotFoundPostCopyWith<NotFoundPost> get copyWith => _$NotFoundPostCopyWithImpl<NotFoundPost>(this as NotFoundPost, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotFoundPost&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.notFound, notFound) || other.notFound == notFound)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,uri,notFound,const DeepCollectionEquality().hash($unknown));
...
/// @nodoc
class _$NotFoundPostCopyWithImpl<$Res>
...
/// Create a copy of NotFoundPost
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = null,Object? notFound = null,Object? $unknown = freezed,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NotFoundPost value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NotFoundPost value)  $default,){
final _that = this;
switch (_that) {
case _NotFoundPost():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NotFoundPost value)?  $default,){
final _that = this;
switch (_that) {
case _NotFoundPost() when $default != null:
return $default(_that);case _:
...
class _NotFoundPost implements NotFoundPost {
  const _NotFoundPost({this.$type = 'so.sprk.feed.defs#notFoundPost', @AtUriConverter() required this.uri, required this.notFound, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$NotFoundPostCopyWith<_NotFoundPost> get copyWith => __$NotFoundPostCopyWithImpl<_NotFoundPost>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$NotFoundPostToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotFoundPost&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.notFound, notFound) || other.notFound == notFound)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,uri,notFound,const DeepCollectionEquality().hash(_$unknown));
...
/// @nodoc
abstract mixin class _$NotFoundPostCopyWith<$Res> implements $NotFoundPostCopyWith<$Res> {
...
/// Create a copy of NotFoundPost
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? uri = null,Object? notFound = null,Object? $unknown = freezed,}) {
