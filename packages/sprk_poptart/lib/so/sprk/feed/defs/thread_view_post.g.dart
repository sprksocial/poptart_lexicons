...
_ThreadViewPost _$ThreadViewPostFromJson(
  ...
  final val = _ThreadViewPost(
    $type: $checkedConvert(
      r'$type',
      (v) => v as String? ?? 'so.sprk.feed.defs#threadViewPost',
    ),
    post: $checkedConvert(
      'post',
      (v) => const UThreadViewPostPostConverter().fromJson(
...
Map<String, dynamic> _$ThreadViewPostToJson(
  ...
  'post': const UThreadViewPostPostConverter().toJson(instance.post),
