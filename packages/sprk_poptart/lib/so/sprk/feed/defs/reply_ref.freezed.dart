...
class _ReplyRef implements ReplyRef {
  const _ReplyRef({this.$type = 'so.sprk.feed.defs#replyRef', @UReplyRefRootConverter() required this.root, @UReplyRefParentConverter() required this.parent, @ProfileViewBasicConverter() this.grandparentAuthor, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
