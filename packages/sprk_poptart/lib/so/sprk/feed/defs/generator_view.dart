...
abstract class GeneratorView with _$GeneratorView {
  static const knownProps = <String>['uri', 'cid', 'did', 'creator', 'displayName', 'description', 'descriptionFacets', 'avatar', 'likeCount', 'acceptsInteractions', 'labels', 'viewer', 'indexedAt', ];

  @JsonSerializable(includeIfNull: false)
  const factory GeneratorView({
    @Default('so.sprk.feed.defs#generatorView') String $type,
...
required DateTime indexedAt,
  ...
  factory GeneratorView.fromJson(Map<String, Object?> json) => _$GeneratorViewFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.feed.defs#generatorView'
;
}
