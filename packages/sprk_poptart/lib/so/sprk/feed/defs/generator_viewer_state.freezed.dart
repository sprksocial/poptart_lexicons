...
class _GeneratorViewerState implements GeneratorViewerState {
  const _GeneratorViewerState({this.$type = 'so.sprk.feed.defs#generatorViewerState', @AtUriConverter() this.like, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
