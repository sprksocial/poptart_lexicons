...
/// Create a copy of KnownRepost
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$KnownRepostCopyWith<KnownRepost> get copyWith => _$KnownRepostCopyWithImpl<KnownRepost>(this as KnownRepost, _$identity);

  /// Serializes this KnownRepost to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is KnownRepost&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.by, by) || other.by == by)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.cid, cid) || other.cid == cid)&&(identical(other.indexedAt, indexedAt) || other.indexedAt == indexedAt)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
@override
String toString() {
  return 'KnownRepost(\$type: ${$type}, by: $by, uri: $uri, cid: $cid, indexedAt: $indexedAt, \$unknown: ${$unknown})';
}
...
/// @nodoc
abstract mixin class $KnownRepostCopyWith<$Res>  {
  factory $KnownRepostCopyWith(KnownRepost value, $Res Function(KnownRepost) _then) = _$KnownRepostCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$KnownRepostCopyWithImpl<$Res>
    implements $KnownRepostCopyWith<$Res> {
  _$KnownRepostCopyWithImpl(this._self, this._then);

  final KnownRepost _self;
  final $Res Function(KnownRepost) _then;
...
/// Adds pattern-matching-related methods to [KnownRepost].
extension KnownRepostPatterns on KnownRepost {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _KnownRepost value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _KnownRepost() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _KnownRepost value)  $default,){
final _that = this;
switch (_that) {
case _KnownRepost():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _KnownRepost value)?  $default,){
final _that = this;
switch (_that) {
case _KnownRepost() when $default != null:
return $default(_that);case _:
...
class _KnownRepost implements KnownRepost {
  const _KnownRepost({this.$type = 'so.sprk.feed.defs#knownRepost', @ProfileViewBasicConverter() required this.by, @AtUriConverter() this.uri, this.cid, required this.indexedAt, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _KnownRepost.fromJson(Map<String, dynamic> json) => _$KnownRepostFromJson(json);
...
@pragma('vm:prefer-inline')
_$KnownRepostCopyWith<_KnownRepost> get copyWith => __$KnownRepostCopyWithImpl<_KnownRepost>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$KnownRepostToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _KnownRepost&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.by, by) || other.by == by)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.cid, cid) || other.cid == cid)&&(identical(other.indexedAt, indexedAt) || other.indexedAt == indexedAt)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$KnownRepostCopyWith<$Res> implements $KnownRepostCopyWith<$Res> {
  factory _$KnownRepostCopyWith(_KnownRepost value, $Res Function(_KnownRepost) _then) = __$KnownRepostCopyWithImpl;
@override @useResult
$Res call({
 String $type,@ProfileViewBasicConverter() ProfileViewBasic by,@AtUriConverter() AtUri? uri, String? cid, DateTime indexedAt, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$KnownRepostCopyWithImpl<$Res>
    implements _$KnownRepostCopyWith<$Res> {
  __$KnownRepostCopyWithImpl(this._self, this._then);

  final _KnownRepost _self;
  final $Res Function(_KnownRepost) _then;
