...
required DateTime indexedAt,
  ...
  factory KnownRepost.fromJson(Map<String, Object?> json) => _$KnownRepostFromJson(json);
...
final class KnownRepostConverter
  ...
  KnownRepost fromJson(Map<String, dynamic> json) {
    return KnownRepost.fromJson(translate(
      json,
      KnownRepost.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(KnownRepost object) => untranslate(
        object.toJson(),
      );
}
