...
@freezed
sealed class UViewerStateKnownInteractions
    with _$UViewerStateKnownInteractions {
  ...
  Map<String, dynamic> toJson() =>
      const UViewerStateKnownInteractionsConverter().toJson(this);
}

extension UViewerStateKnownInteractionsExtension
    on UViewerStateKnownInteractions {
...
final class UViewerStateKnownInteractionsConverter
    implements
        JsonConverter<UViewerStateKnownInteractions, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UViewerStateKnownInteractions object) =>
      object.when(
