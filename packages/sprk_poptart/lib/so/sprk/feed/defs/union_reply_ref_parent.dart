...
const factory UReplyRefParent.replyView({
  required ReplyView data,
}) = UReplyRefParentReplyView;
...
const factory UReplyRefParent.blockedPost({
  ...
  Map<String, dynamic> toJson() => const UReplyRefParentConverter().toJson(this);
}
...
bool get isReplyView => isA<UReplyRefParentReplyView>(this);
...
final class UReplyRefParentConverter implements JsonConverter<UReplyRefParent, Map<String, dynamic>> {
...
if (ReplyView.validate(json)) {
  return UReplyRefParent.replyView(
