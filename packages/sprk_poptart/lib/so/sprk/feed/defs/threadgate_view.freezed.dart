...
mixin _$ThreadgateView {
 ...
 String get $type;@AtUriConverter() AtUri? get uri; String? get cid; Map<String, dynamic>? get record; Map<String, dynamic>? get $unknown;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThreadgateView&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.cid, cid) || other.cid == cid)&&const DeepCollectionEquality().equals(other.record, record)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,uri,cid,const DeepCollectionEquality().hash(record),const DeepCollectionEquality().hash($unknown));

@override
String toString() {
  return 'ThreadgateView(\$type: ${$type}, uri: $uri, cid: $cid, record: $record, \$unknown: ${$unknown})';
}
...
@useResult
$Res call({
 String $type,@AtUriConverter() AtUri? uri, String? cid, Map<String, dynamic>? record, Map<String, dynamic>? $unknown
});
...
/// Create a copy of ThreadgateView
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? $type = null,Object? uri = freezed,Object? cid = freezed,Object? record = freezed,Object? $unknown = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String $type, @AtUriConverter()  AtUri? uri,  String? cid,  Map<String, dynamic>? record,  Map<String, dynamic>? $unknown)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThreadgateView() when $default != null:
return $default(_that.$type,_that.uri,_that.cid,_that.record,_that.$unknown);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String $type, @AtUriConverter()  AtUri? uri,  String? cid,  Map<String, dynamic>? record,  Map<String, dynamic>? $unknown)  $default,) {final _that = this;
switch (_that) {
case _ThreadgateView():
return $default(_that.$type,_that.uri,_that.cid,_that.record,_that.$unknown);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String $type, @AtUriConverter()  AtUri? uri,  String? cid,  Map<String, dynamic>? record,  Map<String, dynamic>? $unknown)?  $default,) {final _that = this;
switch (_that) {
case _ThreadgateView() when $default != null:
return $default(_that.$type,_that.uri,_that.cid,_that.record,_that.$unknown);case _:
  return null;
...
class _ThreadgateView implements ThreadgateView {
  const _ThreadgateView({this.$type = 'so.sprk.feed.defs#threadgateView', @AtUriConverter() this.uri, this.cid, final  Map<String, dynamic>? record, final  Map<String, dynamic>? $unknown}): _record = record,_$unknown = $unknown;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ThreadgateView&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.uri, uri) || other.uri == uri)&&(identical(other.cid, cid) || other.cid == cid)&&const DeepCollectionEquality().equals(other._record, _record)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,$type,uri,cid,const DeepCollectionEquality().hash(_record),const DeepCollectionEquality().hash(_$unknown));
...
/// Create a copy of ThreadgateView
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? uri = freezed,Object? cid = freezed,Object? record = freezed,Object? $unknown = freezed,}) {
