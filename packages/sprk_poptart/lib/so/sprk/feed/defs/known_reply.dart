...
String? text,
  ...
  factory KnownReply.fromJson(Map<String, Object?> json) => _$KnownReplyFromJson(json);
...
final class KnownReplyConverter
  ...
  KnownReply fromJson(Map<String, dynamic> json) {
    return KnownReply.fromJson(translate(
      json,
      KnownReply.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(KnownReply object) => untranslate(
        object.toJson(),
      );
}
