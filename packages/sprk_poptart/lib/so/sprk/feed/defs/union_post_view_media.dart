...
sealed class UPostViewMedia with _$UPostViewMedia {
  ...
  const factory UPostViewMedia.mediaVideoView({required MediaVideoView data}) =
      UPostViewMediaMediaVideoView;

  const factory UPostViewMedia.unknown({required Map<String, dynamic> data}) =
...
extension UPostViewMediaExtension on UPostViewMedia {
  ...
  MediaImagesView? get mediaImagesView =>
      isMediaImagesView ? data as MediaImagesView : null;
...
final class UPostViewMediaConverter
    implements JsonConverter<UPostViewMedia, Map<String, dynamic>> {
