...
abstract class SkeletonFeedPost with _$SkeletonFeedPost {
  ...
  const factory SkeletonFeedPost({
    @Default('so.sprk.feed.defs#skeletonFeedPost') String $type,
...
String? feedContext,
  ...
  factory SkeletonFeedPost.fromJson(Map<String, Object?> json) => _$SkeletonFeedPostFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.feed.defs#skeletonFeedPost'
;
}
