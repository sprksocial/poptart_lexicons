...
_KnownLike _$KnownLikeFromJson(Map json) => $checkedCreate('_KnownLike', json, (
  $checkedConvert,
) {
  final val = _KnownLike(
    $type: $checkedConvert(
      r'$type',
      (v) => v as String? ?? 'so.sprk.feed.defs#knownLike',
    ),
    by: $checkedConvert(
      'by',
      (v) =>
...
Map<String, dynamic> _$KnownLikeToJson(_KnownLike instance) =>
    <String, dynamic>{
