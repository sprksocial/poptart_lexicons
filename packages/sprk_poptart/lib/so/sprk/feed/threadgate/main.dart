...
abstract class FeedThreadgateRecord with _$FeedThreadgateRecord {
  static const knownProps = <String>['post', 'allow', 'createdAt', 'hiddenReplies', ];
...
@AtUriConverter() List<AtUri>? hiddenReplies,
  ...
  factory FeedThreadgateRecord.fromJson(Map<String, Object?> json) => _$FeedThreadgateRecordFromJson(json);
