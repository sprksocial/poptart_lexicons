...
class _FeedRepostRecord implements FeedRepostRecord {
  const _FeedRepostRecord({this.$type = 'so.sprk.feed.repost', @RepoStrongRefConverter() required this.subject, required this.createdAt, @RepoStrongRefConverter() this.via, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
