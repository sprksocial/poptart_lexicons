...
abstract class FeedGetCrosspostThreadInput with _$FeedGetCrosspostThreadInput {
  ...
  factory FeedGetCrosspostThreadInput.fromJson(Map<String, Object?> json) =>
      _$FeedGetCrosspostThreadInputFromJson(json);
}
...
final class FeedGetCrosspostThreadInputConverter
  ...
  FeedGetCrosspostThreadInput fromJson(Map<String, dynamic> json) {
    return FeedGetCrosspostThreadInput.fromJson(
      translate(json, FeedGetCrosspostThreadInput.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(FeedGetCrosspostThreadInput object) =>
