...
@freezed
abstract class FeedGetCrosspostThreadOutput with _$FeedGetCrosspostThreadOutput {
...
@ThreadgateViewConverter() ThreadgateView? threadgate,
  ...
  factory FeedGetCrosspostThreadOutput.fromJson(Map<String, Object?> json) => _$FeedGetCrosspostThreadOutputFromJson(json);
}

extension FeedGetCrosspostThreadOutputExtension on FeedGetCrosspostThreadOutput {
...
final class FeedGetCrosspostThreadOutputConverter
  ...
  FeedGetCrosspostThreadOutput fromJson(Map<String, dynamic> json) {
    return FeedGetCrosspostThreadOutput.fromJson(translate(
      json,
      FeedGetCrosspostThreadOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(FeedGetCrosspostThreadOutput object) => untranslate(
        object.toJson(),
      );
}
