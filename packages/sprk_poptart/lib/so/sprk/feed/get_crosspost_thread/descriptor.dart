...
final methodDescriptor =
    XRPCMethodDescriptor<
      ...
      EmptyData,
      FeedGetCrosspostThreadOutput
    >(
      nsid: NSID.parse('so.sprk.feed.getCrosspostThread'),
      kind: XRPCMethodKind.query,
      parametersFromJson: (json) => const FeedGetCrosspostThreadInputConverter()
          .fromJson(json.cast<String, dynamic>()),
      parametersToJson: const FeedGetCrosspostThreadInputConverter().toJson,
      outputFromJson: (json) => const FeedGetCrosspostThreadOutputConverter()
          .fromJson(json.cast<String, dynamic>()),
