...
abstract class FeedGetCrosspostThreadSort with _$FeedGetCrosspostThreadSort {
  ...
  const factory FeedGetCrosspostThreadSort.unknown({required String data}) =
  ...
  static FeedGetCrosspostThreadSort? valueOf(final String? value) {
    ...
    return knownValue != null
        ? FeedGetCrosspostThreadSort.knownValue(data: knownValue)
        : FeedGetCrosspostThreadSort.unknown(data: value);
  }
...
extension FeedGetCrosspostThreadSortExtension on FeedGetCrosspostThreadSort {
  ...
  KnownFeedGetCrosspostThreadSort? get knownValue =>
      isKnownValue ? data as KnownFeedGetCrosspostThreadSort : null;
  bool get isUnknown => isA<FeedGetCrosspostThreadSortUnknown>(this);
  bool get isNotUnknown => !isUnknown;
  String? get unknown => isUnknown ? data as String : null;
}

final class FeedGetCrosspostThreadSortConverter
    extends JsonConverter<FeedGetCrosspostThreadSort, String> {
  ...
  @override
  String toJson(FeedGetCrosspostThreadSort object) =>
