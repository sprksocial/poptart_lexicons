...
mixin _$ThreadItem {
 ...
 String get $type;@AtUriConverter() AtUri get uri;/// The nesting level of this item in the thread. Depth 0 means the anchor item.
...
class _ThreadItem implements ThreadItem {
  const _ThreadItem({this.$type = 'so.sprk.feed.getCrosspostThread#threadItem', @AtUriConverter() required this.uri, required this.depth, @UThreadItemValueConverter() required this.value, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
