...
class _Links implements Links {
  const _Links({this.$type = 'so.sprk.feed.describeFeedGenerator#links', this.privacyPolicy, this.termsOfService, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
