...
class _FeedLikeRecord implements FeedLikeRecord {
  const _FeedLikeRecord({this.$type = 'so.sprk.feed.like', @RepoStrongRefConverter() required this.subject, required this.createdAt, @RepoStrongRefConverter() this.via, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
