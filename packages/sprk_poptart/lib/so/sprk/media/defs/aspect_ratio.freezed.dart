...
class _AspectRatio implements AspectRatio {
  const _AspectRatio({this.$type = 'so.sprk.media.defs#aspectRatio', required this.width, required this.height, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
