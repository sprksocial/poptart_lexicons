...
final mediaVideoDescriptor = XRPCObjectDescriptor<MediaVideo>(
  ...
  defName: 'main',
  fromJson: (json) => const MediaVideoConverter().fromJson(json.cast<String, dynamic>()),
...
final mediaVideoCaptionDescriptor = XRPCObjectDescriptor<MediaVideoCaption>(
  nsid: 'so.sprk.media.video',
  defName: 'caption',
  fromJson: (json) => const MediaVideoCaptionConverter().fromJson(json.cast<String, dynamic>()),
...
final mediaVideoViewDescriptor = XRPCObjectDescriptor<MediaVideoView>(
  nsid: 'so.sprk.media.video',
  defName: 'view',
  fromJson: (json) => const MediaVideoViewConverter().fromJson(json.cast<String, dynamic>()),
