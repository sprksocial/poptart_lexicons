...
@BlobConverter() required Blob file,
  ...
  factory MediaVideoCaption.fromJson(Map<String, Object?> json) => _$MediaVideoCaptionFromJson(json);
...
final class MediaVideoCaptionConverter
  ...
  MediaVideoCaption fromJson(Map<String, dynamic> json) {
    return MediaVideoCaption.fromJson(translate(
      json,
      MediaVideoCaption.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(MediaVideoCaption object) => untranslate(
        object.toJson(),
      );
}
