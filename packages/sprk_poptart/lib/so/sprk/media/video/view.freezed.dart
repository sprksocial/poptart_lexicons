...
/// Create a copy of MediaVideoView
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$MediaVideoViewCopyWith<MediaVideoView> get copyWith => _$MediaVideoViewCopyWithImpl<MediaVideoView>(this as MediaVideoView, _$identity);

  /// Serializes this MediaVideoView to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MediaVideoView&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.cid, cid) || other.cid == cid)&&(identical(other.playlist, playlist) || other.playlist == playlist)&&(identical(other.thumbnail, thumbnail) || other.thumbnail == thumbnail)&&(identical(other.alt, alt) || other.alt == alt)&&(identical(other.aspectRatio, aspectRatio) || other.aspectRatio == aspectRatio)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
@override
String toString() {
  return 'MediaVideoView(\$type: ${$type}, cid: $cid, playlist: $playlist, thumbnail: $thumbnail, alt: $alt, aspectRatio: $aspectRatio, \$unknown: ${$unknown})';
}
...
/// @nodoc
abstract mixin class $MediaVideoViewCopyWith<$Res>  {
  factory $MediaVideoViewCopyWith(MediaVideoView value, $Res Function(MediaVideoView) _then) = _$MediaVideoViewCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$MediaVideoViewCopyWithImpl<$Res>
    implements $MediaVideoViewCopyWith<$Res> {
  _$MediaVideoViewCopyWithImpl(this._self, this._then);

  final MediaVideoView _self;
  final $Res Function(MediaVideoView) _then;
...
/// Adds pattern-matching-related methods to [MediaVideoView].
extension MediaVideoViewPatterns on MediaVideoView {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _MediaVideoView value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _MediaVideoView() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _MediaVideoView value)  $default,){
final _that = this;
switch (_that) {
case _MediaVideoView():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _MediaVideoView value)?  $default,){
final _that = this;
switch (_that) {
case _MediaVideoView() when $default != null:
return $default(_that);case _:
...
class _MediaVideoView implements MediaVideoView {
  const _MediaVideoView({this.$type = 'so.sprk.media.video#view', required this.cid, required this.playlist, this.thumbnail, this.alt, @AspectRatioConverter() this.aspectRatio, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
  factory _MediaVideoView.fromJson(Map<String, dynamic> json) => _$MediaVideoViewFromJson(json);
...
@pragma('vm:prefer-inline')
_$MediaVideoViewCopyWith<_MediaVideoView> get copyWith => __$MediaVideoViewCopyWithImpl<_MediaVideoView>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$MediaVideoViewToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MediaVideoView&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.cid, cid) || other.cid == cid)&&(identical(other.playlist, playlist) || other.playlist == playlist)&&(identical(other.thumbnail, thumbnail) || other.thumbnail == thumbnail)&&(identical(other.alt, alt) || other.alt == alt)&&(identical(other.aspectRatio, aspectRatio) || other.aspectRatio == aspectRatio)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$MediaVideoViewCopyWith<$Res> implements $MediaVideoViewCopyWith<$Res> {
  factory _$MediaVideoViewCopyWith(_MediaVideoView value, $Res Function(_MediaVideoView) _then) = __$MediaVideoViewCopyWithImpl;
@override @useResult
$Res call({
 String $type, String cid, String playlist, String? thumbnail, String? alt,@AspectRatioConverter() AspectRatio? aspectRatio, Map<String, dynamic>? $unknown
});
...
/// @nodoc
class __$MediaVideoViewCopyWithImpl<$Res>
    implements _$MediaVideoViewCopyWith<$Res> {
  __$MediaVideoViewCopyWithImpl(this._self, this._then);

  final _MediaVideoView _self;
  final $Res Function(_MediaVideoView) _then;
