...
_MediaVideo _$MediaVideoFromJson(Map json) =>
    $checkedCreate('_MediaVideo', json, ($checkedConvert) {
      final val = _MediaVideo(
        $type: $checkedConvert(
          r'$type',
          (v) => v as String? ?? 'so.sprk.media.video',
        ),
        ...
        captions: $checkedConvert(
          ...
          (v) => (v as List<dynamic>?)
              ?.map(
                (e) => const MediaVideoCaptionConverter().fromJson(
...
Map<String, dynamic> _$MediaVideoToJson(_MediaVideo instance) =>
    <String, dynamic>{
      r'$type': instance.$type,
      'video': const BlobConverter().toJson(instance.video),
      'captions': ?instance.captions
          ?.map(const MediaVideoCaptionConverter().toJson)
          .toList(),
      'alt': ?instance.alt,
