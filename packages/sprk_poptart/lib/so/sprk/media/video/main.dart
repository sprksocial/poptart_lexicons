...
@AspectRatioConverter() AspectRatio? aspectRatio,
  ...
  factory MediaVideo.fromJson(Map<String, Object?> json) => _$MediaVideoFromJson(json);
...
final class MediaVideoConverter
  ...
  MediaVideo fromJson(Map<String, dynamic> json) {
    return MediaVideo.fromJson(translate(
      json,
      MediaVideo.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(MediaVideo object) => untranslate(
        object.toJson(),
      );
}
