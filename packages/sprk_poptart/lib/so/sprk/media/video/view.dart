...
abstract class MediaVideoView with _$MediaVideoView {
  static const knownProps = <String>['cid', 'playlist', 'thumbnail', 'alt', 'aspectRatio', ];
...
@AspectRatioConverter() AspectRatio? aspectRatio,
  ...
  factory MediaVideoView.fromJson(Map<String, Object?> json) => _$MediaVideoViewFromJson(json);
...
final class MediaVideoViewConverter
  ...
  MediaVideoView fromJson(Map<String, dynamic> json) {
    return MediaVideoView.fromJson(translate(
      json,
      MediaVideoView.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(MediaVideoView object) => untranslate(
        object.toJson(),
      );
}
