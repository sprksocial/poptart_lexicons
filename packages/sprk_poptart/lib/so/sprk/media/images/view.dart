...
abstract class MediaImagesView with _$MediaImagesView {
  ...
  factory MediaImagesView.fromJson(Map<String, Object?> json) =>
      _$MediaImagesViewFromJson(json);
...
final class MediaImagesViewConverter
  ...
  MediaImagesView fromJson(Map<String, dynamic> json) {
    return MediaImagesView.fromJson(
      translate(json, MediaImagesView.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(MediaImagesView object) =>
