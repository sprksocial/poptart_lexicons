...
@AspectRatioConverter() AspectRatio? aspectRatio,
  ...
  factory MediaImageView.fromJson(Map<String, Object?> json) => _$MediaImageViewFromJson(json);
...
final class MediaImageViewConverter
  ...
  MediaImageView fromJson(Map<String, dynamic> json) {
    return MediaImageView.fromJson(translate(
      json,
      MediaImageView.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(MediaImageView object) => untranslate(
        object.toJson(),
      );
}
