...
_MediaImageView _$MediaImageViewFromJson(Map json) =>
    $checkedCreate('_MediaImageView', json, ($checkedConvert) {
      final val = _MediaImageView(
        $type: $checkedConvert(
          r'$type',
          (v) => v as String? ?? 'so.sprk.media.image#view',
        ),
...
Map<String, dynamic> _$MediaImageViewToJson(_MediaImageView instance) =>
    <String, dynamic>{
