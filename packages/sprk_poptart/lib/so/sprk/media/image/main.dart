...
@AspectRatioConverter() AspectRatio? aspectRatio,
  ...
  factory MediaImage.fromJson(Map<String, Object?> json) => _$MediaImageFromJson(json);
...
final class MediaImageConverter
  ...
  MediaImage fromJson(Map<String, dynamic> json) {
    return MediaImage.fromJson(translate(
      json,
      MediaImage.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(MediaImage object) => untranslate(
        object.toJson(),
      );
}
