...
abstract class NotFoundActor with _$NotFoundActor {
  ...
  const factory NotFoundActor({
    @Default('so.sprk.graph.defs#notFoundActor') String $type,
...
required bool notFound,
  ...
  factory NotFoundActor.fromJson(Map<String, Object?> json) => _$NotFoundActorFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.graph.defs#notFoundActor'
;
}
