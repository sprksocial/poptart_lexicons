...
class _NotFoundActor implements NotFoundActor {
  const _NotFoundActor({this.$type = 'so.sprk.graph.defs#notFoundActor', required this.actor, required this.notFound, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
