...
$GraphBlockRecordCopyWith<GraphBlockRecord> get copyWith => _$GraphBlockRecordCopyWithImpl<GraphBlockRecord>(this as GraphBlockRecord, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GraphBlockRecord&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.subject, subject) || other.subject == subject)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other.$unknown, $unknown));
}
...
/// @nodoc
abstract mixin class $GraphBlockRecordCopyWith<$Res>  {
...
/// @nodoc
class _$GraphBlockRecordCopyWithImpl<$Res>
    implements $GraphBlockRecordCopyWith<$Res> {
  _$GraphBlockRecordCopyWithImpl(this._self, this._then);

  final GraphBlockRecord _self;
  final $Res Function(GraphBlockRecord) _then;
...
/// Adds pattern-matching-related methods to [GraphBlockRecord].
extension GraphBlockRecordPatterns on GraphBlockRecord {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GraphBlockRecord value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GraphBlockRecord value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GraphBlockRecord value)?  $default,){
final _that = this;
switch (_that) {
case _GraphBlockRecord() when $default != null:
return $default(_that);case _:
...
class _GraphBlockRecord implements GraphBlockRecord {
  const _GraphBlockRecord({this.$type = 'so.sprk.graph.block', required this.subject, required this.createdAt, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
...
@pragma('vm:prefer-inline')
_$GraphBlockRecordCopyWith<_GraphBlockRecord> get copyWith => __$GraphBlockRecordCopyWithImpl<_GraphBlockRecord>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$GraphBlockRecordToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GraphBlockRecord&&(identical(other.$type, $type) || other.$type == $type)&&(identical(other.subject, subject) || other.subject == subject)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&const DeepCollectionEquality().equals(other._$unknown, _$unknown));
}
...
/// @nodoc
abstract mixin class _$GraphBlockRecordCopyWith<$Res> implements $GraphBlockRecordCopyWith<$Res> {
...
/// @nodoc
class __$GraphBlockRecordCopyWithImpl<$Res>
    implements _$GraphBlockRecordCopyWith<$Res> {
  __$GraphBlockRecordCopyWithImpl(this._self, this._then);

  final _GraphBlockRecord _self;
  final $Res Function(_GraphBlockRecord) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? $type = null,Object? subject = null,Object? createdAt = null,Object? $unknown = freezed,}) {
  return _then(_GraphBlockRecord(
$type: null == $type ? _self.$type : $type // ignore: cast_nullable_to_non_nullable
as String,subject: null == subject ? _self.subject : subject // ignore: cast_nullable_to_non_nullable
as String,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
