...
class _GraphFollowRecord implements GraphFollowRecord {
  const _GraphFollowRecord({this.$type = 'so.sprk.graph.follow', required this.subject, required this.createdAt, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
