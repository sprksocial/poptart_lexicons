...
String? cursor,
  ...
  factory GraphGetKnownFollowersInput.fromJson(Map<String, Object?> json) => _$GraphGetKnownFollowersInputFromJson(json);
}
...
final class GraphGetKnownFollowersInputConverter
  ...
  @override
  Map<String, dynamic> toJson(GraphGetKnownFollowersInput object) => untranslate(
        object.toJson(),
      );
}
