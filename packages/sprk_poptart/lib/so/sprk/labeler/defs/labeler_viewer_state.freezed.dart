...
class _LabelerViewerState implements LabelerViewerState {
  const _LabelerViewerState({this.$type = 'so.sprk.labeler.defs#labelerViewerState', @AtUriConverter() this.like, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
