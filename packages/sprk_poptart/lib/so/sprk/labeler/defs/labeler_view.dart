...
abstract class LabelerView with _$LabelerView {
  static const knownProps = <String>['uri', 'cid', 'creator', 'likeCount', 'viewer', 'indexedAt', 'labels', ];

  @JsonSerializable(includeIfNull: false)
  const factory LabelerView({
    @Default('so.sprk.labeler.defs#labelerView') String $type,
...
@LabelConverter() List<Label>? labels,
  ...
  factory LabelerView.fromJson(Map<String, Object?> json) => _$LabelerViewFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.labeler.defs#labelerView'
;
}
