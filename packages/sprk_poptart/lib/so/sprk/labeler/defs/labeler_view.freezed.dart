...
class _LabelerView implements LabelerView {
  const _LabelerView({this.$type = 'so.sprk.labeler.defs#labelerView', @AtUriConverter() required this.uri, required this.cid, @ProfileViewConverter() required this.creator, this.likeCount, @LabelerViewerStateConverter() this.viewer, required this.indexedAt, @LabelConverter() final  List<Label>? labels, final  Map<String, dynamic>? $unknown}): _labels = labels,_$unknown = $unknown;
