...
class _LabelerPolicies implements LabelerPolicies {
  const _LabelerPolicies({this.$type = 'so.sprk.labeler.defs#labelerPolicies', @LabelValueConverter() required final  List<LabelValue> labelValues, @LabelValueDefinitionConverter() final  List<LabelValueDefinition>? labelValueDefinitions, final  Map<String, dynamic>? $unknown}): _labelValues = labelValues,_labelValueDefinitions = labelValueDefinitions,_$unknown = $unknown;
