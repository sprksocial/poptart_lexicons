...
abstract class LabelerPolicies with _$LabelerPolicies {
  ...
  const factory LabelerPolicies({
    @Default('so.sprk.labeler.defs#labelerPolicies') String $type,
    @LabelValueConverter() required List<LabelValue> labelValues,
@LabelValueDefinitionConverter() List<LabelValueDefinition>? labelValueDefinitions,

    Map<String, dynamic>? $unknown,
  }) = _LabelerPolicies;

  factory LabelerPolicies.fromJson(Map<String, Object?> json) => _$LabelerPoliciesFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.labeler.defs#labelerPolicies'
;
}
