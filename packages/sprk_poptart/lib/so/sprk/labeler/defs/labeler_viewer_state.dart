...
abstract class LabelerViewerState with _$LabelerViewerState {
  ...
  const factory LabelerViewerState({
    @Default('so.sprk.labeler.defs#labelerViewerState') String $type,
    @AtUriConverter() AtUri? like,

    Map<String, dynamic>? $unknown,
  }) = _LabelerViewerState;

  factory LabelerViewerState.fromJson(Map<String, Object?> json) => _$LabelerViewerStateFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'so.sprk.labeler.defs#labelerViewerState'
;
}
