...
sealed class ULabelerServiceLabels with _$ULabelerServiceLabels {
  ...
  Map<String, dynamic> toJson() => const ULabelerServiceLabelsConverter().toJson(this);
}
...
final class ULabelerServiceLabelsConverter implements JsonConverter<ULabelerServiceLabels, Map<String, dynamic>> {
