...
abstract class StoryPostRecord with _$StoryPostRecord {
  static const knownProps = <String>['media', 'sound', 'embeds', 'labels', 'createdAt', ];
...
required DateTime createdAt,
  ...
  factory StoryPostRecord.fromJson(Map<String, Object?> json) => _$StoryPostRecordFromJson(json);
...
final class StoryPostRecordConverter
  ...
  StoryPostRecord fromJson(Map<String, dynamic> json) {
    return StoryPostRecord.fromJson(translate(
      json,
      StoryPostRecord.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(StoryPostRecord object) => untranslate(
        object.toJson(),
      );
}
