...
sealed class UStoryPostMedia with _$UStoryPostMedia {
  ...
  const factory UStoryPostMedia.mediaImage({
  required MediaImage data,
}) = UStoryPostMediaMediaImage;
const factory UStoryPostMedia.mediaVideo({
  required MediaVideo data,
}) = UStoryPostMediaMediaVideo;


  const factory UStoryPostMedia.unknown({
    required Map<String, dynamic> data,
  }) = UStoryPostMediaUnknown;

  Map<String, dynamic> toJson() => const UStoryPostMediaConverter().toJson(this);
}
...
final class UStoryPostMediaConverter implements JsonConverter<UStoryPostMedia, Map<String, dynamic>> {
