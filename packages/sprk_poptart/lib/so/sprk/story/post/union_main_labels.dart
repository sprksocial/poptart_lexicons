...
sealed class UStoryPostLabels with _$UStoryPostLabels {
  ...
  const factory UStoryPostLabels.selfLabels({required SelfLabels data}) =
      UStoryPostLabelsSelfLabels;

  const factory UStoryPostLabels.unknown({required Map<String, dynamic> data}) =
      UStoryPostLabelsUnknown;

  Map<String, dynamic> toJson() =>
      const UStoryPostLabelsConverter().toJson(this);
}
...
final class UStoryPostLabelsConverter
    implements JsonConverter<UStoryPostLabels, Map<String, dynamic>> {
