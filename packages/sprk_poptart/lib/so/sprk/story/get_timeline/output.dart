...
@StoriesByAuthorConverter() required List<StoriesByAuthor> storiesByAuthor,
  ...
  factory StoryGetTimelineOutput.fromJson(Map<String, Object?> json) => _$StoryGetTimelineOutputFromJson(json);
}
...
final class StoryGetTimelineOutputConverter
  ...
  StoryGetTimelineOutput fromJson(Map<String, dynamic> json) {
    return StoryGetTimelineOutput.fromJson(translate(
      json,
      StoryGetTimelineOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(StoryGetTimelineOutput object) => untranslate(
        object.toJson(),
      );
}
