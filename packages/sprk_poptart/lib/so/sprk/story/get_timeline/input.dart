...
abstract class StoryGetTimelineInput with _$StoryGetTimelineInput {
  ...
  factory StoryGetTimelineInput.fromJson(Map<String, Object?> json) =>
      _$StoryGetTimelineInputFromJson(json);
}
...
final class StoryGetTimelineInputConverter
  ...
  StoryGetTimelineInput fromJson(Map<String, dynamic> json) {
    return StoryGetTimelineInput.fromJson(
      translate(json, StoryGetTimelineInput.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(StoryGetTimelineInput object) =>
