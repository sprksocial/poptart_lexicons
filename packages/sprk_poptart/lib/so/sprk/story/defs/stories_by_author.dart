...
@StoryViewConverter() required List<StoryView> stories,
  ...
  factory StoriesByAuthor.fromJson(Map<String, Object?> json) => _$StoriesByAuthorFromJson(json);
...
final class StoriesByAuthorConverter
  ...
  StoriesByAuthor fromJson(Map<String, dynamic> json) {
    return StoriesByAuthor.fromJson(translate(
      json,
      StoriesByAuthor.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(StoriesByAuthor object) => untranslate(
        object.toJson(),
      );
}
