...
sealed class UStoryViewMedia with _$UStoryViewMedia {
  ...
  const factory UStoryViewMedia.mediaImageView({required MediaImageView data}) =
      UStoryViewMediaMediaImageView;
  const factory UStoryViewMedia.mediaVideoView({required MediaVideoView data}) =
      UStoryViewMediaMediaVideoView;

  const factory UStoryViewMedia.unknown({required Map<String, dynamic> data}) =
      UStoryViewMediaUnknown;

  Map<String, dynamic> toJson() =>
      const UStoryViewMediaConverter().toJson(this);
}
...
extension UStoryViewMediaExtension on UStoryViewMedia {
  ...
  MediaVideoView? get mediaVideoView =>
      isMediaVideoView ? data as MediaVideoView : null;
...
final class UStoryViewMediaConverter
    implements JsonConverter<UStoryViewMedia, Map<String, dynamic>> {
