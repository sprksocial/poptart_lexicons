...
abstract class StoryView with _$StoryView {
  ...
  factory StoryView.fromJson(Map<String, Object?> json) =>
...
final class StoryViewConverter
  ...
  StoryView fromJson(Map<String, dynamic> json) {
    return StoryView.fromJson(translate(json, StoryView.knownProps));
  }

  @override
  Map<String, dynamic> toJson(StoryView object) => untranslate(object.toJson());
}
