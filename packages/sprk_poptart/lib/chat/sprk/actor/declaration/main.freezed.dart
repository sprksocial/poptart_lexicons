...
class _ActorDeclarationRecord implements ActorDeclarationRecord {
  const _ActorDeclarationRecord({this.$type = 'chat.sprk.actor.declaration', @ActorDeclarationAllowIncomingConverter() required this.allowIncoming, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
