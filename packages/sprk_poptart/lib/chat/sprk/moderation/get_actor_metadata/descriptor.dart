...
final metadataDescriptor = XRPCObjectDescriptor<Metadata>(
  nsid: 'chat.sprk.moderation.getActorMetadata',
  defName: 'metadata',
  fromJson: (json) =>
...
final methodDescriptor =
    ...
    >(
      nsid: NSID.parse('chat.sprk.moderation.getActorMetadata'),
...
final chatSprkModerationGetActorMetadata = methodDescriptor;
