...
class _Metadata implements Metadata {
  const _Metadata({this.$type = 'chat.sprk.moderation.getActorMetadata#metadata', required this.messagesSent, required this.messagesReceived, required this.convos, required this.convosStarted, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
