...
class _BatchItem implements BatchItem {
  const _BatchItem({this.$type = 'chat.sprk.convo.sendMessageBatch#batchItem', required this.convoId, @MessageInputConverter() required this.message, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
