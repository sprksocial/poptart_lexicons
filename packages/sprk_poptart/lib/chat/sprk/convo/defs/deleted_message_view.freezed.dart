...
class _DeletedMessageView implements DeletedMessageView {
  const _DeletedMessageView({this.$type = 'chat.sprk.convo.defs#deletedMessageView', required this.id, required this.rev, @MessageViewSenderConverter() required this.sender, required this.sentAt, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
