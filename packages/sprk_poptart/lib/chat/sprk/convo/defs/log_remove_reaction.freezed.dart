...
class _LogRemoveReaction implements LogRemoveReaction {
  const _LogRemoveReaction({this.$type = 'chat.sprk.convo.defs#logRemoveReaction', required this.rev, required this.convoId, @ULogRemoveReactionMessageConverter() required this.message, @ReactionViewConverter() required this.reaction, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
