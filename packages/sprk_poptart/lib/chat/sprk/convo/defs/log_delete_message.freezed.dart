...
class _LogDeleteMessage implements LogDeleteMessage {
  const _LogDeleteMessage({this.$type = 'chat.sprk.convo.defs#logDeleteMessage', required this.rev, required this.convoId, @ULogDeleteMessageMessageConverter() required this.message, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
