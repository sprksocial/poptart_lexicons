...
class _LogCreateMessage implements LogCreateMessage {
  const _LogCreateMessage({this.$type = 'chat.sprk.convo.defs#logCreateMessage', required this.rev, required this.convoId, @ULogCreateMessageMessageConverter() required this.message, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
