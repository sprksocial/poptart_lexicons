...
class _MessageRef implements MessageRef {
  const _MessageRef({this.$type = 'chat.sprk.convo.defs#messageRef', required this.did, required this.convoId, required this.messageId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
