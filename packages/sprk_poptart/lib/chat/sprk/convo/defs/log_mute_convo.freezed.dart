...
class _LogMuteConvo implements LogMuteConvo {
  const _LogMuteConvo({this.$type = 'chat.sprk.convo.defs#logMuteConvo', required this.rev, required this.convoId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
