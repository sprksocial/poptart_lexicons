...
class _LogAcceptConvo implements LogAcceptConvo {
  const _LogAcceptConvo({this.$type = 'chat.sprk.convo.defs#logAcceptConvo', required this.rev, required this.convoId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
