...
class _LogLeaveConvo implements LogLeaveConvo {
  const _LogLeaveConvo({this.$type = 'chat.sprk.convo.defs#logLeaveConvo', required this.rev, required this.convoId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
