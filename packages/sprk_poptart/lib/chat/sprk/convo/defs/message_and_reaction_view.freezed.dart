...
class _MessageAndReactionView implements MessageAndReactionView {
  const _MessageAndReactionView({this.$type = 'chat.sprk.convo.defs#messageAndReactionView', @MessageViewConverter() required this.message, @ReactionViewConverter() required this.reaction, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
