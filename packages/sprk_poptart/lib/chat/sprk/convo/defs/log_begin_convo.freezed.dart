...
class _LogBeginConvo implements LogBeginConvo {
  const _LogBeginConvo({this.$type = 'chat.sprk.convo.defs#logBeginConvo', required this.rev, required this.convoId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
