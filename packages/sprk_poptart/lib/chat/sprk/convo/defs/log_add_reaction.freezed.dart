...
class _LogAddReaction implements LogAddReaction {
  const _LogAddReaction({this.$type = 'chat.sprk.convo.defs#logAddReaction', required this.rev, required this.convoId, @ULogAddReactionMessageConverter() required this.message, @ReactionViewConverter() required this.reaction, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
