...
class _LogUnmuteConvo implements LogUnmuteConvo {
  const _LogUnmuteConvo({this.$type = 'chat.sprk.convo.defs#logUnmuteConvo', required this.rev, required this.convoId, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
