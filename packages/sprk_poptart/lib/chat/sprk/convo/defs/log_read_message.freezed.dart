...
class _LogReadMessage implements LogReadMessage {
  const _LogReadMessage({this.$type = 'chat.sprk.convo.defs#logReadMessage', required this.rev, required this.convoId, @ULogReadMessageMessageConverter() required this.message, final  Map<String, dynamic>? $unknown}): _$unknown = $unknown;
