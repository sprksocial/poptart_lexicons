...
final methodDescriptor =
    XRPCMethodDescriptor<
      ...
      QueueCreateQueueOutput
    >(
      nsid: NSID.parse('tools.ozone.queue.createQueue'),
      kind: XRPCMethodKind.procedure,
      inputFromJson: (json) => const QueueCreateQueueInputConverter().fromJson(
        json.cast<String, dynamic>(),
      ),
      inputToJson: const QueueCreateQueueInputConverter().toJson,
