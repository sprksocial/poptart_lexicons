...
final methodDescriptor =
    XRPCMethodDescriptor<
      ...
      QueueUpdateQueueOutput
    >(
      nsid: NSID.parse('tools.ozone.queue.updateQueue'),
      kind: XRPCMethodKind.procedure,
      inputFromJson: (json) => const QueueUpdateQueueInputConverter().fromJson(
        json.cast<String, dynamic>(),
      ),
      inputToJson: const QueueUpdateQueueInputConverter().toJson,
