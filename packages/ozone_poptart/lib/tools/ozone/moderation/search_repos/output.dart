...
@RepoViewConverter() required List<RepoView> repos,
  ...
  factory ModerationSearchReposOutput.fromJson(Map<String, Object?> json) => _$ModerationSearchReposOutputFromJson(json);
}
...
final class ModerationSearchReposOutputConverter
  ...
  @override
  Map<String, dynamic> toJson(ModerationSearchReposOutput object) => untranslate(
        object.toJson(),
      );
}
