...
const factory UModerationGetReposRepos.repoViewNotFound({
  ...
  Map<String, dynamic> toJson() => const UModerationGetReposReposConverter().toJson(this);
}

extension UModerationGetReposReposExtension on UModerationGetReposRepos {
  bool get isRepoViewDetail => isA<UModerationGetReposReposRepoViewDetail>(this);
...
bool get isRepoViewNotFound => isA<UModerationGetReposReposRepoViewNotFound>(this);
...
final class UModerationGetReposReposConverter implements JsonConverter<UModerationGetReposRepos, Map<String, dynamic>> {
