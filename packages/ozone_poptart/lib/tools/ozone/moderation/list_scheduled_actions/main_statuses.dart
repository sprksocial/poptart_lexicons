...
part 'main_statuses.freezed.dart';
...
abstract class ModerationListScheduledActionsStatuses with _$ModerationListScheduledActionsStatuses {
  ...
  const factory ModerationListScheduledActionsStatuses.knownValue({
    required KnownModerationListScheduledActionsStatuses data,
  }) = ModerationListScheduledActionsStatusesKnownValue;

  const factory ModerationListScheduledActionsStatuses.unknown({
    required String data,
  }) = ModerationListScheduledActionsStatusesUnknown;
...
failed('failed'),
  ...
  const KnownModerationListScheduledActionsStatuses(this.value);
