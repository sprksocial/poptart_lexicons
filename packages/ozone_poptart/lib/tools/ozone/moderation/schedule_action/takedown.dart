...
abstract class Takedown with _$Takedown {
  static const knownProps = <String>['comment', 'durationInHours', 'acknowledgeAccountSubjects', 'policies', 'severityLevel', 'strikeCount', 'strikeExpiresAt', 'emailContent', 'emailSubject', ];
...
String? emailSubject,
  ...
  factory Takedown.fromJson(Map<String, Object?> json) => _$TakedownFromJson(json);
...
final class TakedownConverter
  ...
  Takedown fromJson(Map<String, dynamic> json) {
    return Takedown.fromJson(translate(
      json,
      Takedown.knownProps,
    ));
  }
  ...
  @override
  Map<String, dynamic> toJson(Takedown object) => untranslate(
        object.toJson(),
      );
}
