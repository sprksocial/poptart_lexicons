...
abstract class FailedScheduling with _$FailedScheduling {
  ...
  const factory FailedScheduling({
    @Default('tools.ozone.moderation.scheduleAction#failedScheduling') String $type,
...
String? errorCode,
  ...
  factory FailedScheduling.fromJson(Map<String, Object?> json) => _$FailedSchedulingFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'tools.ozone.moderation.scheduleAction#failedScheduling'
;
}
...
final class FailedSchedulingConverter
  ...
  FailedScheduling fromJson(Map<String, dynamic> json) {
    return FailedScheduling.fromJson(translate(
      json,
      FailedScheduling.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(FailedScheduling object) => untranslate(
        object.toJson(),
      );
}
