...
const factory UModerationEmitEventEvent.cancelScheduledTakedownEvent({
  ...
  Map<String, dynamic> toJson() => const UModerationEmitEventEventConverter().toJson(this);
}

extension UModerationEmitEventEventExtension on UModerationEmitEventEvent {
  bool get isModEventTakedown => isA<UModerationEmitEventEventModEventTakedown>(this);
bool get isNotModEventTakedown => !isModEventTakedown;
ModEventTakedown? get modEventTakedown => isModEventTakedown ? data as ModEventTakedown : null;
bool get isModEventAcknowledge => isA<UModerationEmitEventEventModEventAcknowledge>(this);
bool get isNotModEventAcknowledge => !isModEventAcknowledge;
ModEventAcknowledge? get modEventAcknowledge => isModEventAcknowledge ? data as ModEventAcknowledge : null;
bool get isModEventEscalate => isA<UModerationEmitEventEventModEventEscalate>(this);
bool get isNotModEventEscalate => !isModEventEscalate;
ModEventEscalate? get modEventEscalate => isModEventEscalate ? data as ModEventEscalate : null;
bool get isModEventComment => isA<UModerationEmitEventEventModEventComment>(this);
bool get isNotModEventComment => !isModEventComment;
ModEventComment? get modEventComment => isModEventComment ? data as ModEventComment : null;
bool get isModEventLabel => isA<UModerationEmitEventEventModEventLabel>(this);
bool get isNotModEventLabel => !isModEventLabel;
ModEventLabel? get modEventLabel => isModEventLabel ? data as ModEventLabel : null;
bool get isModEventReport => isA<UModerationEmitEventEventModEventReport>(this);
bool get isNotModEventReport => !isModEventReport;
ModEventReport? get modEventReport => isModEventReport ? data as ModEventReport : null;
bool get isModEventMute => isA<UModerationEmitEventEventModEventMute>(this);
bool get isNotModEventMute => !isModEventMute;
ModEventMute? get modEventMute => isModEventMute ? data as ModEventMute : null;
bool get isModEventUnmute => isA<UModerationEmitEventEventModEventUnmute>(this);
bool get isNotModEventUnmute => !isModEventUnmute;
ModEventUnmute? get modEventUnmute => isModEventUnmute ? data as ModEventUnmute : null;
bool get isModEventMuteReporter => isA<UModerationEmitEventEventModEventMuteReporter>(this);
bool get isNotModEventMuteReporter => !isModEventMuteReporter;
ModEventMuteReporter? get modEventMuteReporter => isModEventMuteReporter ? data as ModEventMuteReporter : null;
bool get isModEventUnmuteReporter => isA<UModerationEmitEventEventModEventUnmuteReporter>(this);
bool get isNotModEventUnmuteReporter => !isModEventUnmuteReporter;
ModEventUnmuteReporter? get modEventUnmuteReporter => isModEventUnmuteReporter ? data as ModEventUnmuteReporter : null;
bool get isModEventReverseTakedown => isA<UModerationEmitEventEventModEventReverseTakedown>(this);
bool get isNotModEventReverseTakedown => !isModEventReverseTakedown;
ModEventReverseTakedown? get modEventReverseTakedown => isModEventReverseTakedown ? data as ModEventReverseTakedown : null;
bool get isModEventResolveAppeal => isA<UModerationEmitEventEventModEventResolveAppeal>(this);
bool get isNotModEventResolveAppeal => !isModEventResolveAppeal;
ModEventResolveAppeal? get modEventResolveAppeal => isModEventResolveAppeal ? data as ModEventResolveAppeal : null;
bool get isModEventEmail => isA<UModerationEmitEventEventModEventEmail>(this);
bool get isNotModEventEmail => !isModEventEmail;
ModEventEmail? get modEventEmail => isModEventEmail ? data as ModEventEmail : null;
bool get isModEventDivert => isA<UModerationEmitEventEventModEventDivert>(this);
bool get isNotModEventDivert => !isModEventDivert;
ModEventDivert? get modEventDivert => isModEventDivert ? data as ModEventDivert : null;
...
AccountEvent? get accountEvent => isAccountEvent ? data as AccountEvent : null;
bool get isIdentityEvent => isA<UModerationEmitEventEventIdentityEvent>(this);
bool get isNotIdentityEvent => !isIdentityEvent;
IdentityEvent? get identityEvent => isIdentityEvent ? data as IdentityEvent : null;
...
bool get isModEventPriorityScore => isA<UModerationEmitEventEventModEventPriorityScore>(this);
bool get isNotModEventPriorityScore => !isModEventPriorityScore;
ModEventPriorityScore? get modEventPriorityScore => isModEventPriorityScore ? data as ModEventPriorityScore : null;
bool get isAgeAssuranceEvent => isA<UModerationEmitEventEventAgeAssuranceEvent>(this);
bool get isNotAgeAssuranceEvent => !isAgeAssuranceEvent;
AgeAssuranceEvent? get ageAssuranceEvent => isAgeAssuranceEvent ? data as AgeAssuranceEvent : null;
bool get isAgeAssuranceOverrideEvent => isA<UModerationEmitEventEventAgeAssuranceOverrideEvent>(this);
bool get isNotAgeAssuranceOverrideEvent => !isAgeAssuranceOverrideEvent;
AgeAssuranceOverrideEvent? get ageAssuranceOverrideEvent => isAgeAssuranceOverrideEvent ? data as AgeAssuranceOverrideEvent : null;
bool get isAgeAssurancePurgeEvent => isA<UModerationEmitEventEventAgeAssurancePurgeEvent>(this);
bool get isNotAgeAssurancePurgeEvent => !isAgeAssurancePurgeEvent;
AgeAssurancePurgeEvent? get ageAssurancePurgeEvent => isAgeAssurancePurgeEvent ? data as AgeAssurancePurgeEvent : null;
bool get isRevokeAccountCredentialsEvent => isA<UModerationEmitEventEventRevokeAccountCredentialsEvent>(this);
bool get isNotRevokeAccountCredentialsEvent => !isRevokeAccountCredentialsEvent;
RevokeAccountCredentialsEvent? get revokeAccountCredentialsEvent => isRevokeAccountCredentialsEvent ? data as RevokeAccountCredentialsEvent : null;
bool get isScheduleTakedownEvent => isA<UModerationEmitEventEventScheduleTakedownEvent>(this);
bool get isNotScheduleTakedownEvent => !isScheduleTakedownEvent;
ScheduleTakedownEvent? get scheduleTakedownEvent => isScheduleTakedownEvent ? data as ScheduleTakedownEvent : null;
bool get isCancelScheduledTakedownEvent => isA<UModerationEmitEventEventCancelScheduledTakedownEvent>(this);
bool get isNotCancelScheduledTakedownEvent => !isCancelScheduledTakedownEvent;
CancelScheduledTakedownEvent? get cancelScheduledTakedownEvent => isCancelScheduledTakedownEvent ? data as CancelScheduledTakedownEvent : null;
...
final class UModerationEmitEventEventConverter implements JsonConverter<UModerationEmitEventEvent, Map<String, dynamic>> {
...
modEventAcknowledge: (data) => const ModEventAcknowledgeConverter().toJson(data),
...
modEventMuteReporter: (data) => const ModEventMuteReporterConverter().toJson(data),
modEventUnmuteReporter: (data) => const ModEventUnmuteReporterConverter().toJson(data),
modEventReverseTakedown: (data) => const ModEventReverseTakedownConverter().toJson(data),
modEventResolveAppeal: (data) => const ModEventResolveAppealConverter().toJson(data),
...
modEventPriorityScore: (data) => const ModEventPriorityScoreConverter().toJson(data),
ageAssuranceEvent: (data) => const AgeAssuranceEventConverter().toJson(data),
ageAssuranceOverrideEvent: (data) => const AgeAssuranceOverrideEventConverter().toJson(data),
ageAssurancePurgeEvent: (data) => const AgeAssurancePurgeEventConverter().toJson(data),
revokeAccountCredentialsEvent: (data) => const RevokeAccountCredentialsEventConverter().toJson(data),
scheduleTakedownEvent: (data) => const ScheduleTakedownEventConverter().toJson(data),
cancelScheduledTakedownEvent: (data) => const CancelScheduledTakedownEventConverter().toJson(data),
