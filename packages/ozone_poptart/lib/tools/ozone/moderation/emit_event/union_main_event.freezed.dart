...
return ageAssuranceOverrideEvent(_that);case UModerationEmitEventEventAgeAssurancePurgeEvent() when ageAssurancePurgeEvent != null:
return ageAssurancePurgeEvent(_that);case UModerationEmitEventEventRevokeAccountCredentialsEvent() when revokeAccountCredentialsEvent != null:
...
return ageAssuranceOverrideEvent(_that);case UModerationEmitEventEventAgeAssurancePurgeEvent():
return ageAssurancePurgeEvent(_that);case UModerationEmitEventEventRevokeAccountCredentialsEvent():
...
return ageAssuranceOverrideEvent(_that.data);case UModerationEmitEventEventAgeAssurancePurgeEvent() when ageAssurancePurgeEvent != null:
return ageAssurancePurgeEvent(_that.data);case UModerationEmitEventEventRevokeAccountCredentialsEvent() when revokeAccountCredentialsEvent != null:
...
return ageAssuranceOverrideEvent(_that.data);case UModerationEmitEventEventAgeAssurancePurgeEvent():
return ageAssurancePurgeEvent(_that.data);case UModerationEmitEventEventRevokeAccountCredentialsEvent():
...
class UModerationEmitEventEventAgeAssurancePurgeEvent extends UModerationEmitEventEvent {
  const UModerationEmitEventEventAgeAssurancePurgeEvent({required this.data}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UModerationEmitEventEventAgeAssurancePurgeEventCopyWith<UModerationEmitEventEventAgeAssurancePurgeEvent> get copyWith => _$UModerationEmitEventEventAgeAssurancePurgeEventCopyWithImpl<UModerationEmitEventEventAgeAssurancePurgeEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UModerationEmitEventEventAgeAssurancePurgeEvent&&(identical(other.data, data) || other.data == data));
}
...
/// @nodoc
abstract mixin class $UModerationEmitEventEventAgeAssurancePurgeEventCopyWith<$Res> implements $UModerationEmitEventEventCopyWith<$Res> {
  factory $UModerationEmitEventEventAgeAssurancePurgeEventCopyWith(UModerationEmitEventEventAgeAssurancePurgeEvent value, $Res Function(UModerationEmitEventEventAgeAssurancePurgeEvent) _then) = _$UModerationEmitEventEventAgeAssurancePurgeEventCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UModerationEmitEventEventAgeAssurancePurgeEventCopyWithImpl<$Res>
    implements $UModerationEmitEventEventAgeAssurancePurgeEventCopyWith<$Res> {
  _$UModerationEmitEventEventAgeAssurancePurgeEventCopyWithImpl(this._self, this._then);

  final UModerationEmitEventEventAgeAssurancePurgeEvent _self;
  final $Res Function(UModerationEmitEventEventAgeAssurancePurgeEvent) _then;

/// Create a copy of UModerationEmitEventEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? data = null,}) {
  return _then(UModerationEmitEventEventAgeAssurancePurgeEvent(
data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
