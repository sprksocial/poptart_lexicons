...
final cancellationResultsDescriptor = XRPCObjectDescriptor<CancellationResults>(
  ...
  fromJson: (json) => const CancellationResultsConverter().fromJson(json.cast<String, dynamic>()),
...
final failedCancellationDescriptor = XRPCObjectDescriptor<FailedCancellation>(
  ...
  fromJson: (json) => const FailedCancellationConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const FailedCancellationConverter().toJson,
  matches: FailedCancellation.validate,
);

final methodDescriptor = XRPCMethodDescriptor<EmptyData, ModerationCancelScheduledActionsInput, CancellationResults>(
  nsid: NSID.parse('tools.ozone.moderation.cancelScheduledActions'),
  kind: XRPCMethodKind.procedure,  inputFromJson: (json) => const ModerationCancelScheduledActionsInputConverter().fromJson(json.cast<String, dynamic>()),
  inputToJson: const ModerationCancelScheduledActionsInputConverter().toJson,  outputFromJson: (json) => const CancellationResultsConverter().fromJson(json.cast<String, dynamic>()),
