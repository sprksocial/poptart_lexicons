...
abstract class TimelineItem with _$TimelineItem {
  ...
  const factory TimelineItem({
    @Default('tools.ozone.moderation.getAccountTimeline#timelineItem') String $type,
    required String day,
@TimelineItemSummaryConverter() required List<TimelineItemSummary> summary,
  ...
  return object['\$type'] == 'tools.ozone.moderation.getAccountTimeline#timelineItem'
;
}
...
final class TimelineItemConverter
  ...
  TimelineItem fromJson(Map<String, dynamic> json) {
    return TimelineItem.fromJson(translate(
      json,
      TimelineItem.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(TimelineItem object) => untranslate(
        object.toJson(),
      );
}
