...
sealed class USubjectViewProfile with _$USubjectViewProfile {
  ...
  Map<String, dynamic> toJson() => const USubjectViewProfileConverter().toJson(this);
}
...
final class USubjectViewProfileConverter implements JsonConverter<USubjectViewProfile, Map<String, dynamic>> {
