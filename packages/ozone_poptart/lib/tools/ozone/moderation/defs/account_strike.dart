...
abstract class AccountStrike with _$AccountStrike {
  static const knownProps = <String>['activeStrikeCount', 'totalStrikeCount', 'firstStrikeAt', 'lastStrikeAt', ];
...
DateTime? lastStrikeAt,
  ...
  factory AccountStrike.fromJson(Map<String, Object?> json) => _$AccountStrikeFromJson(json);
...
final class AccountStrikeConverter
  ...
  AccountStrike fromJson(Map<String, dynamic> json) {
    return AccountStrike.fromJson(translate(
      json,
      AccountStrike.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(AccountStrike object) => untranslate(
        object.toJson(),
      );
}
