...
abstract class ModEventEmail with _$ModEventEmail {
  static const knownProps = <String>['subjectLine', 'content', 'comment', 'policies', 'severityLevel', 'strikeCount', 'strikeExpiresAt', 'isDelivered', ];
...
bool? isDelivered,
  ...
  factory ModEventEmail.fromJson(Map<String, Object?> json) => _$ModEventEmailFromJson(json);
