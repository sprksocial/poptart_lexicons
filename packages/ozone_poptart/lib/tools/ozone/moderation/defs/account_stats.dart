...
abstract class AccountStats with _$AccountStats {
  static const knownProps = <String>['reportCount', 'appealCount', 'suspendCount', 'escalateCount', 'takedownCount', ];
...
int? takedownCount,
  ...
  factory AccountStats.fromJson(Map<String, Object?> json) => _$AccountStatsFromJson(json);
