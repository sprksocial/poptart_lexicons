...
const factory USubjectStatusViewHosting.recordHosting({
  ...
  Map<String, dynamic> toJson() => const USubjectStatusViewHostingConverter().toJson(this);
}

extension USubjectStatusViewHostingExtension on USubjectStatusViewHosting {
  bool get isAccountHosting => isA<USubjectStatusViewHostingAccountHosting>(this);
bool get isNotAccountHosting => !isAccountHosting;
AccountHosting? get accountHosting => isAccountHosting ? data as AccountHosting : null;
bool get isRecordHosting => isA<USubjectStatusViewHostingRecordHosting>(this);
bool get isNotRecordHosting => !isRecordHosting;
RecordHosting? get recordHosting => isRecordHosting ? data as RecordHosting : null;
...
final class USubjectStatusViewHostingConverter implements JsonConverter<USubjectStatusViewHosting, Map<String, dynamic>> {
