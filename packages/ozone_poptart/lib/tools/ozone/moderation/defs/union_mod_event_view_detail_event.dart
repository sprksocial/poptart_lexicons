...
const factory UModEventViewDetailEvent.cancelScheduledTakedownEvent({
  ...
  Map<String, dynamic> toJson() => const UModEventViewDetailEventConverter().toJson(this);
}

extension UModEventViewDetailEventExtension on UModEventViewDetailEvent {
  bool get isModEventTakedown => isA<UModEventViewDetailEventModEventTakedown>(this);
...
bool get isModEventReverseTakedown => isA<UModEventViewDetailEventModEventReverseTakedown>(this);
...
bool get isModEventComment => isA<UModEventViewDetailEventModEventComment>(this);
...
bool get isModEventReport => isA<UModEventViewDetailEventModEventReport>(this);
...
bool get isModEventAcknowledge => isA<UModEventViewDetailEventModEventAcknowledge>(this);
...
bool get isModEventEscalate => isA<UModEventViewDetailEventModEventEscalate>(this);
...
bool get isModEventUnmute => isA<UModEventViewDetailEventModEventUnmute>(this);
...
bool get isModEventMuteReporter => isA<UModEventViewDetailEventModEventMuteReporter>(this);
...
bool get isModEventUnmuteReporter => isA<UModEventViewDetailEventModEventUnmuteReporter>(this);
...
bool get isModEventResolveAppeal => isA<UModEventViewDetailEventModEventResolveAppeal>(this);
...
bool get isModEventDivert => isA<UModEventViewDetailEventModEventDivert>(this);
...
bool get isModEventPriorityScore => isA<UModEventViewDetailEventModEventPriorityScore>(this);
...
bool get isAgeAssuranceEvent => isA<UModEventViewDetailEventAgeAssuranceEvent>(this);
...
bool get isAgeAssuranceOverrideEvent => isA<UModEventViewDetailEventAgeAssuranceOverrideEvent>(this);
...
bool get isAgeAssurancePurgeEvent => isA<UModEventViewDetailEventAgeAssurancePurgeEvent>(this);
...
bool get isRevokeAccountCredentialsEvent => isA<UModEventViewDetailEventRevokeAccountCredentialsEvent>(this);
...
bool get isScheduleTakedownEvent => isA<UModEventViewDetailEventScheduleTakedownEvent>(this);
...
bool get isCancelScheduledTakedownEvent => isA<UModEventViewDetailEventCancelScheduledTakedownEvent>(this);
...
final class UModEventViewDetailEventConverter implements JsonConverter<UModEventViewDetailEvent, Map<String, dynamic>> {
