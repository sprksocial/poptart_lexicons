...
abstract class ModEventView with _$ModEventView {
  static const knownProps = <String>['id', 'event', 'subject', 'subjectBlobCids', 'createdBy', 'createdAt', 'creatorHandle', 'subjectHandle', 'modTool', ];
...
@ModToolConverter() ModTool? modTool,
  ...
  factory ModEventView.fromJson(Map<String, Object?> json) => _$ModEventViewFromJson(json);
