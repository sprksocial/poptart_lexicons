...
return ageAssuranceOverrideEvent(_that);case UModEventViewDetailEventAgeAssurancePurgeEvent() when ageAssurancePurgeEvent != null:
return ageAssurancePurgeEvent(_that);case UModEventViewDetailEventRevokeAccountCredentialsEvent() when revokeAccountCredentialsEvent != null:
...
return ageAssuranceOverrideEvent(_that);case UModEventViewDetailEventAgeAssurancePurgeEvent():
return ageAssurancePurgeEvent(_that);case UModEventViewDetailEventRevokeAccountCredentialsEvent():
...
return ageAssuranceOverrideEvent(_that.data);case UModEventViewDetailEventAgeAssurancePurgeEvent() when ageAssurancePurgeEvent != null:
return ageAssurancePurgeEvent(_that.data);case UModEventViewDetailEventRevokeAccountCredentialsEvent() when revokeAccountCredentialsEvent != null:
...
return ageAssuranceOverrideEvent(_that.data);case UModEventViewDetailEventAgeAssurancePurgeEvent():
return ageAssurancePurgeEvent(_that.data);case UModEventViewDetailEventRevokeAccountCredentialsEvent():
...
class UModEventViewDetailEventAgeAssurancePurgeEvent extends UModEventViewDetailEvent {
  const UModEventViewDetailEventAgeAssurancePurgeEvent({required this.data}): super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UModEventViewDetailEventAgeAssurancePurgeEventCopyWith<UModEventViewDetailEventAgeAssurancePurgeEvent> get copyWith => _$UModEventViewDetailEventAgeAssurancePurgeEventCopyWithImpl<UModEventViewDetailEventAgeAssurancePurgeEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UModEventViewDetailEventAgeAssurancePurgeEvent&&(identical(other.data, data) || other.data == data));
}
...
/// @nodoc
abstract mixin class $UModEventViewDetailEventAgeAssurancePurgeEventCopyWith<$Res> implements $UModEventViewDetailEventCopyWith<$Res> {
  factory $UModEventViewDetailEventAgeAssurancePurgeEventCopyWith(UModEventViewDetailEventAgeAssurancePurgeEvent value, $Res Function(UModEventViewDetailEventAgeAssurancePurgeEvent) _then) = _$UModEventViewDetailEventAgeAssurancePurgeEventCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UModEventViewDetailEventAgeAssurancePurgeEventCopyWithImpl<$Res>
    implements $UModEventViewDetailEventAgeAssurancePurgeEventCopyWith<$Res> {
  _$UModEventViewDetailEventAgeAssurancePurgeEventCopyWithImpl(this._self, this._then);

  final UModEventViewDetailEventAgeAssurancePurgeEvent _self;
  final $Res Function(UModEventViewDetailEventAgeAssurancePurgeEvent) _then;

/// Create a copy of UModEventViewDetailEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? data = null,}) {
  return _then(UModEventViewDetailEventAgeAssurancePurgeEvent(
data: null == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
