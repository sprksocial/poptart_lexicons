...
const factory UBlobViewDetails.videoDetails({
  ...
  Map<String, dynamic> toJson() => const UBlobViewDetailsConverter().toJson(this);
}
...
ImageDetails? get imageDetails => isImageDetails ? data as ImageDetails : null;
bool get isVideoDetails => isA<UBlobViewDetailsVideoDetails>(this);
bool get isNotVideoDetails => !isVideoDetails;
VideoDetails? get videoDetails => isVideoDetails ? data as VideoDetails : null;
...
final class UBlobViewDetailsConverter implements JsonConverter<UBlobViewDetails, Map<String, dynamic>> {
