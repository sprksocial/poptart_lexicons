...
abstract class ModEventTakedown with _$ModEventTakedown {
  static const knownProps = <String>['comment', 'durationInHours', 'acknowledgeAccountSubjects', 'policies', 'severityLevel', 'targetServices', 'strikeCount', 'strikeExpiresAt', ];
...
DateTime? strikeExpiresAt,
  ...
  factory ModEventTakedown.fromJson(Map<String, Object?> json) => _$ModEventTakedownFromJson(json);
