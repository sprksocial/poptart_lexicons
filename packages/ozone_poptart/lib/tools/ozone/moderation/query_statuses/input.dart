...
@ModerationQueryStatusesReviewStateConverter() ModerationQueryStatusesReviewState? reviewState,
...
@ModerationQueryStatusesAgeAssuranceStateConverter() ModerationQueryStatusesAgeAssuranceState? ageAssuranceState,
  ...
  factory ModerationQueryStatusesInput.fromJson(Map<String, Object?> json) => _$ModerationQueryStatusesInputFromJson(json);
}

extension ModerationQueryStatusesInputExtension on ModerationQueryStatusesInput {
...
final class ModerationQueryStatusesInputConverter
  ...
  @override
  Map<String, dynamic> toJson(ModerationQueryStatusesInput object) => untranslate(
        object.toJson(),
      );
}
