...
abstract class ModerationQueryEventsInput with _$ModerationQueryEventsInput {
  static const knownProps = <String>['types', 'createdBy', 'sortDirection', 'createdAfter', 'createdBefore', 'subject', 'collections', 'subjectType', 'includeAllUserRecords', 'limit', 'hasComment', 'comment', 'addedLabels', 'removedLabels', 'addedTags', 'removedTags', 'reportTypes', 'policies', 'modTool', 'batchId', 'ageAssuranceState', 'withStrike', 'cursor', ];
...
@ModerationQueryEventsSubjectTypeConverter() ModerationQueryEventsSubjectType? subjectType,
...
@ModerationQueryEventsAgeAssuranceStateConverter() ModerationQueryEventsAgeAssuranceState? ageAssuranceState,
...
String? cursor,
  ...
  factory ModerationQueryEventsInput.fromJson(Map<String, Object?> json) => _$ModerationQueryEventsInputFromJson(json);
}
