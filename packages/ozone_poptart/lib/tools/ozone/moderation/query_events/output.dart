...
@ModEventViewConverter() required List<ModEventView> events,
  ...
  factory ModerationQueryEventsOutput.fromJson(Map<String, Object?> json) => _$ModerationQueryEventsOutputFromJson(json);
}
...
final class ModerationQueryEventsOutputConverter
  ...
  @override
  Map<String, dynamic> toJson(ModerationQueryEventsOutput object) => untranslate(
        object.toJson(),
      );
}
