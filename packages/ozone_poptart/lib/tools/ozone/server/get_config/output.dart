...
abstract class ServerGetConfigOutput with _$ServerGetConfigOutput {
  static const knownProps = <String>['appview', 'pds', 'blobDivert', 'chat', 'viewer', 'verifierDid', ];
...
String? verifierDid,
  ...
  factory ServerGetConfigOutput.fromJson(Map<String, Object?> json) => _$ServerGetConfigOutputFromJson(json);
}
