...
abstract class ViewerConfigRole with _$ViewerConfigRole {
  ...
  static ViewerConfigRole? valueOf(final String? value) {
    ...
    return knownValue != null ? ViewerConfigRole.knownValue(data: knownValue) : ViewerConfigRole.unknown(data: value);
  }
...
KnownViewerConfigRole? get knownValue => isKnownValue ? data as KnownViewerConfigRole : null;
...
final class ViewerConfigRoleConverter extends JsonConverter<ViewerConfigRole, String> {
