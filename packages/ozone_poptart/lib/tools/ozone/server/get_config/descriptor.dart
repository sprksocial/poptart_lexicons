...
final serviceConfigDescriptor = XRPCObjectDescriptor<ServiceConfig>(
  ...
  fromJson: (json) => const ServiceConfigConverter().fromJson(json.cast<String, dynamic>()),
...
final viewerConfigDescriptor = XRPCObjectDescriptor<ViewerConfig>(
  ...
  fromJson: (json) => const ViewerConfigConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const ViewerConfigConverter().toJson,
  matches: ViewerConfig.validate,
);

final methodDescriptor = XRPCMethodDescriptor<EmptyData, EmptyData, ServerGetConfigOutput>(
  nsid: NSID.parse('tools.ozone.server.getConfig'),
  kind: XRPCMethodKind.query,  outputFromJson: (json) => const ServerGetConfigOutputConverter().fromJson(json.cast<String, dynamic>()),
