...
abstract class UrlRule with _$UrlRule {
  static const knownProps = <String>['url', 'pattern', 'action', 'reason', 'comment', 'createdBy', 'createdAt', 'updatedAt', ];
...
required DateTime updatedAt,
  ...
  factory UrlRule.fromJson(Map<String, Object?> json) => _$UrlRuleFromJson(json);
