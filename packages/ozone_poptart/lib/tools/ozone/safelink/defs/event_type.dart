...
abstract class EventType with _$EventType {
  ...
  const factory EventType.knownValue({
    required KnownEventType data,
  }) = EventTypeKnownValue;

  const factory EventType.unknown({
  ...
  static EventType? valueOf(final String? value) {
    ...
    return knownValue != null ? EventType.knownValue(data: knownValue) : EventType.unknown(data: value);
  }
...
KnownEventType? get knownValue => isKnownValue ? data as KnownEventType : null;
...
final class EventTypeConverter extends JsonConverter<EventType, String> {
  ...
  @override
  String toJson(EventType object) => object.when(
