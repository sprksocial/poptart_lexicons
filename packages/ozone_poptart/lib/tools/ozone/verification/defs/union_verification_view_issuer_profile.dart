...
@freezed
sealed class UVerificationViewIssuerProfile with _$UVerificationViewIssuerProfile {
  ...
  Map<String, dynamic> toJson() => const UVerificationViewIssuerProfileConverter().toJson(this);
}

extension UVerificationViewIssuerProfileExtension on UVerificationViewIssuerProfile {
...
final class UVerificationViewIssuerProfileConverter implements JsonConverter<UVerificationViewIssuerProfile, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UVerificationViewIssuerProfile object) => object.when(
