...
import '../../moderation/defs/repo_view_not_found.dart';
...
const factory UVerificationViewSubjectRepo.repoViewNotFound({
  ...
  Map<String, dynamic> toJson() => const UVerificationViewSubjectRepoConverter().toJson(this);
}

extension UVerificationViewSubjectRepoExtension on UVerificationViewSubjectRepo {
  bool get isRepoViewDetail => isA<UVerificationViewSubjectRepoRepoViewDetail>(this);
bool get isNotRepoViewDetail => !isRepoViewDetail;
RepoViewDetail? get repoViewDetail => isRepoViewDetail ? data as RepoViewDetail : null;
bool get isRepoViewNotFound => isA<UVerificationViewSubjectRepoRepoViewNotFound>(this);
bool get isNotRepoViewNotFound => !isRepoViewNotFound;
RepoViewNotFound? get repoViewNotFound => isRepoViewNotFound ? data as RepoViewNotFound : null;
...
final class UVerificationViewSubjectRepoConverter implements JsonConverter<UVerificationViewSubjectRepo, Map<String, dynamic>> {
...
if (RepoViewNotFound.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UVerificationViewSubjectRepo object) => object.when(
