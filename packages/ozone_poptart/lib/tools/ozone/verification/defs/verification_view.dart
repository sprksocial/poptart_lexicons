...
abstract class VerificationView with _$VerificationView {
  static const knownProps = <String>['issuer', 'uri', 'subject', 'handle', 'displayName', 'createdAt', 'revokeReason', 'revokedAt', 'revokedBy', 'subjectProfile', 'issuerProfile', 'subjectRepo', 'issuerRepo', ];
