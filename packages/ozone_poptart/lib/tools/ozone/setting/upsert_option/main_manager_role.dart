...
@freezed
abstract class SettingUpsertOptionManagerRole with _$SettingUpsertOptionManagerRole {
  ...
  static SettingUpsertOptionManagerRole? valueOf(final String? value) {
    ...
    return knownValue != null ? SettingUpsertOptionManagerRole.knownValue(data: knownValue) : SettingUpsertOptionManagerRole.unknown(data: value);
  }

  String toJson() => const SettingUpsertOptionManagerRoleConverter().toJson(this);
}

extension SettingUpsertOptionManagerRoleExtension on SettingUpsertOptionManagerRole {
  bool get isKnownValue => isA<SettingUpsertOptionManagerRoleKnownValue>(this);
bool get isNotKnownValue => !isKnownValue;
KnownSettingUpsertOptionManagerRole? get knownValue => isKnownValue ? data as KnownSettingUpsertOptionManagerRole : null;
...
final class SettingUpsertOptionManagerRoleConverter extends JsonConverter<SettingUpsertOptionManagerRole, String> {
