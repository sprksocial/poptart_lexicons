...
abstract class OptionManagerRole with _$OptionManagerRole {
  ...
  static OptionManagerRole? valueOf(final String? value) {
    ...
    return knownValue != null ? OptionManagerRole.knownValue(data: knownValue) : OptionManagerRole.unknown(data: value);
  }
...
KnownOptionManagerRole? get knownValue => isKnownValue ? data as KnownOptionManagerRole : null;
...
final class OptionManagerRoleConverter extends JsonConverter<OptionManagerRole, String> {
