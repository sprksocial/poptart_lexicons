...
abstract class SettingListOptionsScope with _$SettingListOptionsScope {
  ...
  static SettingListOptionsScope? valueOf(final String? value) {
    ...
    return knownValue != null ? SettingListOptionsScope.knownValue(data: knownValue) : SettingListOptionsScope.unknown(data: value);
  }
...
KnownSettingListOptionsScope? get knownValue => isKnownValue ? data as KnownSettingListOptionsScope : null;
...
final class SettingListOptionsScopeConverter extends JsonConverter<SettingListOptionsScope, String> {
