...
@freezed
abstract class CommunicationDeleteTemplateInput with _$CommunicationDeleteTemplateInput {
  ...
  factory CommunicationDeleteTemplateInput.fromJson(Map<String, Object?> json) => _$CommunicationDeleteTemplateInputFromJson(json);
}



final class CommunicationDeleteTemplateInputConverter
    extends JsonConverter<CommunicationDeleteTemplateInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(CommunicationDeleteTemplateInput object) => untranslate(
        object.toJson(),
      );
}
