...
const factory UEmbedRecordViewRecordEmbeds.embedRecordWithMediaView({
  ...
  Map<String, dynamic> toJson() => const UEmbedRecordViewRecordEmbedsConverter().toJson(this);
}

extension UEmbedRecordViewRecordEmbedsExtension on UEmbedRecordViewRecordEmbeds {
  bool get isEmbedImagesView => isA<UEmbedRecordViewRecordEmbedsEmbedImagesView>(this);
bool get isNotEmbedImagesView => !isEmbedImagesView;
EmbedImagesView? get embedImagesView => isEmbedImagesView ? data as EmbedImagesView : null;
bool get isEmbedVideoView => isA<UEmbedRecordViewRecordEmbedsEmbedVideoView>(this);
bool get isNotEmbedVideoView => !isEmbedVideoView;
EmbedVideoView? get embedVideoView => isEmbedVideoView ? data as EmbedVideoView : null;
bool get isEmbedExternalView => isA<UEmbedRecordViewRecordEmbedsEmbedExternalView>(this);
bool get isNotEmbedExternalView => !isEmbedExternalView;
EmbedExternalView? get embedExternalView => isEmbedExternalView ? data as EmbedExternalView : null;
bool get isEmbedRecordView => isA<UEmbedRecordViewRecordEmbedsEmbedRecordView>(this);
...
bool get isEmbedRecordWithMediaView => isA<UEmbedRecordViewRecordEmbedsEmbedRecordWithMediaView>(this);
bool get isNotEmbedRecordWithMediaView => !isEmbedRecordWithMediaView;
EmbedRecordWithMediaView? get embedRecordWithMediaView => isEmbedRecordWithMediaView ? data as EmbedRecordWithMediaView : null;
...
final class UEmbedRecordViewRecordEmbedsConverter implements JsonConverter<UEmbedRecordViewRecordEmbeds, Map<String, dynamic>> {
...
if (EmbedRecordWithMediaView.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UEmbedRecordViewRecordEmbeds object) => object.when(
...
embedExternalView: (data) => const EmbedExternalViewConverter().toJson(data),
embedRecordView: (data) => const EmbedRecordViewConverter().toJson(data),
embedRecordWithMediaView: (data) => const EmbedRecordWithMediaViewConverter().toJson(data),
