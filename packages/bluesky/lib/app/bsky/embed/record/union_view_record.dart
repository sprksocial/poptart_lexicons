...
extension UEmbedRecordViewRecordExtension on UEmbedRecordViewRecord {
  bool get isEmbedRecordViewRecord => isA<UEmbedRecordViewRecordEmbedRecordViewRecord>(this);
bool get isNotEmbedRecordViewRecord => !isEmbedRecordViewRecord;
EmbedRecordViewRecord? get embedRecordViewRecord => isEmbedRecordViewRecord ? data as EmbedRecordViewRecord : null;
bool get isEmbedRecordViewNotFound => isA<UEmbedRecordViewRecordEmbedRecordViewNotFound>(this);
bool get isNotEmbedRecordViewNotFound => !isEmbedRecordViewNotFound;
EmbedRecordViewNotFound? get embedRecordViewNotFound => isEmbedRecordViewNotFound ? data as EmbedRecordViewNotFound : null;
bool get isEmbedRecordViewBlocked => isA<UEmbedRecordViewRecordEmbedRecordViewBlocked>(this);
bool get isNotEmbedRecordViewBlocked => !isEmbedRecordViewBlocked;
EmbedRecordViewBlocked? get embedRecordViewBlocked => isEmbedRecordViewBlocked ? data as EmbedRecordViewBlocked : null;
bool get isEmbedRecordViewDetached => isA<UEmbedRecordViewRecordEmbedRecordViewDetached>(this);
bool get isNotEmbedRecordViewDetached => !isEmbedRecordViewDetached;
EmbedRecordViewDetached? get embedRecordViewDetached => isEmbedRecordViewDetached ? data as EmbedRecordViewDetached : null;
bool get isGeneratorView => isA<UEmbedRecordViewRecordGeneratorView>(this);
bool get isNotGeneratorView => !isGeneratorView;
GeneratorView? get generatorView => isGeneratorView ? data as GeneratorView : null;
...
bool get isStarterPackViewBasic => isA<UEmbedRecordViewRecordStarterPackViewBasic>(this);
bool get isNotStarterPackViewBasic => !isStarterPackViewBasic;
StarterPackViewBasic? get starterPackViewBasic => isStarterPackViewBasic ? data as StarterPackViewBasic : null;
...
final class UEmbedRecordViewRecordConverter implements JsonConverter<UEmbedRecordViewRecord, Map<String, dynamic>> {
...
if (StarterPackViewBasic.validate(json)) {
  ...
  Map<String, dynamic> toJson(UEmbedRecordViewRecord object) => object.when(
        embedRecordViewRecord: (data) => const EmbedRecordViewRecordConverter().toJson(data),
embedRecordViewNotFound: (data) => const EmbedRecordViewNotFoundConverter().toJson(data),
embedRecordViewBlocked: (data) => const EmbedRecordViewBlockedConverter().toJson(data),
embedRecordViewDetached: (data) => const EmbedRecordViewDetachedConverter().toJson(data),
...
starterPackViewBasic: (data) => const StarterPackViewBasicConverter().toJson(data),
