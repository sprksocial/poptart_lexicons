...
final embedExternalDescriptor = XRPCObjectDescriptor<EmbedExternal>(
  ...
  defName: 'main',
  fromJson: (json) => const EmbedExternalConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const EmbedExternalConverter().toJson,
  matches: EmbedExternal.validate,
);

final embedExternalExternalDescriptor = XRPCObjectDescriptor<EmbedExternalExternal>(
  nsid: 'app.bsky.embed.external',
  defName: 'external',
  fromJson: (json) => const EmbedExternalExternalConverter().fromJson(json.cast<String, dynamic>()),
...
final embedExternalViewDescriptor = XRPCObjectDescriptor<EmbedExternalView>(
  nsid: 'app.bsky.embed.external',
  defName: 'view',
  fromJson: (json) => const EmbedExternalViewConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const EmbedExternalViewConverter().toJson,
  matches: EmbedExternalView.validate,
);

final embedExternalViewExternalDescriptor = XRPCObjectDescriptor<EmbedExternalViewExternal>(
  nsid: 'app.bsky.embed.external',
  defName: 'viewExternal',
  fromJson: (json) => const EmbedExternalViewExternalConverter().fromJson(json.cast<String, dynamic>()),
