...
abstract class EmbedVideoPresentation with _$EmbedVideoPresentation {
  ...
  const factory EmbedVideoPresentation.unknown({
  ...
  static EmbedVideoPresentation? valueOf(final String? value) {
    ...
    return knownValue != null ? EmbedVideoPresentation.knownValue(data: knownValue) : EmbedVideoPresentation.unknown(data: value);
  }
...
KnownEmbedVideoPresentation? get knownValue => isKnownValue ? data as KnownEmbedVideoPresentation : null;
...
final class EmbedVideoPresentationConverter extends JsonConverter<EmbedVideoPresentation, String> {
  ...
  @override
  String toJson(EmbedVideoPresentation object) => object.when(
