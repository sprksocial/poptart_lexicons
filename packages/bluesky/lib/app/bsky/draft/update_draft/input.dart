...
abstract class DraftUpdateDraftInput with _$DraftUpdateDraftInput {
  ...
  factory DraftUpdateDraftInput.fromJson(Map<String, Object?> json) => _$DraftUpdateDraftInputFromJson(json);
}
...
final class DraftUpdateDraftInputConverter
  ...
  DraftUpdateDraftInput fromJson(Map<String, dynamic> json) {
    return DraftUpdateDraftInput.fromJson(translate(
      json,
      DraftUpdateDraftInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(DraftUpdateDraftInput object) => untranslate(
        object.toJson(),
      );
}
