...
abstract class Draft with _$Draft {
  static const knownProps = <String>['deviceId', 'deviceName', 'posts', 'langs', 'postgateEmbeddingRules', 'threadgateAllow', ];
...
List<String>? langs,
@UDraftPostgateEmbeddingRulesConverter() List<UDraftPostgateEmbeddingRules>? postgateEmbeddingRules,
@UDraftThreadgateAllowConverter() List<UDraftThreadgateAllow>? threadgateAllow,
...
final class DraftConverter
    extends JsonConverter<Draft, Map<String, dynamic>> {
  const DraftConverter();

  @override
  Draft fromJson(Map<String, dynamic> json) {
    return Draft.fromJson(translate(
      json,
      Draft.knownProps,
    ));
  }
  ...
  @override
  Map<String, dynamic> toJson(Draft object) => untranslate(
        object.toJson(),
      );
}
