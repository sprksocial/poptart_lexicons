...
String? cursor,
  ...
  factory DraftGetDraftsInput.fromJson(Map<String, Object?> json) => _$DraftGetDraftsInputFromJson(json);
}
...
final class DraftGetDraftsInputConverter
  ...
  DraftGetDraftsInput fromJson(Map<String, dynamic> json) {
    return DraftGetDraftsInput.fromJson(translate(
      json,
      DraftGetDraftsInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(DraftGetDraftsInput object) => untranslate(
        object.toJson(),
      );
}
