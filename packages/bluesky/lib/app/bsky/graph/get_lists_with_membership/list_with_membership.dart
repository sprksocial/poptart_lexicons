...
abstract class ListWithMembership with _$ListWithMembership {
  ...
  const factory ListWithMembership({
    @Default('app.bsky.graph.getListsWithMembership#listWithMembership') String $type,
...
@ListItemViewConverter() ListItemView? listItem,
  ...
  factory ListWithMembership.fromJson(Map<String, Object?> json) => _$ListWithMembershipFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'app.bsky.graph.getListsWithMembership#listWithMembership'
;
}
...
final class ListWithMembershipConverter
  ...
  ListWithMembership fromJson(Map<String, dynamic> json) {
    return ListWithMembership.fromJson(translate(
      json,
      ListWithMembership.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ListWithMembership object) => untranslate(
        object.toJson(),
      );
}
