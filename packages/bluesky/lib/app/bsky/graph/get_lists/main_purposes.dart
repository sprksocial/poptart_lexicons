...
abstract class GraphGetListsPurposes with _$GraphGetListsPurposes {
  ...
  const factory GraphGetListsPurposes.unknown({
  ...
  static GraphGetListsPurposes? valueOf(final String? value) {
    ...
    return knownValue != null ? GraphGetListsPurposes.knownValue(data: knownValue) : GraphGetListsPurposes.unknown(data: value);
  }
...
KnownGraphGetListsPurposes? get knownValue => isKnownValue ? data as KnownGraphGetListsPurposes : null;
...
final class GraphGetListsPurposesConverter extends JsonConverter<GraphGetListsPurposes, String> {
  ...
  @override
  String toJson(GraphGetListsPurposes object) => object.when(
