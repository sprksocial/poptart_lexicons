...
abstract class GraphGetRelationshipsOutput with _$GraphGetRelationshipsOutput {
  ...
  const factory GraphGetRelationshipsOutput({
    String? actor,
@UGraphGetRelationshipsRelationshipsConverter() required List<UGraphGetRelationshipsRelationships> relationships,

    Map<String, dynamic>? $unknown,
  }) = _GraphGetRelationshipsOutput;

  factory GraphGetRelationshipsOutput.fromJson(Map<String, Object?> json) => _$GraphGetRelationshipsOutputFromJson(json);
}
...
final class GraphGetRelationshipsOutputConverter
  ...
  @override
  Map<String, dynamic> toJson(GraphGetRelationshipsOutput object) => untranslate(
        object.toJson(),
      );
}
