...
sealed class UGraphListLabels with _$UGraphListLabels {
  ...
  Map<String, dynamic> toJson() => const UGraphListLabelsConverter().toJson(this);
}
...
final class UGraphListLabelsConverter implements JsonConverter<UGraphListLabels, Map<String, dynamic>> {
