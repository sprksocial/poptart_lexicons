...
abstract class ListViewBasic with _$ListViewBasic {
  static const knownProps = <String>['uri', 'cid', 'name', 'purpose', 'avatar', 'listItemCount', 'labels', 'viewer', 'indexedAt', ];
...
DateTime? indexedAt,
  ...
  factory ListViewBasic.fromJson(Map<String, Object?> json) => _$ListViewBasicFromJson(json);
