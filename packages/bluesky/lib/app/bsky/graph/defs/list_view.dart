...
abstract class ListView with _$ListView {
  static const knownProps = <String>['uri', 'cid', 'creator', 'name', 'purpose', 'description', 'descriptionFacets', 'avatar', 'listItemCount', 'labels', 'viewer', 'indexedAt', ];
...
required DateTime indexedAt,
  ...
  factory ListView.fromJson(Map<String, Object?> json) => _$ListViewFromJson(json);
