...
abstract class Status with _$Status {
  ...
  const factory Status.knownValue({
    required KnownStatus data,
  }) = StatusKnownValue;

  const factory Status.unknown({
  ...
  static Status? valueOf(final String? value) {
    ...
    return knownValue != null ? Status.knownValue(data: knownValue) : Status.unknown(data: value);
  }
...
final class StatusConverter extends JsonConverter<Status, String> {
  ...
  @override
  String toJson(Status object) => object.when(
