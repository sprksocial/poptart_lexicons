...
abstract class Event with _$Event {
  static const knownProps = <String>['createdAt', 'attemptId', 'status', 'access', 'countryCode', 'regionCode', 'email', 'initIp', 'initUa', 'completeIp', 'completeUa', ];
...
final class EventConverter
    extends JsonConverter<Event, Map<String, dynamic>> {
