...
abstract class ConfigRegion with _$ConfigRegion {
  static const knownProps = <String>['countryCode', 'regionCode', 'minAccessAge', 'rules', ];
...
@UConfigRegionRulesConverter() required List<UConfigRegionRules> rules,
  ...
  factory ConfigRegion.fromJson(Map<String, Object?> json) => _$ConfigRegionFromJson(json);
...
final class ConfigRegionConverter
  ...
  ConfigRegion fromJson(Map<String, dynamic> json) {
    return ConfigRegion.fromJson(translate(
      json,
      ConfigRegion.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ConfigRegion object) => untranslate(
        object.toJson(),
      );
}
