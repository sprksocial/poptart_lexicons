...
@StateMetadataConverter() required StateMetadata metadata,
  ...
  factory AgeassuranceGetStateOutput.fromJson(Map<String, Object?> json) => _$AgeassuranceGetStateOutputFromJson(json);
}
...
final class AgeassuranceGetStateOutputConverter
  ...
  AgeassuranceGetStateOutput fromJson(Map<String, dynamic> json) {
    return AgeassuranceGetStateOutput.fromJson(translate(
      json,
      AgeassuranceGetStateOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(AgeassuranceGetStateOutput object) => untranslate(
        object.toJson(),
      );
}
