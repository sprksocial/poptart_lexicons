...
@freezed
abstract class NotificationRegisterPushInput with _$NotificationRegisterPushInput {
  static const knownProps = <String>['serviceDid', 'token', 'platform', 'appId', 'ageRestricted', ];

  @JsonSerializable(includeIfNull: false)
  const factory NotificationRegisterPushInput({
    required String serviceDid,
required String token,
@NotificationRegisterPushPlatformConverter() required NotificationRegisterPushPlatform platform,
...
bool? ageRestricted,
  ...
  factory NotificationRegisterPushInput.fromJson(Map<String, Object?> json) => _$NotificationRegisterPushInputFromJson(json);
}

extension NotificationRegisterPushInputExtension on NotificationRegisterPushInput {
...
final class NotificationRegisterPushInputConverter
  ...
  @override
  Map<String, dynamic> toJson(NotificationRegisterPushInput object) => untranslate(
        object.toJson(),
      );
}
