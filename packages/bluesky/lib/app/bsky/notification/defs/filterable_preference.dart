...
abstract class FilterablePreference with _$FilterablePreference {
  ...
  const factory FilterablePreference({
    ...
    @FilterablePreferenceIncludeConverter() required FilterablePreferenceInclude include,
required bool list,
required bool push,
  ...
  factory FilterablePreference.fromJson(Map<String, Object?> json) => _$FilterablePreferenceFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'app.bsky.notification.defs#filterablePreference'
;
}
