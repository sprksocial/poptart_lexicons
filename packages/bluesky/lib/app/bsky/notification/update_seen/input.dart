...
abstract class NotificationUpdateSeenInput with _$NotificationUpdateSeenInput {
  ...
  factory NotificationUpdateSeenInput.fromJson(Map<String, Object?> json) => _$NotificationUpdateSeenInputFromJson(json);
}
...
final class NotificationUpdateSeenInputConverter
  ...
  @override
  Map<String, dynamic> toJson(NotificationUpdateSeenInput object) => untranslate(
        object.toJson(),
      );
}
