...
abstract class ActorStatusStatus with _$ActorStatusStatus {
  ...
  static ActorStatusStatus? valueOf(final String? value) {
    ...
    return knownValue != null ? ActorStatusStatus.knownValue(data: knownValue) : ActorStatusStatus.unknown(data: value);
  }
...
KnownActorStatusStatus? get knownValue => isKnownValue ? data as KnownActorStatusStatus : null;
...
final class ActorStatusStatusConverter extends JsonConverter<ActorStatusStatus, String> {
