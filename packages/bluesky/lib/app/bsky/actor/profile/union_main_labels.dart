...
sealed class UActorProfileLabels with _$UActorProfileLabels {
  ...
  Map<String, dynamic> toJson() => const UActorProfileLabelsConverter().toJson(this);
}
...
final class UActorProfileLabelsConverter implements JsonConverter<UActorProfileLabels, Map<String, dynamic>> {
