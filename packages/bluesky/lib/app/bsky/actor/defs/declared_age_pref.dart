...
abstract class DeclaredAgePref with _$DeclaredAgePref {
  static const knownProps = <String>['isOverAge13', 'isOverAge16', 'isOverAge18', ];
...
bool? isOverAge18,
  ...
  factory DeclaredAgePref.fromJson(Map<String, Object?> json) => _$DeclaredAgePrefFromJson(json);
...
final class DeclaredAgePrefConverter
  ...
  DeclaredAgePref fromJson(Map<String, dynamic> json) {
    return DeclaredAgePref.fromJson(translate(
      json,
      DeclaredAgePref.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(DeclaredAgePref object) => untranslate(
        object.toJson(),
      );
}
