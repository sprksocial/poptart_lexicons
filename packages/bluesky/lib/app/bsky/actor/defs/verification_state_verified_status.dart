...
@freezed
abstract class VerificationStateVerifiedStatus with _$VerificationStateVerifiedStatus {
  ...
  static VerificationStateVerifiedStatus? valueOf(final String? value) {
    ...
    return knownValue != null ? VerificationStateVerifiedStatus.knownValue(data: knownValue) : VerificationStateVerifiedStatus.unknown(data: value);
  }

  String toJson() => const VerificationStateVerifiedStatusConverter().toJson(this);
}

extension VerificationStateVerifiedStatusExtension on VerificationStateVerifiedStatus {
  bool get isKnownValue => isA<VerificationStateVerifiedStatusKnownValue>(this);
bool get isNotKnownValue => !isKnownValue;
KnownVerificationStateVerifiedStatus? get knownValue => isKnownValue ? data as KnownVerificationStateVerifiedStatus : null;
...
final class VerificationStateVerifiedStatusConverter extends JsonConverter<VerificationStateVerifiedStatus, String> {
