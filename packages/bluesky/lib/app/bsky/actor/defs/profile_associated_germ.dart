...
@ProfileAssociatedGermShowButtonToConverter() required ProfileAssociatedGermShowButtonTo showButtonTo,

    Map<String, dynamic>? $unknown,
  }) = _ProfileAssociatedGerm;

  factory ProfileAssociatedGerm.fromJson(Map<String, Object?> json) => _$ProfileAssociatedGermFromJson(json);
...
final class ProfileAssociatedGermConverter
  ...
  ProfileAssociatedGerm fromJson(Map<String, dynamic> json) {
    return ProfileAssociatedGerm.fromJson(translate(
      json,
      ProfileAssociatedGerm.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ProfileAssociatedGerm object) => untranslate(
        object.toJson(),
      );
}
