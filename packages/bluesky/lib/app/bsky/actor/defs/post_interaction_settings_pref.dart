...
abstract class PostInteractionSettingsPref with _$PostInteractionSettingsPref {
  static const knownProps = <String>['threadgateAllowRules', 'postgateEmbeddingRules', ];

  @JsonSerializable(includeIfNull: false)
  const factory PostInteractionSettingsPref({
    @Default('app.bsky.actor.defs#postInteractionSettingsPref') String $type,
    @UPostInteractionSettingsPrefThreadgateAllowRulesConverter() List<UPostInteractionSettingsPrefThreadgateAllowRules>? threadgateAllowRules,
@UPostInteractionSettingsPrefPostgateEmbeddingRulesConverter() List<UPostInteractionSettingsPrefPostgateEmbeddingRules>? postgateEmbeddingRules,

    Map<String, dynamic>? $unknown,
  }) = _PostInteractionSettingsPref;

  factory PostInteractionSettingsPref.fromJson(Map<String, Object?> json) => _$PostInteractionSettingsPrefFromJson(json);

  static bool validate(final Map<String, dynamic> object) {
  if (!object.containsKey('\$type')) return false;
  return object['\$type'] == 'app.bsky.actor.defs#postInteractionSettingsPref'
;
}
...
final class PostInteractionSettingsPrefConverter
  ...
  @override
  Map<String, dynamic> toJson(PostInteractionSettingsPref object) => untranslate(
        object.toJson(),
      );
}
