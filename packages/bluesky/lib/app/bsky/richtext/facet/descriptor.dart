...
final richtextFacetDescriptor = XRPCObjectDescriptor<RichtextFacet>(
  ...
  defName: 'main',
  fromJson: (json) => const RichtextFacetConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const RichtextFacetConverter().toJson,
  matches: RichtextFacet.validate,
);

final richtextFacetMentionDescriptor = XRPCObjectDescriptor<RichtextFacetMention>(
  nsid: 'app.bsky.richtext.facet',
  defName: 'mention',
  fromJson: (json) => const RichtextFacetMentionConverter().fromJson(json.cast<String, dynamic>()),
...
final richtextFacetLinkDescriptor = XRPCObjectDescriptor<RichtextFacetLink>(
  nsid: 'app.bsky.richtext.facet',
  defName: 'link',
  fromJson: (json) => const RichtextFacetLinkConverter().fromJson(json.cast<String, dynamic>()),
...
final richtextFacetTagDescriptor = XRPCObjectDescriptor<RichtextFacetTag>(
  nsid: 'app.bsky.richtext.facet',
  defName: 'tag',
  fromJson: (json) => const RichtextFacetTagConverter().fromJson(json.cast<String, dynamic>()),
  toJson: const RichtextFacetTagConverter().toJson,
  matches: RichtextFacetTag.validate,
);

final richtextFacetByteSliceDescriptor = XRPCObjectDescriptor<RichtextFacetByteSlice>(
  nsid: 'app.bsky.richtext.facet',
  defName: 'byteSlice',
  fromJson: (json) => const RichtextFacetByteSliceConverter().fromJson(json.cast<String, dynamic>()),
