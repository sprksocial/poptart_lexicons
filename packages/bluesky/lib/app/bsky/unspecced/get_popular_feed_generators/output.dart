...
@freezed
abstract class UnspeccedGetPopularFeedGeneratorsOutput with _$UnspeccedGetPopularFeedGeneratorsOutput {
...
@GeneratorViewConverter() required List<GeneratorView> feeds,
  ...
  factory UnspeccedGetPopularFeedGeneratorsOutput.fromJson(Map<String, Object?> json) => _$UnspeccedGetPopularFeedGeneratorsOutputFromJson(json);
}

extension UnspeccedGetPopularFeedGeneratorsOutputExtension on UnspeccedGetPopularFeedGeneratorsOutput {
...
final class UnspeccedGetPopularFeedGeneratorsOutputConverter
    extends JsonConverter<UnspeccedGetPopularFeedGeneratorsOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedGetPopularFeedGeneratorsOutput object) => untranslate(
        object.toJson(),
      );
}
