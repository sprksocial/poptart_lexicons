...
@freezed
abstract class UnspeccedInitAgeAssuranceInput with _$UnspeccedInitAgeAssuranceInput {
...
required String countryCode,
  ...
  factory UnspeccedInitAgeAssuranceInput.fromJson(Map<String, Object?> json) => _$UnspeccedInitAgeAssuranceInputFromJson(json);
}



final class UnspeccedInitAgeAssuranceInputConverter
    extends JsonConverter<UnspeccedInitAgeAssuranceInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedInitAgeAssuranceInput object) => untranslate(
        object.toJson(),
      );
}
