...
@freezed
abstract class UnspeccedGetPostThreadOtherV2Output with _$UnspeccedGetPostThreadOtherV2Output {
  ...
  factory UnspeccedGetPostThreadOtherV2Output.fromJson(Map<String, Object?> json) => _$UnspeccedGetPostThreadOtherV2OutputFromJson(json);
}



final class UnspeccedGetPostThreadOtherV2OutputConverter
    extends JsonConverter<UnspeccedGetPostThreadOtherV2Output, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedGetPostThreadOtherV2Output object) => untranslate(
        object.toJson(),
      );
}
