...
@freezed
abstract class UnspeccedSearchPostsSkeletonOutput with _$UnspeccedSearchPostsSkeletonOutput {
...
@SkeletonSearchPostConverter() required List<SkeletonSearchPost> posts,
  ...
  factory UnspeccedSearchPostsSkeletonOutput.fromJson(Map<String, Object?> json) => _$UnspeccedSearchPostsSkeletonOutputFromJson(json);
}

extension UnspeccedSearchPostsSkeletonOutputExtension on UnspeccedSearchPostsSkeletonOutput {
...
final class UnspeccedSearchPostsSkeletonOutputConverter
    extends JsonConverter<UnspeccedSearchPostsSkeletonOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedSearchPostsSkeletonOutput object) => untranslate(
        object.toJson(),
      );
}
