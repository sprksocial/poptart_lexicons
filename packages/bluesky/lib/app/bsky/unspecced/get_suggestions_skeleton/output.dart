...
@freezed
abstract class UnspeccedGetSuggestionsSkeletonOutput with _$UnspeccedGetSuggestionsSkeletonOutput {
  static const knownProps = <String>['cursor', 'actors', 'relativeToDid', 'recIdStr', ];
...
String? recIdStr,
  ...
  factory UnspeccedGetSuggestionsSkeletonOutput.fromJson(Map<String, Object?> json) => _$UnspeccedGetSuggestionsSkeletonOutputFromJson(json);
}

extension UnspeccedGetSuggestionsSkeletonOutputExtension on UnspeccedGetSuggestionsSkeletonOutput {
...
final class UnspeccedGetSuggestionsSkeletonOutputConverter
    extends JsonConverter<UnspeccedGetSuggestionsSkeletonOutput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(UnspeccedGetSuggestionsSkeletonOutput object) => untranslate(
        object.toJson(),
      );
}
