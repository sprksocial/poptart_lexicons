...
abstract class ThreadItemPost with _$ThreadItemPost {
  static const knownProps = <String>['post', 'moreParents', 'moreReplies', 'opThread', 'hiddenByThreadgate', 'mutedByViewer', ];
...
required bool mutedByViewer,
  ...
  factory ThreadItemPost.fromJson(Map<String, Object?> json) => _$ThreadItemPostFromJson(json);
