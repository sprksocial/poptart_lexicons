...
abstract class FeedGetFeedGeneratorsOutput with _$FeedGetFeedGeneratorsOutput {
  ...
  factory FeedGetFeedGeneratorsOutput.fromJson(Map<String, Object?> json) => _$FeedGetFeedGeneratorsOutputFromJson(json);
}
...
final class FeedGetFeedGeneratorsOutputConverter
  ...
  @override
  Map<String, dynamic> toJson(FeedGetFeedGeneratorsOutput object) => untranslate(
        object.toJson(),
      );
}
