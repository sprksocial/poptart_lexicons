...
const factory USkeletonFeedPostReason.skeletonReasonPin({
  ...
  Map<String, dynamic> toJson() => const USkeletonFeedPostReasonConverter().toJson(this);
}

extension USkeletonFeedPostReasonExtension on USkeletonFeedPostReason {
  bool get isSkeletonReasonRepost => isA<USkeletonFeedPostReasonSkeletonReasonRepost>(this);
bool get isNotSkeletonReasonRepost => !isSkeletonReasonRepost;
SkeletonReasonRepost? get skeletonReasonRepost => isSkeletonReasonRepost ? data as SkeletonReasonRepost : null;
bool get isSkeletonReasonPin => isA<USkeletonFeedPostReasonSkeletonReasonPin>(this);
bool get isNotSkeletonReasonPin => !isSkeletonReasonPin;
SkeletonReasonPin? get skeletonReasonPin => isSkeletonReasonPin ? data as SkeletonReasonPin : null;
...
final class USkeletonFeedPostReasonConverter implements JsonConverter<USkeletonFeedPostReason, Map<String, dynamic>> {
...
if (SkeletonReasonPin.validate(json)) {
  ...
  Map<String, dynamic> toJson(USkeletonFeedPostReason object) => object.when(
        skeletonReasonRepost: (data) => const SkeletonReasonRepostConverter().toJson(data),
skeletonReasonPin: (data) => const SkeletonReasonPinConverter().toJson(data),
