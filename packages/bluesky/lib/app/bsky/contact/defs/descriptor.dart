...
final matchAndContactIndexDescriptor = XRPCObjectDescriptor<MatchAndContactIndex>(
  nsid: 'app.bsky.contact.defs',
  defName: 'matchAndContactIndex',
  fromJson: (json) => const MatchAndContactIndexConverter().fromJson(json.cast<String, dynamic>()),
...
final syncStatusDescriptor = XRPCObjectDescriptor<SyncStatus>(
  nsid: 'app.bsky.contact.defs',
  defName: 'syncStatus',
  fromJson: (json) => const SyncStatusConverter().fromJson(json.cast<String, dynamic>()),
