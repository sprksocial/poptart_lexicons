...
required String token,
  ...
  factory ContactVerifyPhoneOutput.fromJson(Map<String, Object?> json) => _$ContactVerifyPhoneOutputFromJson(json);
}
...
final class ContactVerifyPhoneOutputConverter
  ...
  ContactVerifyPhoneOutput fromJson(Map<String, dynamic> json) {
    return ContactVerifyPhoneOutput.fromJson(translate(
      json,
      ContactVerifyPhoneOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ContactVerifyPhoneOutput object) => untranslate(
        object.toJson(),
      );
}
