...
required String code,
  ...
  factory ContactVerifyPhoneInput.fromJson(Map<String, Object?> json) => _$ContactVerifyPhoneInputFromJson(json);
}
...
final class ContactVerifyPhoneInputConverter
  ...
  ContactVerifyPhoneInput fromJson(Map<String, dynamic> json) {
    return ContactVerifyPhoneInput.fromJson(translate(
      json,
      ContactVerifyPhoneInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ContactVerifyPhoneInput object) => untranslate(
        object.toJson(),
      );
}
