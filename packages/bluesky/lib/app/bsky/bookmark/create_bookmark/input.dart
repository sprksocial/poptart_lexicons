...
required String cid,
  ...
  factory BookmarkCreateBookmarkInput.fromJson(Map<String, Object?> json) => _$BookmarkCreateBookmarkInputFromJson(json);
}
...
final class BookmarkCreateBookmarkInputConverter
  ...
  BookmarkCreateBookmarkInput fromJson(Map<String, dynamic> json) {
    return BookmarkCreateBookmarkInput.fromJson(translate(
      json,
      BookmarkCreateBookmarkInput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(BookmarkCreateBookmarkInput object) => untranslate(
        object.toJson(),
      );
}
