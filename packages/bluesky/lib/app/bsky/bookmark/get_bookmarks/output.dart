...
@BookmarkViewConverter() required List<BookmarkView> bookmarks,
  ...
  factory BookmarkGetBookmarksOutput.fromJson(Map<String, Object?> json) => _$BookmarkGetBookmarksOutputFromJson(json);
}
...
final class BookmarkGetBookmarksOutputConverter
  ...
  BookmarkGetBookmarksOutput fromJson(Map<String, dynamic> json) {
    return BookmarkGetBookmarksOutput.fromJson(translate(
      json,
      BookmarkGetBookmarksOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(BookmarkGetBookmarksOutput object) => untranslate(
        object.toJson(),
      );
}
