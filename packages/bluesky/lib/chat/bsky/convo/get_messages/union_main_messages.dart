...
const factory UConvoGetMessagesMessages.deletedMessageView({
  ...
  Map<String, dynamic> toJson() => const UConvoGetMessagesMessagesConverter().toJson(this);
}
...
bool get isDeletedMessageView => isA<UConvoGetMessagesMessagesDeletedMessageView>(this);
...
final class UConvoGetMessagesMessagesConverter implements JsonConverter<UConvoGetMessagesMessages, Map<String, dynamic>> {
