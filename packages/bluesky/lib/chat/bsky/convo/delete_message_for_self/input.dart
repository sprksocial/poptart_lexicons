...
@freezed
abstract class ConvoDeleteMessageForSelfInput with _$ConvoDeleteMessageForSelfInput {
...
required String messageId,
  ...
  factory ConvoDeleteMessageForSelfInput.fromJson(Map<String, Object?> json) => _$ConvoDeleteMessageForSelfInputFromJson(json);
}



final class ConvoDeleteMessageForSelfInputConverter
    extends JsonConverter<ConvoDeleteMessageForSelfInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(ConvoDeleteMessageForSelfInput object) => untranslate(
        object.toJson(),
      );
}
