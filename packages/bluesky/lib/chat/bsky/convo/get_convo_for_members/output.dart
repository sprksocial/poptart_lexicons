...
@freezed
abstract class ConvoGetConvoForMembersOutput with _$ConvoGetConvoForMembersOutput {
  ...
  factory ConvoGetConvoForMembersOutput.fromJson(Map<String, Object?> json) => _$ConvoGetConvoForMembersOutputFromJson(json);
}
...
final class ConvoGetConvoForMembersOutputConverter
  ...
  ConvoGetConvoForMembersOutput fromJson(Map<String, dynamic> json) {
    return ConvoGetConvoForMembersOutput.fromJson(translate(
      json,
      ConvoGetConvoForMembersOutput.knownProps,
    ));
  }

  @override
  Map<String, dynamic> toJson(ConvoGetConvoForMembersOutput object) => untranslate(
        object.toJson(),
      );
}
