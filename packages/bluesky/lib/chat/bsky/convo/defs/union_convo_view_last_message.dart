...
const factory UConvoViewLastMessage.deletedMessageView({
  ...
  Map<String, dynamic> toJson() => const UConvoViewLastMessageConverter().toJson(this);
}
...
bool get isDeletedMessageView => isA<UConvoViewLastMessageDeletedMessageView>(this);
...
final class UConvoViewLastMessageConverter implements JsonConverter<UConvoViewLastMessage, Map<String, dynamic>> {
