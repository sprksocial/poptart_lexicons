...
const factory ULogCreateMessageMessage.deletedMessageView({
  ...
  Map<String, dynamic> toJson() => const ULogCreateMessageMessageConverter().toJson(this);
}
...
bool get isDeletedMessageView => isA<ULogCreateMessageMessageDeletedMessageView>(this);
...
final class ULogCreateMessageMessageConverter implements JsonConverter<ULogCreateMessageMessage, Map<String, dynamic>> {
