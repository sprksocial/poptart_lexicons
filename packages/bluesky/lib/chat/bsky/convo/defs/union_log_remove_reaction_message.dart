...
const factory ULogRemoveReactionMessage.deletedMessageView({
  ...
  Map<String, dynamic> toJson() => const ULogRemoveReactionMessageConverter().toJson(this);
}
...
bool get isDeletedMessageView => isA<ULogRemoveReactionMessageDeletedMessageView>(this);
...
final class ULogRemoveReactionMessageConverter implements JsonConverter<ULogRemoveReactionMessage, Map<String, dynamic>> {
