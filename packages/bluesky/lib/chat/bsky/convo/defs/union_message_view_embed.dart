...
sealed class UMessageViewEmbed with _$UMessageViewEmbed {
  ...
  Map<String, dynamic> toJson() => const UMessageViewEmbedConverter().toJson(this);
}
...
final class UMessageViewEmbedConverter implements JsonConverter<UMessageViewEmbed, Map<String, dynamic>> {
