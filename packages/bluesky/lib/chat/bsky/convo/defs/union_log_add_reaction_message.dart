...
const factory ULogAddReactionMessage.deletedMessageView({
  ...
  Map<String, dynamic> toJson() => const ULogAddReactionMessageConverter().toJson(this);
}
...
bool get isDeletedMessageView => isA<ULogAddReactionMessageDeletedMessageView>(this);
...
final class ULogAddReactionMessageConverter implements JsonConverter<ULogAddReactionMessage, Map<String, dynamic>> {
