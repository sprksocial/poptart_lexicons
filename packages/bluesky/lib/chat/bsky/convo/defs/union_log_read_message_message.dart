...
const factory ULogReadMessageMessage.deletedMessageView({
  ...
  Map<String, dynamic> toJson() => const ULogReadMessageMessageConverter().toJson(this);
}
...
bool get isDeletedMessageView => isA<ULogReadMessageMessageDeletedMessageView>(this);
...
final class ULogReadMessageMessageConverter implements JsonConverter<ULogReadMessageMessage, Map<String, dynamic>> {
