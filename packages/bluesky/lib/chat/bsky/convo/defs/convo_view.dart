...
abstract class ConvoView with _$ConvoView {
  static const knownProps = <String>['id', 'rev', 'members', 'lastMessage', 'lastReaction', 'muted', 'status', 'unreadCount', ];
...
required int unreadCount,
  ...
  factory ConvoView.fromJson(Map<String, Object?> json) => _$ConvoViewFromJson(json);
