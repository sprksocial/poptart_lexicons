...
const factory ULogDeleteMessageMessage.deletedMessageView({
  ...
  Map<String, dynamic> toJson() => const ULogDeleteMessageMessageConverter().toJson(this);
}
...
bool get isDeletedMessageView => isA<ULogDeleteMessageMessageDeletedMessageView>(this);
...
final class ULogDeleteMessageMessageConverter implements JsonConverter<ULogDeleteMessageMessage, Map<String, dynamic>> {
