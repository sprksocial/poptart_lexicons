...
sealed class UConvoViewLastReaction with _$UConvoViewLastReaction {
  ...
  Map<String, dynamic> toJson() => const UConvoViewLastReactionConverter().toJson(this);
}

extension UConvoViewLastReactionExtension on UConvoViewLastReaction {
  bool get isMessageAndReactionView => isA<UConvoViewLastReactionMessageAndReactionView>(this);
bool get isNotMessageAndReactionView => !isMessageAndReactionView;
MessageAndReactionView? get messageAndReactionView => isMessageAndReactionView ? data as MessageAndReactionView : null;
...
final class UConvoViewLastReactionConverter implements JsonConverter<UConvoViewLastReaction, Map<String, dynamic>> {
  ...
  Map<String, dynamic> toJson(UConvoViewLastReaction object) => object.when(
        messageAndReactionView: (data) => const MessageAndReactionViewConverter().toJson(data),
