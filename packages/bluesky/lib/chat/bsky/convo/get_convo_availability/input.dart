...
@freezed
abstract class ConvoGetConvoAvailabilityInput with _$ConvoGetConvoAvailabilityInput {
  ...
  factory ConvoGetConvoAvailabilityInput.fromJson(Map<String, Object?> json) => _$ConvoGetConvoAvailabilityInputFromJson(json);
}



final class ConvoGetConvoAvailabilityInputConverter
    extends JsonConverter<ConvoGetConvoAvailabilityInput, Map<String, dynamic>> {
  ...
  @override
  Map<String, dynamic> toJson(ConvoGetConvoAvailabilityInput object) => untranslate(
        object.toJson(),
      );
}
