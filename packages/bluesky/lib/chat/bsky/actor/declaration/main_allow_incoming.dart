...
@freezed
abstract class ActorDeclarationAllowIncoming with _$ActorDeclarationAllowIncoming {
  ...
  static ActorDeclarationAllowIncoming? valueOf(final String? value) {
    ...
    return knownValue != null ? ActorDeclarationAllowIncoming.knownValue(data: knownValue) : ActorDeclarationAllowIncoming.unknown(data: value);
  }

  String toJson() => const ActorDeclarationAllowIncomingConverter().toJson(this);
}

extension ActorDeclarationAllowIncomingExtension on ActorDeclarationAllowIncoming {
  bool get isKnownValue => isA<ActorDeclarationAllowIncomingKnownValue>(this);
bool get isNotKnownValue => !isKnownValue;
KnownActorDeclarationAllowIncoming? get knownValue => isKnownValue ? data as KnownActorDeclarationAllowIncoming : null;
...
final class ActorDeclarationAllowIncomingConverter extends JsonConverter<ActorDeclarationAllowIncoming, String> {
