...
@freezed
sealed class UModerationGetMessageContextMessages with _$UModerationGetMessageContextMessages {
...
const factory UModerationGetMessageContextMessages.deletedMessageView({
  ...
  Map<String, dynamic> toJson() => const UModerationGetMessageContextMessagesConverter().toJson(this);
}

extension UModerationGetMessageContextMessagesExtension on UModerationGetMessageContextMessages {
  bool get isMessageView => isA<UModerationGetMessageContextMessagesMessageView>(this);
bool get isNotMessageView => !isMessageView;
MessageView? get messageView => isMessageView ? data as MessageView : null;
bool get isDeletedMessageView => isA<UModerationGetMessageContextMessagesDeletedMessageView>(this);
bool get isNotDeletedMessageView => !isDeletedMessageView;
DeletedMessageView? get deletedMessageView => isDeletedMessageView ? data as DeletedMessageView : null;
...
final class UModerationGetMessageContextMessagesConverter implements JsonConverter<UModerationGetMessageContextMessages, Map<String, dynamic>> {
...
if (DeletedMessageView.validate(json)) {
  ...
  @override
  Map<String, dynamic> toJson(UModerationGetMessageContextMessages object) => object.when(
        messageView: (data) => const MessageViewConverter().toJson(data),
deletedMessageView: (data) => const DeletedMessageViewConverter().toJson(data),
