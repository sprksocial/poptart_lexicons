...
import 'package:bluesky_poptart/app/bsky/feed/postgate.dart';
import 'package:bluesky_poptart/app/bsky/feed/repost.dart';
import 'package:bluesky_poptart/app/bsky/feed/threadgate.dart';
...
import 'package:bluesky_poptart/app/bsky/notification/declaration.dart';
import 'package:bluesky_poptart/chat/bsky/actor/declaration.dart';
...
final RepoCommitOnCreate<NotificationDeclarationRecord>? _onCreateNotificationDeclaration;
final RepoCommitOnUpdate<NotificationDeclarationRecord>? _onUpdateNotificationDeclaration;
...
final RepoCommitOnCreate<GraphVerificationRecord>? onCreateGraphVerification,
final RepoCommitOnUpdate<GraphVerificationRecord>? onUpdateGraphVerification,
...
final RepoCommitOnCreate<NotificationDeclarationRecord>? onCreateNotificationDeclaration,
final RepoCommitOnUpdate<NotificationDeclarationRecord>? onUpdateNotificationDeclaration,
...
if (uri.isNotificationDeclaration && NotificationDeclarationRecord.validate(record)) {
  await _onCreateNotificationDeclaration?.call(
    RepoCommitCreate<NotificationDeclarationRecord>(
      record: const NotificationDeclarationRecordConverter().fromJson(record),
      uri: uri,
      cid: op.cid,
      author: data.repo,
      cursor: data.seq,
